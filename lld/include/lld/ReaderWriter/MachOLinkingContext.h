...
public:
    ...
    virtual uint64_t pageSize() const {
        return _pageSize;
    }

    mach_o::ArchHandler &archHandler() const;

    HeaderFileType outputMachOType() const {
        return _outputMachOType;
    }
    ...
    StringRef archName() const {
        return nameFromArch(_arch);
    }
    OS os() const {
        return _os;
    }

    ExportMode exportMode() const {
        return _exportMode;
    }
    ...
    bool exportRestrictMode() const {
        return _exportMode != ExportMode::globals;
    }
    bool exportSymbolNamed(StringRef sym) const;

    DebugInfoMode debugInfoMode() const {
        return _debugInfoMode;
    }
    ...
    bool keepPrivateExterns() const {
        return _keepPrivateExterns;
    }
    void setKeepPrivateExterns(bool v) {
        _keepPrivateExterns = v;
    }
    bool demangleSymbols() const {
        return _demangle;
    }
    void setDemangleSymbols(bool d) {
        _demangle = d;
    }
    bool mergeObjCCategories() const {
        return _mergeObjCCategories;
    }
    void setMergeObjCCategories(bool v) {
        _mergeObjCCategories = v;
    }
    ...
    void setDoNothing(bool value) {
        _doNothing = value;
    }
    bool doNothing() const {
        return _doNothing;
    }
    bool printAtoms() const {
        return _printAtoms;
    }
    bool testingFileUsage() const {
        return _testingFileUsage;
    }
    const StringRefVector &searchDirs() const {
        return _searchDirs;
    }
    const StringRefVector &frameworkDirs() const {
        return _frameworkDirs;
    }
    void setSysLibRoots(const StringRefVector &paths);
    const StringRefVector &sysLibRoots() const {
        return _syslibRoots;
    }
    bool PIE() const {
        return _pie;
    ...
    ObjCConstraint objcConstraint() const {
        return _objcConstraint;
    }

    uint32_t osMinVersion() const {
        return _osMinVersion;
    }

    uint32_t sdkVersion() const {
        return _sdkVersion;
    }
    void setSdkVersion(uint64_t v) {
        _sdkVersion = v;
    }
    ...
    void setSourceVersion(uint64_t v) {
        _sourceVersion = v;
    }

    uint32_t swiftVersion() const {
    ...
    bool deadStrippableDylib() const {
    ...
    bool useFlatNamespace() const {
        return _flatNamespace;
    }
    ...
    ///    runtime.
    UndefinedMode undefinedMode() const {
        return _undefinedMode;
    }
    ...
    /// at that point.
    StringRef bundleLoader() const {
        return _bundleLoader;
    }

    void setCompatibilityVersion(uint32_t vers) {
        _compatibilityVersion = vers;
    }
    void setCurrentVersion(uint32_t vers) {
        _currentVersion = vers;
    }
    void setInstallName(StringRef name) {
        _installName = name;
    }
    ...
    void setBundleLoader(StringRef loader) {
        _bundleLoader = loader;
    }
    void setPrintAtoms(bool value=true) {
        _printAtoms = value;
    }
    ...
    const StringRefVector &rpaths() const {
        return _rpaths;
    }
    ...
    StringRef copy(StringRef str) {
        return str.copy(_allocator);
    }
    ...
    File* flatNamespaceFile() const {
        return _flatNamespaceFile;
    }
