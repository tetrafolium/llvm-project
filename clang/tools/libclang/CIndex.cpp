...
public:
    ...
    const Decl *get() const {
        return static_cast<const Decl *>(data[0]);
    }
    bool isFirst() const {
        return data[1] != nullptr;
    }
};
...
class AnnotateTokensWorker {
    ...
    bool MoreTokens() const {
        return TokIdx < NumTokens;
    }
    unsigned NextToken() const {
        return TokIdx;
    }
    void AdvanceToken() {
        ++TokIdx;
...
public:
    ...
    void VisitChildren(CXCursor C) {
        AnnotateVis.VisitChildren(C);
    }
