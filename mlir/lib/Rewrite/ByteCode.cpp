...
struct ByteCodeWriter {
    ...
    void append(ByteCodeField field) {
        bytecode.push_back(field);
    }
    ...
    void appendPDLValueList(OperandRange values) {
        ...
        for (Value value : values) {
            ...
            [](Type) {
                return PDLValueKind::Attribute;
            })
            .Case<pdl::OperationType>(
            [](Type) {
                return PDLValueKind::Operation;
            })
            .Case<pdl::TypeType>([](Type) {
                return PDLValueKind::Type;
            })
            .Case<pdl::ValueType>([](Type) {
                return PDLValueKind::Value;
            });
...
private:
    ...
    ByteCodeField read(size_t skipN = 0) {
    ...
    void selectJump(bool isTrue) {
        selectJump(size_t(isTrue ? 0 : 1));
    }
