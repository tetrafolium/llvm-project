...
static const ARMVectorIntrinsicInfo AArch64SIMDIntrinsicMap[] = {
    ...
    NEONMAP2(vcvtq_n_f16_v, aarch64_neon_vcvtfxu2fp, aarch64_neon_vcvtfxs2fp,
             0),
...
Value *CodeGenFunction::EmitARMBuiltinExpr(unsigned BuiltinID,
  ...
  if (BuiltinID == ARM::BI__builtin_arm_strexd ||
    ...
    Address LdPtr =
        Builder.CreateBitCast(Tmp, llvm::PointerType::getUnqual(STy));
...
static Value *EmitX86ConvertIntToFp(CodeGenFunction &CGF, ArrayRef<Value *> Ops,
                                    bool IsSigned) {
...
static Value *EmitX86CvtBF16ToFloatExpr(CodeGenFunction &CGF, const CallExpr *E,
                                        ArrayRef<Value *> Ops) {
...
#undef INTRINSIC_X86_XSAVE_ID
  ...
  case X86::BI__builtin_ia32_extracti64x2_512_mask: {
    ...
    Value *Res =
        Builder.CreateShuffleVector(Ops[0], UndefValue::get(Ops[0]->getType()),
  ...
  case X86::BI__builtin_ia32_inserti64x2_512: {
    ...
    Value *Op1 =
        Builder.CreateShuffleVector(Ops[1], UndefValue::get(Ops[1]->getType()),
                                    makeArrayRef(Indices, DstNumElts), "widen");
  ...
  case X86::BI__builtin_ia32_pshuflw512: {
    ...
    return Builder.CreateShuffleVector(
        Ops[0], UndefValue::get(Ty), makeArrayRef(Indices, NumElts), "pshuflw");
  }
  ...
  case X86::BI__builtin_ia32_pshufhw512: {
    ...
    return Builder.CreateShuffleVector(
        Ops[0], UndefValue::get(Ty), makeArrayRef(Indices, NumElts), "pshufhw");
  }
  ...
  case X86::BI__builtin_ia32_vpermilps512: {
    ...
    return Builder.CreateShuffleVector(
        Ops[0], UndefValue::get(Ty), makeArrayRef(Indices, NumElts), "permil");
  }
  ...
  case X86::BI__builtin_ia32_permdf512: {
    ...
    return Builder.CreateShuffleVector(Ops[0], UndefValue::get(Ty),
                                       makeArrayRef(Indices, NumElts), "perm");
  }
...
#define CUSTOM_BUILTIN(Name, Types, Accumulate) case PPC::BI__builtin_##Name:
  ...
  {Hexagon::BI__builtin_HEXAGON_##x, Intrinsic::hexagon_##x, s},
      CUSTOM_BUILTIN_MAPPING(L2_loadrub_pci, 0) CUSTOM_BUILTIN_MAPPING(
          ...
          CUSTOM_BUILTIN_MAPPING(L2_loadri_pci, 0) CUSTOM_BUILTIN_MAPPING(
              L2_loadrd_pci,
              0) CUSTOM_BUILTIN_MAPPING(L2_loadrub_pcr,
                                        0) CUSTOM_BUILTIN_MAPPING(L2_loadrb_pcr,
                                                                  0)
              CUSTOM_BUILTIN_MAPPING(L2_loadruh_pcr, 0) CUSTOM_BUILTIN_MAPPING(
                  L2_loadrh_pcr,
                  0) CUSTOM_BUILTIN_MAPPING(L2_loadri_pcr,
                                            0) CUSTOM_BUILTIN_MAPPING(L2_loadrd_pcr,
                                                                      0)
                  CUSTOM_BUILTIN_MAPPING(S2_storerb_pci, 0) CUSTOM_BUILTIN_MAPPING(
                      S2_storerh_pci, 0) CUSTOM_BUILTIN_MAPPING(S2_storerf_pci,
                                                                0)
                      CUSTOM_BUILTIN_MAPPING(
                          S2_storeri_pci,
                          0) CUSTOM_BUILTIN_MAPPING(S2_storerd_pci, 0)
                          CUSTOM_BUILTIN_MAPPING(
                              S2_storerb_pcr,
                              0) CUSTOM_BUILTIN_MAPPING(S2_storerh_pcr, 0)
                              CUSTOM_BUILTIN_MAPPING(
                                  S2_storerf_pcr,
                                  0) CUSTOM_BUILTIN_MAPPING(S2_storeri_pcr, 0)
                                  CUSTOM_BUILTIN_MAPPING(
                                      S2_storerd_pcr,
                                      0) CUSTOM_BUILTIN_MAPPING(V6_vmaskedstoreq,
                                                                64)
                                      CUSTOM_BUILTIN_MAPPING(
                                          V6_vmaskedstorenq,
                                          64) CUSTOM_BUILTIN_MAPPING(V6_vmaskedstorentq,
                                                                     64)
                                          CUSTOM_BUILTIN_MAPPING(
                                              V6_vmaskedstorentnq, 64)
                                              CUSTOM_BUILTIN_MAPPING(
                                                  V6_vmaskedstoreq_128B, 128)
                                                  CUSTOM_BUILTIN_MAPPING(
                                                      V6_vmaskedstorenq_128B,
                                                      128)
                                                      CUSTOM_BUILTIN_MAPPING(
                                                          V6_vmaskedstorentq_128B,
                                                          128)
                                                          CUSTOM_BUILTIN_MAPPING(
                                                              V6_vmaskedstorentnq_128B,
                                                              128)
