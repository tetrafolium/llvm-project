...
private:
    ...
    struct InstructionAllowed : public InstVisitor<InstructionAllowed, bool> {
        ...
        // dependent.
        bool visitLandingPadInst(LandingPadInst &LPI) {
            return false;
        }
        bool visitFuncletPadInst(FuncletPadInst &FPI) {
            return false;
        }
        ...
        // handled.
        bool IntrinsicInst(IntrinsicInst &II) {
            return false;
        }
        ...
        // handled differently.
        bool visitFreezeInst(FreezeInst &CI) {
            return false;
        }
        ...
        // TODO: We do not current handle similarity that changes the control flow.
        bool visitCallBrInst(CallBrInst &CBI) {
            return false;
        }
