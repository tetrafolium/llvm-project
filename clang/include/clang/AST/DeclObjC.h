...
public:
    ...
    bool isRedeclaration() const {
        return ObjCMethodDeclBits.IsRedeclaration;
    }
    void setIsRedeclaration(bool RD) {
        ObjCMethodDeclBits.IsRedeclaration = RD;
    }
    void setAsRedeclaration(const ObjCMethodDecl *PrevMethod);

    /// True if redeclared in the same interface.
    bool hasRedeclaration() const {
        return ObjCMethodDeclBits.HasRedeclaration;
    }
    ...
    param_iterator param_begin() {
        return param_iterator(getParams());
    }
    param_iterator param_end() {
        return param_iterator(getParams() + NumParams);
    }
    ...
    bool isInstanceMethod() const {
        return ObjCMethodDeclBits.IsInstance;
    }
    ...
    void setVariadic(bool isVar) {
        ObjCMethodDeclBits.IsVariadic = isVar;
    }
    ...
    void setDefined(bool isDefined) {
        ObjCMethodDeclBits.IsDefined = isDefined;
    }
    ...
    bool isOverriding() const {
        return ObjCMethodDeclBits.IsOverriding;
    }
    void setOverriding(bool IsOver) {
        ObjCMethodDeclBits.IsOverriding = IsOver;
    }
    ...
    bool hasSkippedBody() const {
        return ObjCMethodDeclBits.HasSkippedBody;
    }
...
public:
    ...
    prop_range properties() const {
        return prop_range(prop_begin(), prop_end());
    }
    ...
    SourceLocation getAtStartLoc() const {
        return ObjCContainerDeclBits.AtStart;
    }
...
public:
    ...
    ivar_range ivars() const {
        return ivar_range(ivar_begin(), ivar_end());
    }
...
private:
    ...
    static bool isKnownCategory(ObjCCategoryDecl *) {
        return true;
    }
...
public:
    ...
    AccessControl getAccessControl() const {
        return AccessControl(DeclAccess);
    }
...
public:
    ...
    SourceLocation getIvarLBraceLoc() const {
        return IvarLBraceLoc;
    }
    void setIvarRBraceLoc(SourceLocation Loc) {
        IvarRBraceLoc = Loc;
    }
    SourceLocation getIvarRBraceLoc() const {
        return IvarRBraceLoc;
    }
...
public:
    ...
    init_range inits() {
        return init_range(init_begin(), init_end());
    }
