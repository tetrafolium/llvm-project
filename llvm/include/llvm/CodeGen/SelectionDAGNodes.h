...
public:
    ...
    unsigned getOpcode()  const {
        return (unsigned short)NodeType;
    }
...
#include "llvm/IR/ConstrainedOps.def"
    ...
    bool getHasDebugValue() const {
        return SDNodeBits.HasDebugValue;
    }
    void setHasDebugValue(bool b) {
        SDNodeBits.HasDebugValue = b;
    }

    bool isDivergent() const {
        return SDNodeBits.IsDivergent;
    }
    ...
    op_iterator op_end() const {
        return OperandList+NumOperands;
    }
    ArrayRef<SDUse> ops() const {
        return makeArrayRef(op_begin(), op_end());
    }
...
public:
    ...
    bool isVolatile() const {
        return MemSDNodeBits.IsVolatile;
    }
    bool isNonTemporal() const {
        return MemSDNodeBits.IsNonTemporal;
    }
    bool isDereferenceable() const {
        return MemSDNodeBits.IsDereferenceable;
    }
    bool isInvariant() const {
        return MemSDNodeBits.IsInvariant;
    }

    // Returns the offset from the location of the access.
    int64_t getSrcValueOffset() const {
        return MMO->getOffset();
    }

    /// Returns the AA info that describes the dereference.
    AAMDNodes getAAInfo() const {
        return MMO->getAAInfo();
    }

    /// Returns the Ranges that describes the dereference.
    const MDNode *getRanges() const {
        return MMO->getRanges();
    }

    /// Returns the synchronization scope ID for this memory operation.
    SyncScope::ID getSyncScopeID() const {
        return MMO->getSyncScopeID();
    }
...
public:
    ...
    MaybeAlign getMaybeAlignValue() const {
        return Value->getMaybeAlignValue();
    }
    Align getAlignValue() const {
        return Value->getAlignValue();
    }
...
public:
    ...
    bool isIndexed() const {
        return getAddressingMode() != ISD::UNINDEXED;
    }
...
public:
    ...
    bool isTruncatingStore() const {
        return StoreSDNodeBits.IsTruncating;
    }
...
public:
    ...
    bool isExpandingLoad() const {
        return LoadSDNodeBits.IsExpanding;
    }
};
...
public:
    ...
    bool isCompressingStore() const {
        return StoreSDNodeBits.IsCompressing;
    }
