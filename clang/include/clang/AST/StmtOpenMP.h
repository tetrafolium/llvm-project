...
public:
    ...
    bool hasAssociatedStmt() const {
        return Data && Data->hasAssociatedStmt();
    }
...
protected:
    ...
    void setCond(Expr *Cond) {
        Data->getChildren()[CondOffset] = Cond;
    }
    void setInit(Expr *Init) {
        Data->getChildren()[InitOffset] = Init;
    }
    void setInc(Expr *Inc) {
        Data->getChildren()[IncOffset] = Inc;
    }
