...
public:
  explicit ARMTargetLowering(const TargetMachine &TM, const ARMSubtarget &STI);
  ...
  bool hasStandaloneRem(EVT VT) const override { return HasStandaloneRem; }
...
private:
  ...
  std::pair<SDValue, SDValue> getARMXALUOOp(SDValue Op, SelectionDAG &DAG,
                                            SDValue &ARMcc) const;
  ...
  void PassF64ArgInRegs(const SDLoc &dl, SelectionDAG &DAG, SDValue Chain,
                        ...
                        CCValAssign &VA, CCValAssign &NextVA, SDValue &StackPtr,
  ...
  SDValue LowerToTLSExecModels(GlobalAddressSDNode *GA, SelectionDAG &DAG,
  ...
  SDValue MoveToHPR(const SDLoc &dl, SelectionDAG &DAG, MVT LocVT, MVT ValVT,
                    SDValue Val) const;
  SDValue MoveFromHPR(const SDLoc &dl, SelectionDAG &DAG, MVT LocVT, MVT ValVT,
                      SDValue Val) const;
  ...
  void VarArgStyleRegisters(CCState &CCInfo, SelectionDAG &DAG, const SDLoc &dl,
                            SDValue &Chain, unsigned ArgOffset,
  ...
  SDValue getCMOV(const SDLoc &dl, EVT VT, SDValue FalseVal, SDValue TrueVal,
                  ...
                  SelectionDAG &DAG) const;
  SDValue getARMCmp(SDValue LHS, SDValue RHS, ISD::CondCode CC, SDValue &ARMcc,
