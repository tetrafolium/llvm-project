...
public:
    ...
    MaybeExpr bindName() const {
        return bindName_;
    }
    void set_bindName(MaybeExpr &&expr) {
        bindName_ = std::move(expr);
    }
...
public:
    ...
    SubprogramKind kind() const {
        return kind_;
    }
    ProgramTree &node() const {
        return *node_;
    }
...
public:
    ...
    const ProcInterface &interface() const {
        return interface_;
    }
...
public:
    const std::list<SourceName> &paramNames() const {
        return paramNames_;
    }
    const SymbolVector &paramDecls() const {
        return paramDecls_;
    }
    bool sequence() const {
        return sequence_;
...
public:
    const SymbolVector &objects() const {
        return objects_;
    }
    void add_object(const Symbol &object) {
...
public:
    ...
    common::TypeParamAttr attr() const {
        return attr_;
    }
    MaybeIntExpr &init() {
        return init_;
...
public:
    ...
    const SourceName &location() const {
        return location_;
    }
    const Symbol &symbol() const {
        return symbol_;
...
public:
    ...
    const listType occurrences() const {
        return occurrences_;
    };
...
struct GenericKind {
    ...
    template <typename T> GenericKind(const T &x) {
        u = x;
    }
    bool IsName() const {
...
public:
    ...
    template <typename D> D *detailsIf() {
