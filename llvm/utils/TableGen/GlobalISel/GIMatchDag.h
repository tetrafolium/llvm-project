...
public:
    ...
    GIMatchDagContext &getContext() const {
        return Ctx;
    }
    ...
    size_t getNumInstrNodes() const {
        return InstrNodes.size();
    }
    size_t getNumEdges() const {
        return Edges.size();
    }
    size_t getNumPredicates() const {
        return PredicateNodes.size();
    }

    void setHasPostMatchPredicate(bool V) {
        HasPostMatchPredicate = V;
    }
    bool hasPostMatchPredicate() const {
        return HasPostMatchPredicate;
    }

    void addMatchRoot(GIMatchDagInstr *N) {
        MatchRoots.push_back(N);
    }
