...
public:
    ...
    unsigned getLength() const {
        return (unsigned)getString().size();
    }
    ...
    const unsigned char *bytes_begin() const {
        return getString().bytes_begin();
    }
    const unsigned char *bytes_end() const {
        return getString().bytes_end();
    }
...
protected:
    ...
    MDOperand *mutable_begin() {
        return mutable_end() - NumOperands;
    }
    MDOperand *mutable_end() {
        return reinterpret_cast<MDOperand *>(this);
    }
...
public:
    ...
    bool isUniqued() const {
        return Storage == Uniqued;
    }
    bool isDistinct() const {
        return Storage == Distinct;
    }
...
public:
    ...
    bool empty() const {
        return N ? N->getNumOperands() == 0 : true;
    }
...
class NamedMDNode : public ilist_node<NamedMDNode> {
    ...
    public:
        ...
        bool operator==(const op_iterator_impl &o) const {
            return Idx == o.Idx;
        }
        bool operator!=(const op_iterator_impl &o) const {
            return Idx != o.Idx;
...
public:
    ...
    inline const Module *getParent() const {
        return Parent;
    }
    ...
    const_op_iterator op_begin() const {
        return const_op_iterator(this, 0);
    }
