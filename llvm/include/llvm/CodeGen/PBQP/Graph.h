...
private:
    ...
    public:
        ...
        const AdjEdgeList& getAdjEdgeIds() const {
            return AdjEdgeIds;
        }
    ...
    public:
        ...
        NodeId getN1Id() const {
            return NIds[0];
        }
        NodeId getN2Id() const {
            return NIds[1];
        }
...
public:
    ...
    NodeIdSet nodeIds() const {
        return NodeIdSet(*this);
    }
    EdgeIdSet edgeIds() const {
        return EdgeIdSet(*this);
    }
    ...
    unsigned getNumNodes() const {
        return NodeIdSet(*this).size();
    }

    /// Get the number of edges in the graph.
    /// @return Number of edges in the graph.
    unsigned getNumEdges() const {
        return EdgeIdSet(*this).size();
    }
