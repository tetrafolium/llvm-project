...
#define __DEFAULT_FN_ATTRS                                                     \
  __attribute__((__always_inline__, __nodebug__, __target__("xop"),            \
...
#define _mm_com_epu16(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomuw((__v8hi)(__m128i)(A), (__v8hi)(__m128i)(B), (N))

#define _mm_com_epu32(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomud((__v4si)(__m128i)(A), (__v4si)(__m128i)(B), (N))

#define _mm_com_epu64(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomuq((__v2di)(__m128i)(A), (__v2di)(__m128i)(B), (N))

#define _mm_com_epi8(A, B, N)                                                  \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomb((__v16qi)(__m128i)(A), (__v16qi)(__m128i)(B), (N))

#define _mm_com_epi16(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomw((__v8hi)(__m128i)(A), (__v8hi)(__m128i)(B), (N))

#define _mm_com_epi32(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomd((__v4si)(__m128i)(A), (__v4si)(__m128i)(B), (N))

#define _mm_com_epi64(A, B, N)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_vpcomq((__v2di)(__m128i)(A), (__v2di)(__m128i)(B), (N))
...
#define _mm_permute2_pd(X, Y, C, I)                                            \
  (__m128d) __builtin_ia32_vpermil2pd(                                         \
      (__v2df)(__m128d)(X), (__v2df)(__m128d)(Y), (__v2di)(__m128i)(C), (I))

#define _mm256_permute2_pd(X, Y, C, I)                                         \
  (__m256d) __builtin_ia32_vpermil2pd256(                                      \
      (__v4df)(__m256d)(X), (__v4df)(__m256d)(Y), (__v4di)(__m256i)(C), (I))
...
#define _mm256_permute2_ps(X, Y, C, I)                                         \
  (__m256) __builtin_ia32_vpermil2ps256(                                       \
      (__v8sf)(__m256)(X), (__v8sf)(__m256)(Y), (__v8si)(__m256i)(C), (I))
