...
class _LIBCPP_HIDDEN __thread_struct_imp {
  typedef vector<__assoc_sub_state*, __hidden_allocator<__assoc_sub_state*> >
      _AsyncStates;
...
__thread_struct_imp::~__thread_struct_imp() {
  ...
  for (_AsyncStates::iterator i = async_states_.begin(),
                              e = async_states_.end();
       i != e; ++i) {
    (*i)->__make_ready();
    (*i)->__release_shared();
...
void __thread_struct_imp::notify_all_at_thread_exit(condition_variable* cv,
                                                    mutex* m) {
...
void __thread_struct::notify_all_at_thread_exit(condition_variable* cv,
                                                mutex* m) {
