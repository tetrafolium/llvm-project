...
public:
    ...
    inline void projectOut(unsigned pos) {
        return projectOut(pos, 1);
    }
    ...
    inline unsigned getNumIds() const {
        return numIds;
    }
    inline unsigned getNumDimIds() const {
        return numDims;
    }
    inline unsigned getNumSymbolIds() const {
        return numSymbols;
    }
    inline unsigned getNumDimAndSymbolIds() const {
    ...
    inline Optional<Value> getId(unsigned pos) const {
        return ids[pos];
    }
    inline Optional<Value> &getId(unsigned pos) {
        return ids[pos];
    }
