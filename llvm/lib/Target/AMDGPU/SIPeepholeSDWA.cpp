...
public:
    ...
    MachineOperand *getTargetOperand() const {
        return Target;
    }
    MachineOperand *getReplacedOperand() const {
        return Replaced;
    }
    MachineInstr *getParentInst() const {
...
public:
    ...
    SdwaSel getDstSel() const {
        return DstSel;
    }
    DstUnused getDstUnused() const {
        return DstUn;
    }
...
public:
    ...
    MachineOperand *getPreservedOperand() const {
        return Preserve;
    }
...
SIPeepholeSDWA::matchSDWAOperand(MachineInstr &MI) {
    ...
    case AMDGPU::V_OR_B32_e64: {
        ...
        switch (DstSel) {
        case WORD_0:
            DstSelAgree = ((OtherDstSel == BYTE_2) ||
                           (OtherDstSel == BYTE_3) ||
                           (OtherDstSel == WORD_1));
            break;
        case WORD_1:
            DstSelAgree = ((OtherDstSel == BYTE_0) ||
                           (OtherDstSel == BYTE_1) ||
                           (OtherDstSel == WORD_0));
            break;
        case BYTE_0:
            DstSelAgree = ((OtherDstSel == BYTE_1) ||
                           (OtherDstSel == BYTE_2) ||
                           (OtherDstSel == BYTE_3) ||
                           (OtherDstSel == WORD_1));
            break;
