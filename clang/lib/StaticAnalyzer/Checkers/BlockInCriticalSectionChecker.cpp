...
class BlockInCriticalSectionChecker : public Checker<check::PostCall> {
  ...
  CallDescription LockFn, UnlockFn, SleepFn, GetcFn, FgetsFn, ReadFn, RecvFn,
      PthreadLockFn, PthreadTryLockFn, PthreadUnlockFn, MtxLock, MtxTimedLock,
...
BlockInCriticalSectionChecker::BlockInCriticalSectionChecker()
    : IILockGuard(nullptr), IIUniqueLock(nullptr), LockFn("lock"),
      UnlockFn("unlock"), SleepFn("sleep"), GetcFn("getc"), FgetsFn("fgets"),
      ReadFn("read"), RecvFn("recv"), PthreadLockFn("pthread_mutex_lock"),
  ...
  BlockInCritSectionBugType.reset(new BugType(
...
bool BlockInCriticalSectionChecker::isBlockingFunction(
  ...
  if (Call.isCalled(SleepFn) || Call.isCalled(GetcFn) ||
      Call.isCalled(FgetsFn) || Call.isCalled(ReadFn) ||
...
bool BlockInCriticalSectionChecker::isLockFunction(
  ...
  if (Call.isCalled(LockFn) || Call.isCalled(PthreadLockFn) ||
      Call.isCalled(PthreadTryLockFn) || Call.isCalled(MtxLock) ||
      Call.isCalled(MtxTimedLock) || Call.isCalled(MtxTryLock)) {
    return true;
  }
  return false;
}
...
bool BlockInCriticalSectionChecker::isUnlockFunction(
  ...
  if (Call.isCalled(UnlockFn) || Call.isCalled(PthreadUnlockFn) ||
