...
private:
    interp::Frame *getCurrentFrame() override {
        return CurrentCall;
    }
    const interp::Frame *getBottomFrame() const override {
        return &BottomFrame;
    }
...
public:
    ...
    public:
        ...
        ~ArrayInitLoopIndex() {
            Info.ArrayInitIndex = OuterIndex;
        }
...
struct LValue {
    ...
    const APValue::LValueBase getLValueBase() const {
        return Base;
    }
...
static ICEDiag NoDiag() {
    return ICEDiag(IK_ICE, SourceLocation());
}
