...
public:
    ...
    bool isSlowDivBypassed() const {
        return !BypassSlowDivWidths.empty();
    }
...
public:
    ...
    public:
        ...
        bool isBeforeLegalize() const {
            return Level == BeforeLegalizeTypes;
        }
        bool isBeforeLegalizeOps() const {
            return Level < AfterLegalizeVectorOps;
        }
