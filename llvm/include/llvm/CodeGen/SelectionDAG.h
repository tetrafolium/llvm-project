...
public:
    ...
    DbgIterator DbgBegin() {
        return DbgValues.begin();
    }
    DbgIterator DbgEnd()   {
        return DbgValues.end();
    }
    DbgIterator ByvalParmDbgBegin() {
        return ByvalParmDbgValues.begin();
    }
    DbgIterator ByvalParmDbgEnd()   {
        return ByvalParmDbgValues.end();
    }
    DbgLabelIterator DbgLabelBegin() {
        return DbgLabels.begin();
    }
    DbgLabelIterator DbgLabelEnd()   {
        return DbgLabels.end();
    }
};
...
public:
    ...
    public:
        ...
        ~FlagInserter() {
            DAG.setFlagInserter(LastInserter);
        }
...
public:
    ...
    bool hasDebugValues() const {
        return !DbgInfo->empty();
    }

    SDDbgInfo::DbgIterator DbgBegin() const {
        return DbgInfo->DbgBegin();
    }
    SDDbgInfo::DbgIterator DbgEnd() const  {
        return DbgInfo->DbgEnd();
    }
