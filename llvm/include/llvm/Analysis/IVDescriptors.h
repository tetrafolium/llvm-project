...
public:
    ...
    public:
        ...
        bool hasUnsafeAlgebra() {
            return UnsafeAlgebraInst != nullptr;
        }

        Instruction *getUnsafeAlgebraInst() {
            return UnsafeAlgebraInst;
        }
    ...
    RecurrenceKind getRecurrenceKind() const {
        return Kind;
    }
    ...
    MinMaxRecurrenceKind getMinMaxRecurrenceKind() const {
        return MinMaxKind;
    }
    ...
    Instruction *getUnsafeAlgebraInst() const {
        return UnsafeAlgebraInst;
    }
