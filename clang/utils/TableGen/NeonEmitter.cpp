...
public:
    ...
    // Query functions
    //
    bool isScalarForMangling() const {
        return ScalarForMangling;
    }
    bool noManglingQ() const {
        return NoManglingQ;
    }
    ...
    bool isFloat() const {
        return isFloating() && ElementBitwidth == 32;
    }
    bool isDouble() const {
        return isFloating() && ElementBitwidth == 64;
    }
    bool isHalf() const {
        return isFloating() && ElementBitwidth == 16;
    }
    bool isChar() const {
        return ElementBitwidth == 8;
    }
    bool isShort() const {
        return isInteger() && ElementBitwidth == 16;
    }
    bool isInt() const {
        return isInteger() && ElementBitwidth == 32;
    }
    bool isLong() const {
        return isInteger() && ElementBitwidth == 64;
    }
    bool isVoid() const {
        return Kind == Void;
    }
...
public:
    ...
    Type getPolymorphicKeyType() const {
        return Types[PolymorphicKeyType];
    }
    ...
    bool hasBody() const {
        return Body && !Body->getValues().empty();
    }
