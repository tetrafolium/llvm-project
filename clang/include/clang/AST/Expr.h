...
public:
    ...
    public:
        ...
        bool isPRValue() const {
            return Kind >= CL_Function;
        }
        bool isRValue() const {
            return Kind >= CL_XValue;
        }
        bool isModifiable() const {
            return getModifiable() == CM_Modifiable;
        }
...
public:
    ...
    bool refersToBitField() const {
        return getObjectKind() == OK_BitField;
    }
...
public:
    ...
    APValue &getResultAsAPValue() const {
...
public:
    ...
    SourceLocation getLocation() const {
        return OpaqueValueExprBits.Loc;
    }
...
public:
    ...
    bool hasQualifier() const {
        return DeclRefExprBits.HasQualifier;
    }
...
public:
    ...
    unsigned getByteLength() const {
        return getCharByteWidth() * getLength();
    }
    unsigned getLength() const {
        return *getTrailingObjects<unsigned>();
    }
    unsigned getCharByteWidth() const {
        return StringLiteralBits.CharByteWidth;
    }
    ...
    bool isUTF16() const {
        return getKind() == UTF16;
    }
    bool isUTF32() const {
        return getKind() == UTF32;
    }
    bool isPascal() const {
...
public:
    ...
    bool canOverflow() const {
        return UnaryOperatorBits.CanOverflow;
    }
    void setCanOverflow(bool C) {
        UnaryOperatorBits.CanOverflow = C;
    }
    ...
    bool hasStoredFPFeatures() const {
        return UnaryOperatorBits.HasFPFeatures;
    }
...
public:
    ...
    bool isArgumentType() const {
        return UnaryExprOrTypeTraitExprBits.IsType;
    }
...
public:
    ...
    Expr *getRowIdx() {
        return cast<Expr>(SubExprs[ROW_IDX]);
    }
    ...
    Expr *getColumnIdx() {
        return cast_or_null<Expr>(SubExprs[COLUMN_IDX]);
    }
...
protected:
    ...
    unsigned getNumPreArgs() const {
        return CallExprBits.NumPreArgs;
    }
...
public:
    ...
    Expr *getCallee() {
        return cast<Expr>(getTrailingStmts()[FN]);
    }
    const Expr *getCallee() const {
        return cast<Expr>(getTrailingStmts()[FN]);
    }
    void setCallee(Expr *F) {
        getTrailingStmts()[FN] = F;
    }
    ...
    bool hasStoredFPFeatures() const {
        return CallExprBits.HasFPFeatures;
    }
...
public:
    ...
    SourceLocation getOperatorLoc() const {
        return MemberExprBits.OperatorLoc;
    }
...
public:
    CastKind getCastKind() const {
        return (CastKind) CastExprBits.Kind;
    }
    ...
    const char *getCastKindName() const {
        return getCastKindName(getCastKind());
    }
    ...
    bool hasStoredFPFeatures() const {
        return CastExprBits.HasFPFeatures;
    }
    ...
    const_child_range children() const {
        return const_child_range(&Op, &Op + 1);
    }
};
...
public:
    ...
    SourceLocation getOperatorLoc() const {
        return BinaryOperatorBits.OpLoc;
    }
    void setOperatorLoc(SourceLocation L) {
        BinaryOperatorBits.OpLoc = L;
    }
    ...
    void setHasStoredFPFeatures(bool B) {
        BinaryOperatorBits.HasFPFeatures = B;
    }
    bool hasStoredFPFeatures() const {
        return BinaryOperatorBits.HasFPFeatures;
    }
...
public:
    ...
    //   the ?: operator.
    Expr *getCond() const {
        return cast<Expr>(SubExprs[COND]);
    }
...
public:
    ...
    Expr *getCommon() const {
        return cast<Expr>(SubExprs[COMMON]);
    }
...
public:
    ...
    CompoundStmt *getSubStmt() {
        return cast<CompoundStmt>(SubStmt);
    }
    ...
    unsigned getTemplateDepth() const {
        return StmtExprBits.TemplateDepth;
    }
...
public:
    ...
    Expr **getInits() {
        return reinterpret_cast<Expr **>(InitExprs.data());
    }
...
public:
    ...
    bool isDirectInit() const {
        return EqualOrColonLoc.isInvalid();
    }
...
public:
    ...
    Expr *getBase() const {
        return cast<Expr>(BaseAndUpdaterExprs[0]);
    }
...
public:
    ...
    unsigned getNumExprs() const {
        return ParenListExprBits.NumExprs;
    }
...
class GenericSelectionExpr final
    ...
    public:
        ExprPtrTy getAssociationExpr() const {
            return E;
        }
        TSIPtrTy getTypeSourceInfo() const {
            return TSI;
        }
        QualType getType() const {
        ...
        AssociationTy *operator->() {
            return this;
        }
        const AssociationTy *operator->() const {
            return this;
        }
    }; // class AssociationTy
    ...
    public:
        ...
        typename BaseTy::pointer operator->() const {
            return **this;
        }
        ...
        bool operator==(AssociationIteratorTy Other) const {
            return E == Other.E;
        }
...
public:
    ...
    bool isResultDependent() const {
        return ResultIndex == ResultDependentIndex;
    }
