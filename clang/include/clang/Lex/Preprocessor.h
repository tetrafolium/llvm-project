...
private:
    ...
    public:
        ...
        void startRecording() {
            ConditionalStackState = Recording;
        }
        void startReplaying() {
            ConditionalStackState = Replaying;
        }
...
public:
    ...
    bool isCodeCompletionEnabled() const {
        return CodeCompletionFile != nullptr;
    }
