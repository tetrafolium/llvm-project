...
public:
    ...
    public:
        ...
        bool isCXXThisExprCaptured() const {
            return getThisFieldDecl() != nullptr;
        }
...
public:
    ...
    public:
        ...
        ~OMPLocalDeclMapRAII() {
            SavedMap.swap(CGF.LocalDeclMap);
        }
    };
    ...
    bool isInConditionalBranch() const {
        return OutermostConditional != nullptr;
    }
