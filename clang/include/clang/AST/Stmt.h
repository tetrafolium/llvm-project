...
protected:
    ...
    unsigned /*ExprDependence*/ Dependent :
        llvm::BitWidth<ExprDependence>;
    };
...
public:
    ...
    SourceLocation getSemiLoc() const {
        return NullStmtBits.SemiLoc;
    }
    void setSemiLoc(SourceLocation L) {
        NullStmtBits.SemiLoc = L;
    }
...
public:
    ...
    body_range body() {
        return body_range(body_begin(), body_end());
    }
    body_iterator body_begin() {
        return getTrailingObjects<Stmt *>();
    }
    body_iterator body_end() {
        return body_begin() + size();
    }
    Stmt *body_front() {
    ...
    SourceLocation getBeginLoc() const {
        return CompoundStmtBits.LBraceLoc;
    }
    SourceLocation getEndLoc() const {
        return RBraceLoc;
    }
    ...
    // Iterators
    child_range children() {
        return child_range(body_begin(), body_end());
    }
...
public:
    ...
    SourceLocation getKeywordLoc() const {
        return SwitchCaseBits.KeywordLoc;
    }
    void setKeywordLoc(SourceLocation L) {
        SwitchCaseBits.KeywordLoc = L;
    }
...
class CaseStmt final
    ...
    unsigned lhsOffset() const {
        return LhsOffset;
    }
    unsigned rhsOffset() const {
...
public:
    ...
    bool caseStmtIsGNURange() const {
        return SwitchCaseBits.CaseStmtIsGNURange;
    }
...
public:
    ...
    SourceLocation getIdentLoc() const {
        return LabelStmtBits.IdentLoc;
    }
    void setIdentLoc(SourceLocation L) {
        LabelStmtBits.IdentLoc = L;
    }
...
public:
    ...
    SourceLocation getAttrLoc() const {
        return AttributedStmtBits.AttrLoc;
    }
...
class IfStmt final
    ...
    unsigned initOffset() const {
        return InitOffset;
    }
    unsigned varOffset() const {
        return InitOffset + hasInitStorage();
    }
    unsigned condOffset() const {
        return InitOffset + hasInitStorage() + hasVarStorage();
    }
    unsigned thenOffset() const {
        return condOffset() + ThenOffsetFromCond;
    }
    unsigned elseOffset() const {
...
public:
    ...
    bool hasInitStorage() const {
        return IfStmtBits.HasInit;
    }

    /// True if this IfStmt has storage for a variable declaration.
    bool hasVarStorage() const {
        return IfStmtBits.HasVar;
    }

    /// True if this IfStmt has storage for an else statement.
    bool hasElseStorage() const {
        return IfStmtBits.HasElse;
    }
    ...
    SourceLocation getIfLoc() const {
        return IfStmtBits.IfLoc;
    }
    void setIfLoc(SourceLocation IfLoc) {
        IfStmtBits.IfLoc = IfLoc;
    }
    ...
    bool isConstexpr() const {
        return IfStmtBits.IsConstexpr;
    }
    void setConstexpr(bool C) {
        IfStmtBits.IsConstexpr = C;
    }
...
public:
    ...
    bool hasInitStorage() const {
        return SwitchStmtBits.HasInit;
    }

    /// True if this SwitchStmt has storage for a condition variable.
    bool hasVarStorage() const {
        return SwitchStmtBits.HasVar;
    }
    ...
    SourceLocation getSwitchLoc() const {
        return SwitchStmtBits.SwitchLoc;
    }
    void setSwitchLoc(SourceLocation L) {
        SwitchStmtBits.SwitchLoc = L;
    }
    SourceLocation getLParenLoc() const {
        return LParenLoc;
    }
    ...
    void setAllEnumCasesCovered() {
        SwitchStmtBits.AllEnumCasesCovered = true;
    }
...
public:
    ...
    SourceLocation getWhileLoc() const {
        return WhileStmtBits.WhileLoc;
    }
    void setWhileLoc(SourceLocation L) {
        WhileStmtBits.WhileLoc = L;
    }
...
public:
    ...
    void setCond(Expr *E) {
        SubExprs[COND] = reinterpret_cast<Stmt*>(E);
    }
    void setInc(Expr *E) {
        SubExprs[INC] = reinterpret_cast<Stmt*>(E);
    }
    void setBody(Stmt *S) {
        SubExprs[BODY] = S;
    }
    ...
    SourceLocation getForLoc() const {
        return ForStmtBits.ForLoc;
    }
    void setForLoc(SourceLocation L) {
        ForStmtBits.ForLoc = L;
    }
    SourceLocation getLParenLoc() const {
        return LParenLoc;
    }
...
public:
    ...
    SourceLocation getGotoLoc() const {
        return GotoStmtBits.GotoLoc;
    }
    void setGotoLoc(SourceLocation L) {
        GotoStmtBits.GotoLoc = L;
    }
...
public:
    ...
    Expr *getTarget() {
        return reinterpret_cast<Expr *>(Target);
    }
    const Expr *getTarget() const {
        return reinterpret_cast<const Expr *>(Target);
    }
    void setTarget(Expr *E) {
        Target = reinterpret_cast<Stmt *>(E);
    }
...
public:
    ...
    SourceLocation getContinueLoc() const {
        return ContinueStmtBits.ContinueLoc;
    }
    void setContinueLoc(SourceLocation L) {
        ContinueStmtBits.ContinueLoc = L;
    }

    SourceLocation getBeginLoc() const {
        return getContinueLoc();
    }
    SourceLocation getEndLoc() const {
        return getContinueLoc();
    }
...
public:
    ...
    SourceLocation getBreakLoc() const {
        return BreakStmtBits.BreakLoc;
    }
    void setBreakLoc(SourceLocation L) {
        BreakStmtBits.BreakLoc = L;
    }
...
public:
    ...
    void setRetValue(Expr *E) {
        RetExpr = reinterpret_cast<Stmt *>(E);
    }
    ...
    SourceLocation getReturnLoc() const {
        return ReturnStmtBits.RetLoc;
    }
    void setReturnLoc(SourceLocation L) {
        ReturnStmtBits.RetLoc = L;
    }
...
public:
    ...
    inputs_range inputs() {
        return inputs_range(begin_inputs(), end_inputs());
    }
...
public:
    ...
    SourceLocation getEndLoc() const {
        return Block->getEndLoc();
    }

    CompoundStmt *getBlock() const {
        return cast<CompoundStmt>(Block);
    }
...
public:
    ...
    SourceLocation getEndLoc() const {
        return Children[HANDLER]->getEndLoc();
    }
...
public:
    ...
    public:
        ...
        bool capturesThis() const {
            return getCaptureKind() == VCK_This;
        }

        /// Determine whether this capture handles a variable (by reference).
        bool capturesVariable() const {
            return getCaptureKind() == VCK_ByRef;
        }
...
private:
    ...
    void setCapturedStmt(Stmt *S) {
        getStoredStmts()[NumCaptures] = S;
    }
