...
private:
  ...
  bool IgnoresVEX_W;
  /// Inferred from the operands; indicates whether the L bit in the VEX prefix
  /// is set
  bool HasVEX_LPrefix;
  ...
  static OperandType typeFromString(const std::string &s, bool hasREX_WPrefix,
                                    uint8_t OpSize);
  ...
  bool shouldBeEmitted() const { return ShouldBeEmitted; }
