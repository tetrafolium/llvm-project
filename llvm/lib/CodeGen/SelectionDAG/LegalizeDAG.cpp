...
SDValue SelectionDAGLegalize::ExpandLegalINT_TO_FP(SDNode *Node,
  ...
  if (SrcVT == MVT::i32 && TLI.isTypeLegal(MVT::f64) &&
    ...
    SDValue Bias =
        DAG.getConstantFP(isSigned ? BitsToDouble(0x4330000080000000ULL)
...
SDValue SelectionDAGLegalize::ExpandBSWAP(SDValue Op, const SDLoc &dl) {
  ...
  default:
    llvm_unreachable("Unhandled Expand type in BSWAP!");
  case MVT::i16:
  ...
  case MVT::i32:
    ...
    Tmp3 =
        DAG.getNode(ISD::AND, dl, VT, Tmp3, DAG.getConstant(0xFF0000, dl, VT));
...
void SelectionDAGLegalize::ConvertNodeToLibcall(SDNode *Node) {
  ...
  case ISD::STRICT_FPOWI: {
    ...
    ExpandFPLibCall(Node, RTLIB::POWI_F32, RTLIB::POWI_F64, RTLIB::POWI_F80,
                    RTLIB::POWI_F128, RTLIB::POWI_PPCF128, Results);
    break;
  }
  case ISD::FPOW:
...
void SelectionDAGLegalize::PromoteNode(SDNode *Node) {
  ...
  case ISD::FPOW:
    ...
    Results.push_back(DAG.getNode(ISD::FP_ROUND, dl, OVT, Tmp3,
                                  DAG.getIntPtrConstant(0, dl)));
    break;
  case ISD::STRICT_FREM:
  case ISD::STRICT_FPOW:
  ...
  case ISD::FPOWI: {
    ...
    Results.push_back(DAG.getNode(ISD::FP_ROUND, dl, OVT, Tmp3,
                                  DAG.getIntPtrConstant(isTrunc, dl)));
    break;
  }
  case ISD::FFLOOR:
  case ISD::FCEIL:
  ...
  case ISD::FEXP2:
    ...
    Results.push_back(DAG.getNode(ISD::FP_ROUND, dl, OVT, Tmp2,
                                  DAG.getIntPtrConstant(0, dl)));
    break;
  case ISD::STRICT_FFLOOR:
  case ISD::STRICT_FCEIL:
