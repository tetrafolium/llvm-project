...
Tool *MachO::buildLinker() const {
    return new tools::darwin::Linker(*this);
}
...
struct DarwinPlatform {
    ...
    DarwinPlatformKind getPlatform() const {
        return Platform;
    }

    DarwinEnvironmentKind getEnvironment() const {
        return Environment;
    }
    ...
    bool canInferSimulatorFromArch() const {
