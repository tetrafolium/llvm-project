 ...
 */
static TYPE *SF(basic_map_partial_lexopt_symm,
                SUFFIX)(__isl_take isl_basic_map *bmap,
                        __isl_take isl_basic_set *dom,
                        __isl_give isl_set **empty, int max, int first,
                        int second) {
  int i, n, k;
  int *list = NULL;
  ...
  return SF(basic_map_partial_lexopt_symm_core,
            SUFFIX)(bmap, dom, empty, max, cst, map_space, set_space);
error:
...
static __isl_give TYPE *SF(basic_map_partial_lexopt,
  ...
  if (par < 0)
    goto error;
  if (!par)
    return SF(basic_map_partial_lexopt_base, SUFFIX)(bmap, dom, empty, max);

  return SF(basic_map_partial_lexopt_symm, SUFFIX)(bmap, dom, empty, max, first,
                                                   second);
error:
  isl_basic_set_free(dom);
  isl_basic_map_free(bmap);
 ...
 */
__isl_give TYPE *SF(isl_tab_basic_map_partial_lexopt,
                    SUFFIX)(__isl_take isl_basic_map *bmap,
                            __isl_take isl_basic_set *dom,
