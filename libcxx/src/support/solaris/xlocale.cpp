...
int isxdigit_l(int __c, locale_t __l) { return isxdigit(__c); }

int iswxdigit_l(wint_t __c, locale_t __l) { return isxdigit(__c); }
...
size_t mbrtowc_l(wchar_t* __pwc, const char* __pmb, size_t __max,
