...
#define _mm_round_ss(X, Y, M)                                                  \
  (__m128) __builtin_ia32_roundss((__v4sf)(__m128)(X), (__v4sf)(__m128)(Y), (M))
...
#define _mm_round_sd(X, Y, M)                                                  \
  (__m128d)                                                                    \
      __builtin_ia32_roundsd((__v2df)(__m128d)(X), (__v2df)(__m128d)(Y), (M))
...
#define _mm_dp_pd(X, Y, M)                                                     \
  (__m128d) __builtin_ia32_dppd((__v2df)(__m128d)(X), (__v2df)(__m128d)(Y), (M))
...
#define _mm_insert_epi8(X, I, N)                                               \
  (__m128i)                                                                    \
      __builtin_ia32_vec_set_v16qi((__v16qi)(__m128i)(X), (int)(I), (int)(N))
...
#define _mm_insert_epi32(X, I, N)                                              \
  (__m128i)                                                                    \
      __builtin_ia32_vec_set_v4si((__v4si)(__m128i)(X), (int)(I), (int)(N))
...
#define _mm_cmpestrm(A, LA, B, LB, M)                                          \
  (__m128i)                                                                    \
      __builtin_ia32_pcmpestrm128((__v16qi)(__m128i)(A), (int)(LA),            \
                                  (__v16qi)(__m128i)(B), (int)(LB), (int)(M))
