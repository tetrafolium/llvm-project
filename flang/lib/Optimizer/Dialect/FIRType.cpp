...
struct SequenceTypeStorage : public mlir::TypeStorage {
    ...
    SequenceType::Shape getShape() const {
        return shape;
    }
    mlir::Type getElementType() const {
        return eleTy;
...
struct RecordTypeStorage : public mlir::TypeStorage {
    ...
    llvm::ArrayRef<RecordType::TypePair> getLenParamList() const {
        return lens;
    }

    void setTypeList(llvm::ArrayRef<RecordType::TypePair> list) {
        types = list;
    }
    llvm::ArrayRef<RecordType::TypePair> getTypeList() const {
        return types;
    }
...
int fir::CharacterType::getFKind() const {
...
unsigned fir::DimsType::getRank() const {
...
int fir::LogicalType::getFKind() const {
    return getImpl()->getFKind();
}
...
int fir::IntType::getFKind() const {
    return getImpl()->getFKind();
}
...
KindTy fir::CplxType::getFKind() const {
    return getImpl()->getFKind();
}
...
int fir::RealType::getFKind() const {
    return getImpl()->getFKind();
}
...
llvm::StringRef fir::RecordType::getName() {
...
mlir::Type fir::TypeDescType::getOfTy() const {
    return getImpl()->getOfType();
}
