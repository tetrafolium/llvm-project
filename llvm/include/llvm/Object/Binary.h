...
public:
    ...
    bool isTapiUniversal() const {
        return TypeID == ID_TapiUniversal;
    }
    ...
    bool isXCOFF() const {
        return TypeID == ID_XCOFF32 || TypeID == ID_XCOFF64;
    }

    bool isWasm() const {
        return TypeID == ID_Wasm;
    }
    ...
    bool isMinidump() const {
        return TypeID == ID_Minidump;
    }

    bool isTapiFile() const {
        return TypeID == ID_TapiFile;
    }
