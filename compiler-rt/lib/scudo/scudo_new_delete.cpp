...
#define OPERATOR_DELETE_BODY(Type) scudoDeallocate(ptr, 0, 0, Type);
#define OPERATOR_DELETE_BODY_SIZE(Type) scudoDeallocate(ptr, size, 0, Type);
...
CXX_OPERATOR_ATTRIBUTE
void operator delete(void *ptr)NOEXCEPT { OPERATOR_DELETE_BODY(FromNew); }
CXX_OPERATOR_ATTRIBUTE
