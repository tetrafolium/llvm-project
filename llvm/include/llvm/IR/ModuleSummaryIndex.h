...
struct ValueInfo {
    ...
    bool haveGVs() const {
        return RefAndFlags.getInt() & HaveGV;
    }
...
public:
    ...
    bool notEligibleToImport() const {
        return Flags.NotEligibleToImport;
    }
    ...
    void setDSOLocal(bool Local) {
        Flags.DSOLocal = Local;
    }

    bool isDSOLocal() const {
        return Flags.DSOLocal;
    }

    void setCanAutoHide(bool CanAutoHide) {
        Flags.CanAutoHide = CanAutoHide;
    }

    bool canAutoHide() const {
        return Flags.CanAutoHide;
    }

    /// Flag that this global value cannot be imported.
    void setNotEligibleToImport() {
        Flags.NotEligibleToImport = true;
    }
...
public:
    ...
    void setReadOnly(bool RO) {
        VarFlags.MaybeReadOnly = RO;
    }
    void setWriteOnly(bool WO) {
        VarFlags.MaybeWriteOnly = WO;
    }
    bool maybeReadOnly() const {
        return VarFlags.MaybeReadOnly;
    }
    bool maybeWriteOnly() const {
        return VarFlags.MaybeWriteOnly;
    }
    bool isConstant() const {
        return VarFlags.Constant;
    }
...
public:
    ...
    bool withAttributePropagation() const {
        return WithAttributePropagation;
    }
    ...
    bool hasSyntheticEntryCounts() const {
        return HasSyntheticEntryCounts;
    }
    void setHasSyntheticEntryCounts() {
        HasSyntheticEntryCounts = true;
    }
    ...
    void setEnableSplitLTOUnit() {
        EnableSplitLTOUnit = true;
    }

    bool partiallySplitLTOUnits() const {
        return PartiallySplitLTOUnits;
    }
    void setPartiallySplitLTOUnits() {
        PartiallySplitLTOUnits = true;
    }

    bool hasParamAccess() const {
        return HasParamAccess;
    }
