 ...
 */
static __isl_keep const isl_basic_map *
const_bset_to_bmap(__isl_keep const isl_basic_set *bset) {
...
isl_size isl_basic_map_dim(__isl_keep isl_basic_map *bmap,
  ...
  case isl_dim_in:
  case isl_dim_out:
    return isl_space_dim(bmap->dim, type);
  case isl_dim_div:
    return bmap->n_div;
  case isl_dim_all:
...
isl_size isl_basic_map_var_offset(__isl_keep isl_basic_map *bmap,
  ...
  case isl_dim_in:
  case isl_dim_out:
    return isl_space_offset(space, type);
  case isl_dim_div:
...
unsigned isl_basic_map_offset(__isl_keep isl_basic_map *bmap,
  ...
  case isl_dim_out:
  case isl_dim_div:
    return 1 + isl_basic_map_var_offset(bmap, type);
  default:
    return 0;
  }
}
 ...
 */
static isl_bool
isl_basic_map_has_equal_params(__isl_keep isl_basic_map *bmap1,
 ...
 */
static isl_bool
isl_basic_map_set_tuple_is_equal(__isl_keep isl_basic_map *bmap,
                                 enum isl_dim_type type,
  ...
  return isl_space_tuple_is_equal(bmap_space, type, bset_space, isl_dim_set);
}
...
isl_basic_map_peek_space(__isl_keep const isl_basic_map *bmap) {
...
isl_basic_map_take_space(__isl_keep isl_basic_map *bmap) {
  isl_space *space;
 ...
 */
static __isl_give isl_basic_map *
isl_basic_map_restore_space(__isl_take isl_basic_map *bmap,
...
isl_basic_map_get_local_space(__isl_keep isl_basic_map *bmap) {
  isl_mat *div;
...
__isl_give isl_local_space *
isl_basic_set_get_local_space(__isl_keep isl_basic_set *bset) {
 ...
 */
static __isl_give isl_basic_map *
add_known_div_constraints(__isl_take isl_basic_map *bmap) {
  int i;
  isl_size n_div;
...
isl_basic_map_from_local_space(__isl_take isl_local_space *ls) {
  int i;
  isl_size n_div;
  isl_basic_map *bmap;
  ...
  bmap = isl_basic_map_alloc_space(isl_local_space_get_space(ls), n_div, 0,
                                   2 * n_div);
...
isl_basic_set_from_local_space(__isl_take isl_local_space *ls) {
...
__isl_give isl_basic_map *
isl_basic_map_set_tuple_name(__isl_take isl_basic_map *bmap,
...
__isl_give isl_basic_set *
isl_basic_set_set_tuple_name(__isl_take isl_basic_set *bset, const char *s) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_set_tuple_id(__isl_take isl_basic_map *bmap,
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_set_tuple_id(__isl_take isl_basic_set *bset,
...
__isl_give isl_set *isl_set_set_tuple_name(__isl_take isl_set *set,
                                           const char *s) {
  return set_from_map(isl_map_set_tuple_name(set_to_map(set), isl_dim_set, s));
}
 ...
 */
isl_bool isl_map_has_dim_name(__isl_keep isl_map *map, enum isl_dim_type type,
                              unsigned pos) {
  if (!map)
    return isl_bool_error;
...
/* Does the given dimension have a name?
 */
isl_bool isl_set_has_dim_name(__isl_keep isl_set *set, enum isl_dim_type type,
                              unsigned pos) {
  if (!set)
    return isl_bool_error;
...
__isl_give isl_basic_map *
isl_basic_map_set_dim_name(__isl_take isl_basic_map *bmap,
                           enum isl_dim_type type, unsigned pos,
                           const char *s) {
  isl_space *space;
...
__isl_give isl_basic_set *
isl_basic_set_set_dim_name(__isl_take isl_basic_set *bset,
                           enum isl_dim_type type, unsigned pos,
                           const char *s) {
  return bset_from_bmap(
      isl_basic_map_set_dim_name(bset_to_bmap(bset), type, pos, s));
}

__isl_give isl_set *isl_set_set_dim_name(__isl_take isl_set *set,
                                         enum isl_dim_type type, unsigned pos,
                                         const char *s) {
  return set_from_map(isl_map_set_dim_name(set_to_map(set), type, pos, s));
}
...
isl_bool isl_map_has_dim_id(__isl_keep isl_map *map, enum isl_dim_type type,
                            unsigned pos) {
...
isl_bool isl_set_has_dim_id(__isl_keep isl_set *set, enum isl_dim_type type,
                            unsigned pos) {
  ...
  if (bmap->n_eq == total) {
    ...
    for (i = 0; i < bmap->n_eq; ++i) {
      ...
      if (!isl_int_is_one(bmap->eq[i][1 + j]) &&
        ...
        break;
      j = isl_seq_first_non_zero(bmap->eq[i] + 1 + j + 1, total - j - 1);
      if (j >= 0)
        break;
    }
    if (i == bmap->n_eq)
...
__isl_give isl_basic_set *isl_basic_set_alloc(isl_ctx *ctx, unsigned nparam,
                                              unsigned dim, unsigned extra,
...
__isl_give isl_basic_map *isl_basic_map_alloc(isl_ctx *ctx, unsigned nparam,
...
static __isl_give isl_basic_map *
dup_constraints(__isl_take isl_basic_map *dst, __isl_keep isl_basic_map *src) {
  int i;
...
__isl_give isl_basic_map *isl_basic_map_dup(__isl_keep isl_basic_map *bmap) {
  ...
  if (!bmap)
    return NULL;
  dup = isl_basic_map_alloc_space(isl_space_copy(bmap->dim), bmap->n_div,
                                  bmap->n_eq, bmap->n_ineq);
...
isl_stat isl_basic_set_check_no_params(__isl_keep isl_basic_set *bset) {
  ...
  if (nparam != 0)
    isl_die(isl_basic_set_get_ctx(bset), isl_error_invalid,
            "basic set should not have any parameters", return isl_stat_error);
  return isl_stat_ok;
}
...
#include "isl_check_named_params_templ.c"
     ...
     */
    static isl_stat
    isl_basic_map_check_equal_params(__isl_keep isl_basic_map *bmap1,
                                     __isl_keep isl_basic_map *bmap2) {
  isl_bool match;
...
isl_bool isl_map_align_params_map_map_and_test(
...
__isl_give isl_basic_map *
isl_basic_map_free_equality(__isl_take isl_basic_map *bmap, unsigned n) {
  if (!bmap)
    return NULL;
  if (n > bmap->n_eq)
    isl_die(isl_basic_map_get_ctx(bmap), isl_error_invalid,
            "invalid number of equalities", isl_basic_map_free(bmap));
  bmap->n_eq -= n;
  return bmap;
}

__isl_give isl_basic_set *
isl_basic_set_free_equality(__isl_take isl_basic_set *bset, unsigned n) {
  return bset_from_bmap(isl_basic_map_free_equality(bset_to_bmap(bset), n));
}
...
__isl_give isl_basic_map *
isl_basic_map_free_inequality(__isl_take isl_basic_map *bmap, unsigned n) {
  if (!bmap)
    return NULL;
  if (n > bmap->n_ineq)
    isl_die(isl_basic_map_get_ctx(bmap), isl_error_invalid,
            "invalid number of inequalities", return isl_basic_map_free(bmap));
  bmap->n_ineq -= n;
  return bmap;
}

__isl_give isl_basic_set *
isl_basic_set_free_inequality(__isl_take isl_basic_set *bset, unsigned n) {
  return bset_from_bmap(isl_basic_map_free_inequality(bset_to_bmap(bset), n));
}
...
isl_stat isl_basic_set_check_range(__isl_keep isl_basic_set *bset,
                                   ...
                                   unsigned n) {
  return isl_basic_map_check_range(bset_to_bmap(bset), type, first, n);
}
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_insert_div(__isl_take isl_basic_map *bmap, int pos,
  ...
  if (div->size != 1 + 1 + total)
    isl_die(isl_basic_map_get_ctx(bmap), isl_error_invalid, "unexpected size",
            return isl_basic_map_free(bmap));
...
static __isl_give isl_basic_map *
add_constraints(__isl_take isl_basic_map *bmap1,
                __isl_take isl_basic_map *bmap2, unsigned i_pos,
                unsigned o_pos) {
...
__isl_give isl_basic_set *isl_basic_set_extend(__isl_take isl_basic_set *base,
                                               ...
                                               unsigned n_ineq) {
  return bset_from_bmap(
      isl_basic_map_extend(bset_to_bmap(base), extra, n_eq, n_ineq));
}

__isl_give isl_basic_map *
isl_basic_map_extend_constraints(__isl_take isl_basic_map *base, unsigned n_eq,
                                 unsigned n_ineq) {
  return isl_basic_map_extend(base, 0, n_eq, n_ineq);
}

__isl_give isl_basic_set *
isl_basic_set_extend_constraints(__isl_take isl_basic_set *base, unsigned n_eq,
                                 unsigned n_ineq) {
...
static void swap_vars(struct isl_blk blk, isl_int *a, unsigned a_len,
                      unsigned b_len) {
...
static __isl_give isl_basic_map *
isl_basic_map_swap_vars(__isl_take isl_basic_map *bmap, unsigned pos,
  ...
  for (i = 0; i < bmap->n_eq; ++i)
    swap_vars(blk, bmap->eq[i] + pos, n1, n2);

  for (i = 0; i < bmap->n_ineq; ++i)
    swap_vars(blk, bmap->ineq[i] + pos, n1, n2);

  for (i = 0; i < bmap->n_div; ++i)
    swap_vars(blk, bmap->div[i] + 1 + pos, n1, n2);
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_set_to_empty(__isl_take isl_basic_map *bmap) {
  int i = 0;
  isl_bool empty;
  isl_size total;
...
__isl_give isl_basic_set *
isl_basic_set_set_to_empty(__isl_take isl_basic_set *bset) {
  return bset_from_bmap(isl_basic_map_set_to_empty(bset_to_bmap(bset)));
}

__isl_give isl_basic_map *
isl_basic_map_set_rational(__isl_take isl_basic_map *bmap) {
  if (!bmap)
    return NULL;
...
__isl_give isl_basic_set *
isl_basic_set_set_rational(__isl_take isl_basic_set *bset) {
  return isl_basic_map_set_rational(bset);
}

__isl_give isl_basic_set *
isl_basic_set_set_integral(__isl_take isl_basic_set *bset) {
  if (!bset)
    return NULL;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_drop_dims(__isl_take isl_basic_set *bset, unsigned first,
                        unsigned n) {
...
#include "check_type_range_templ.c"
     ...
     */
    isl_stat
    isl_set_check_range(__isl_keep isl_set *set, enum isl_dim_type type,
                        unsigned first, unsigned n) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_drop_core(__isl_take isl_basic_map *bmap, enum isl_dim_type type,
                        unsigned first, unsigned n) {
  int i;
  unsigned offset;
  unsigned left;
...
__isl_give isl_basic_set *isl_basic_set_drop(__isl_take isl_basic_set *bset,
                                             enum isl_dim_type type,
                                             unsigned first, unsigned n) {
  return bset_from_bmap(isl_basic_map_drop(bset_to_bmap(bset), type, first, n));
}
...
__isl_give isl_basic_map *
isl_basic_map_remove_divs(__isl_take isl_basic_map *bmap) {
  isl_size v_div;
...
__isl_give isl_basic_set *
isl_basic_set_remove_divs(__isl_take isl_basic_set *bset) {
...
__isl_give isl_basic_map *
isl_basic_map_remove_dims(__isl_take isl_basic_map *bmap,
                          enum isl_dim_type type, unsigned first, unsigned n) {
  if (isl_basic_map_check_range(bmap, type, first, n) < 0)
    return isl_basic_map_free(bmap);
  if (n == 0 && !isl_space_is_named_or_nested(bmap->dim, type))
    return bmap;
  bmap = isl_basic_map_eliminate_vars(
      bmap, isl_basic_map_offset(bmap, type) - 1 + first, n);
  if (!bmap)
    return bmap;
 ...
 */
static __isl_give isl_basic_map *
insert_bounds_on_div_from_ineq(__isl_take isl_basic_map *bmap, int div, int i,
                               unsigned total, isl_int v, int lb, int ub) {
  int j;

  for (j = 0; (lb || ub) && j < total + bmap->n_div; ++j) {
    if (lb) {
      isl_int_sub(v, bmap->ineq[i][1 + j], bmap->div[div][1 + 1 + j]);
      lb = isl_int_is_divisible_by(v, bmap->div[div][0]);
    }
    if (ub) {
      isl_int_add(v, bmap->ineq[i][1 + j], bmap->div[div][1 + 1 + j]);
  ...
  if (lb) {
    ...
    for (j = 0; j < 1 + total + bmap->n_div; ++j) {
      isl_int_sub(bmap->ineq[k][j], bmap->ineq[i][j], bmap->div[div][1 + j]);
      isl_int_cdiv_q(bmap->ineq[k][j], bmap->ineq[k][j], bmap->div[div][0]);
    }
  ...
  if (ub) {
    ...
    if (k < 0)
      goto error;
    for (j = 0; j < 1 + total + bmap->n_div; ++j) {
      isl_int_add(bmap->ineq[k][j], bmap->ineq[i][j], bmap->div[div][1 + j]);
      isl_int_fdiv_q(bmap->ineq[k][j], bmap->ineq[k][j], bmap->div[div][0]);
    }
    isl_int_set_si(bmap->ineq[k][1 + total + div], -1);
  }
 ...
 */
static __isl_give isl_basic_map *
insert_bounds_on_div(__isl_take isl_basic_map *bmap, int div) {
  int i;
  ...
  for (i = 0; bmap && i < bmap->n_ineq; ++i) {
    ...
    bmap = insert_bounds_on_div_from_ineq(bmap, div, i, v_div, v, check_lb,
                                          check_ub);
  }
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_remove_divs_involving_dims(__isl_take isl_basic_map *bmap,
                                         enum isl_dim_type type, unsigned first,
                                         unsigned n) {
  int i;
...
__isl_give isl_basic_set *
isl_basic_set_remove_divs_involving_dims(__isl_take isl_basic_set *bset,
                                         enum isl_dim_type type, unsigned first,
                                         unsigned n) {
...
__isl_give isl_map *isl_map_remove_divs_involving_dims(__isl_take isl_map *map,
  ...
  for (i = 0; i < map->n; ++i) {
    map->p[i] =
        isl_basic_map_remove_divs_involving_dims(map->p[i], type, first, n);
    if (!map->p[i])
      goto error;
  }
  return map;
...
__isl_give isl_set *isl_set_remove_divs_involving_dims(__isl_take isl_set *set,
                                                       ...
                                                       unsigned n) {
  return set_from_map(
      isl_map_remove_divs_involving_dims(set_to_map(set), type, first, n));
}
...
isl_bool isl_map_involves_dims(__isl_keep isl_map *map, enum isl_dim_type type,
                               unsigned first, unsigned n) {
  int i;
  ...
  for (i = 0; i < map->n; ++i) {
    isl_bool involves = isl_basic_map_involves_dims(map->p[i], type, first, n);
    if (involves < 0 || involves)
      return involves;
  }
...
isl_bool isl_set_involves_dims(__isl_keep isl_set *set, enum isl_dim_type type,
                               unsigned first, unsigned n) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_drop_constraints_involving(__isl_take isl_basic_map *bmap,
                                         unsigned first, unsigned n) {
  int i;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_drop_constraints_involving(__isl_take isl_basic_set *bset,
                                         unsigned first, unsigned n) {
...
__isl_give isl_basic_set *isl_basic_set_drop_constraints_not_involving_dims(
    ...
    unsigned n) {
  return isl_basic_map_drop_constraints_not_involving_dims(bset, type, first,
                                                           n);
}
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_drop_constraints_involving_dims(__isl_take isl_basic_map *bmap,
                                              enum isl_dim_type type,
                                              unsigned first, unsigned n) {
  if (!bmap)
    return NULL;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_drop_constraints_involving_dims(__isl_take isl_basic_set *bset,
                                              enum isl_dim_type type,
                                              unsigned first, unsigned n) {
  return isl_basic_map_drop_constraints_involving_dims(bset, type, first, n);
}

/* Drop constraints from "map" by applying "drop" to each basic map.
 */
static __isl_give isl_map *drop_constraints(
    __isl_take isl_map *map, enum isl_dim_type type, unsigned first, unsigned n,
 ...
 */
__isl_give isl_map *
isl_map_drop_constraints_involving_dims(__isl_take isl_map *map,
                                        enum isl_dim_type type, unsigned first,
                                        unsigned n) {
  if (n == 0)
    return map;
 ...
 */
__isl_give isl_map *
isl_map_drop_constraints_not_involving_dims(__isl_take isl_map *map,
                                            enum isl_dim_type type,
                                            unsigned first, unsigned n) {
  if (n == 0) {
 ...
 */
__isl_give isl_set *
isl_set_drop_constraints_involving_dims(__isl_take isl_set *set,
                                        enum isl_dim_type type, unsigned first,
                                        unsigned n) {
 ...
 */
__isl_give isl_set *
isl_set_drop_constraints_not_involving_dims(__isl_take isl_set *set,
                                            enum isl_dim_type type,
                                            unsigned first, unsigned n) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_remove_unknown_divs(__isl_take isl_basic_map *bmap) {
  int i;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_remove_unknown_divs(__isl_take isl_basic_set *bset) {
...
__isl_give isl_basic_set *
isl_basic_set_remove_dims(__isl_take isl_basic_set *bset,
                          enum isl_dim_type type, unsigned first, unsigned n) {
...
__isl_give isl_map *isl_map_remove_dims(__isl_take isl_map *map,
  ...
  for (i = 0; i < map->n; ++i) {
    map->p[i] = isl_basic_map_eliminate_vars(
        map->p[i], isl_basic_map_offset(map->p[i], type) - 1 + first, n);
    if (!map->p[i])
      goto error;
  }
...
__isl_give isl_set *isl_set_remove_dims(__isl_take isl_set *bset,
                                        enum isl_dim_type type, unsigned first,
                                        unsigned n) {
  return set_from_map(isl_map_remove_dims(set_to_map(bset), type, first, n));
}
...
void isl_basic_set_print_internal(__isl_keep isl_basic_set *bset, FILE *out,
                                  int indent) {
  isl_printer *p;
  ...
  fprintf(out, "ref: %d, nparam: %d, dim: %d, extra: %d, flags: %x\n",
          bset->ref, bset->dim->nparam, bset->dim->n_out, bset->extra,
          bset->flags);
...
void isl_basic_map_print_internal(__isl_keep isl_basic_map *bmap, FILE *out,
                                  int indent) {
  isl_printer *p;
  ...
  fprintf(out,
          ...
          "flags: %x, n_name: %d\n",
          bmap->ref, bmap->dim->nparam, bmap->dim->n_in, bmap->dim->n_out,
...
__isl_give isl_basic_map *isl_inequality_negate(__isl_take isl_basic_map *bmap,
  ...
  if (total < 0)
    return isl_basic_map_free(bmap);
  if (pos >= bmap->n_ineq)
    isl_die(isl_basic_map_get_ctx(bmap), isl_error_invalid, "invalid position",
            return isl_basic_map_free(bmap));
...
__isl_give isl_set *isl_set_add_basic_set(__isl_take isl_set *set,
  ...
  return set_from_map(
      isl_map_add_basic_map(set_to_map(set), bset_to_bmap(bset)));
}
...
void isl_set_print_internal(__isl_keep isl_set *set, FILE *out, int indent) {
  ...
  fprintf(out, "ref: %d, n: %d, nparam: %d, dim: %d, flags: %x\n", set->ref,
          set->n, set->dim->nparam, set->dim->n_out, set->flags);
  for (i = 0; i < set->n; ++i) {
    fprintf(out, "%*s", indent, "");
...
void isl_map_print_internal(__isl_keep isl_map *map, FILE *out, int indent) {
  ...
  fprintf(out,
          ...
          "flags: %x, n_name: %d\n",
          map->ref, map->n, map->dim->nparam, map->dim->n_in, map->dim->n_out,
          map->flags, map->dim->n_id);
  for (i = 0; i < map->n; ++i) {
    fprintf(out, "%*s", indent, "");
 ...
 */
static isl_stat
isl_basic_map_check_compatible_domain(__isl_keep isl_basic_map *bmap,
                                      __isl_keep isl_basic_set *bset) {
  isl_bool ok;
...
__isl_give isl_basic_map *
isl_basic_map_intersect_domain(__isl_take isl_basic_map *bmap,
                               __isl_take isl_basic_set *bset) {
  ...
  if (dim < 0)
    goto error;
  if (dim != 0 && isl_basic_map_check_compatible_domain(bmap, bset) < 0)
    goto error;

  bmap = isl_basic_map_cow(bmap);
  if (!bmap)
    goto error;
  bmap = isl_basic_map_extend(bmap, bset->n_div, bset->n_eq, bset->n_ineq);
 ...
 */
static isl_stat
isl_basic_map_check_compatible_range(__isl_keep isl_basic_map *bmap,
                                     __isl_keep isl_basic_set *bset) {
  isl_bool ok;
...
__isl_give isl_basic_map *
isl_basic_map_intersect_range(__isl_take isl_basic_map *bmap,
                              __isl_take isl_basic_set *bset) {
...
__isl_give isl_basic_map *
isl_basic_map_intersect(__isl_take isl_basic_map *bmap1,
  ...
  if (dim2 != nparam2 && isl_basic_map_check_equal_space(bmap1, bmap2) < 0)
    goto error;
  ...
  if (bmap1->sample && isl_basic_map_contains(bmap1, bmap1->sample) > 0 &&
      isl_basic_map_contains(bmap2, bmap1->sample) > 0)
    sample = isl_vec_copy(bmap1->sample);
  else if (bmap2->sample && isl_basic_map_contains(bmap1, bmap2->sample) > 0 &&
  ...
  if (!bmap1)
    goto error;
  bmap1 = isl_basic_map_extend(bmap1, bmap2->n_div, bmap2->n_eq, bmap2->n_ineq);
...
__isl_give isl_basic_set *
isl_basic_set_intersect(__isl_take isl_basic_set *bset1,
                        __isl_take isl_basic_set *bset2) {
  return bset_from_bmap(
      isl_basic_map_intersect(bset_to_bmap(bset1), bset_to_bmap(bset2)));
}

__isl_give isl_basic_set *
isl_basic_set_intersect_params(__isl_take isl_basic_set *bset1,
                               __isl_take isl_basic_set *bset2) {
...
map_intersect_add_constraint(__isl_take isl_map *map1,
  ...
  if (map2->p[0]->n_eq == 1)
    ...
    map1->p[0] = isl_basic_map_add_ineq(map1->p[0], map2->p[0]->ineq[0]);
...
static __isl_give isl_map *map_intersect_internal(__isl_take isl_map *map1,
  ...
  if ((isl_map_plain_is_empty(map1) || isl_map_plain_is_universe(map2)) &&
      isl_space_is_equal(map1->dim, map2->dim)) {
    isl_map_free(map2);
    return map1;
  }
  if ((isl_map_plain_is_empty(map2) || isl_map_plain_is_universe(map1)) &&
      isl_space_is_equal(map1->dim, map2->dim)) {
    isl_map_free(map1);
    return map2;
  }

  if (map1->n == 1 && map2->n == 1 && map1->p[0]->n_div == 0 &&
      map2->p[0]->n_div == 0 && isl_space_is_equal(map1->dim, map2->dim) &&
  ...
  result =
      isl_map_alloc_space(isl_space_copy(map1->dim), map1->n * map2->n, flags);
  if (!result)
    goto error;
  for (i = 0; i < map1->n; ++i)
    for (j = 0; j < map2->n; ++j) {
      struct isl_basic_map *part;
      part = isl_basic_map_intersect(isl_basic_map_copy(map1->p[i]),
...
__isl_give isl_set *isl_set_intersect(__isl_take isl_set *set1,
  ...
  return set_from_map(isl_map_intersect(set_to_map(set1), set_to_map(set2)));
}
...
__isl_give isl_basic_map *
isl_basic_map_reverse(__isl_take isl_basic_map *bmap) {
  isl_space *space;
  unsigned pos;
  isl_size n1, n2;
 ...
 */
static __isl_give isl_basic_map *
isl_basic_map_range_reverse(__isl_take isl_basic_map *bmap) {
  isl_space *space;
...
static __isl_give isl_basic_map *
basic_map_space_reset(__isl_take isl_basic_map *bmap, enum isl_dim_type type) {
  isl_space *space;
...
__isl_give isl_basic_map *
isl_basic_map_insert_dims(__isl_take isl_basic_map *bmap,
  ...
  if (is_empty < 0 || total < 0)
    return isl_basic_map_free(bmap);
  res_space =
      isl_space_insert_dims(isl_basic_map_get_space(bmap), type, pos, n);
  if (!res_space)
    return isl_basic_map_free(bmap);
  if (is_empty) {
    isl_basic_map_free(bmap);
  ...
  for (t = isl_dim_param; t <= isl_dim_out; ++t) {
    ...
    if (t != type) {
      ...
      isl_dim_map_dim_range(dim_map, bmap->dim, t, 0, pos, off);
      isl_dim_map_dim_range(dim_map, bmap->dim, t, pos, size - pos,
                            off + pos + n);
    }
  ...
  res = isl_basic_map_alloc_space(res_space, bmap->n_div, bmap->n_eq,
                                  bmap->n_ineq);
...
__isl_give isl_basic_set *
isl_basic_set_insert_dims(__isl_take isl_basic_set *bset,
                          enum isl_dim_type type, unsigned pos, unsigned n) {
...
__isl_give isl_basic_map *
isl_basic_map_move_dims(__isl_take isl_basic_map *bmap,
  ...
  if (pos(bmap->dim, dst_type) + dst_pos ==
    ...
    space = isl_basic_map_take_space(bmap);
    space = isl_space_move_dims(space, dst_type, dst_pos, src_type, src_pos, n);
    bmap = isl_basic_map_restore_space(bmap, space);
    bmap = isl_basic_map_finalize(bmap);
  ...
  for (t = isl_dim_param; t <= isl_dim_out; ++t) {
    ...
    if (size < 0)
      dim_map = isl_dim_map_free(dim_map);
    if (t == dst_type) {
      isl_dim_map_dim_range(dim_map, space, t, 0, dst_pos, off);
      off += dst_pos;
      isl_dim_map_dim_range(dim_map, space, src_type, src_pos, n, off);
      off += n;
      isl_dim_map_dim_range(dim_map, space, t, dst_pos, size - dst_pos, off);
      off += size - dst_pos;
    } else if (t == src_type) {
      isl_dim_map_dim_range(dim_map, space, t, 0, src_pos, off);
      off += src_pos;
      isl_dim_map_dim_range(dim_map, space, t, src_pos + n, size - src_pos - n,
                            off);
      off += size - src_pos - n;
    } else {
  ...
  res = isl_basic_map_alloc_space(isl_basic_map_get_space(bmap), bmap->n_div,
                                  bmap->n_eq, bmap->n_ineq);
...
__isl_give isl_basic_set *
isl_basic_set_move_dims(__isl_take isl_basic_set *bset,
                        enum isl_dim_type dst_type, unsigned dst_pos,
                        enum isl_dim_type src_type, unsigned src_pos,
                        unsigned n) {
  isl_basic_map *bmap = bset_to_bmap(bset);
  bmap = isl_basic_map_move_dims(bmap, dst_type, dst_pos, src_type, src_pos, n);
  return bset_from_bmap(bmap);
}
...
__isl_give isl_set *isl_set_move_dims(__isl_take isl_set *set,
  ...
  return set_from_map(isl_map_move_dims(set_to_map(set), dst_type, dst_pos,
                                        src_type, src_pos, n));
error:
  isl_set_free(set);
  return NULL;
...
__isl_give isl_map *isl_map_move_dims(__isl_take isl_map *map,
  ...
  for (i = 0; i < map->n; ++i) {
    map->p[i] = isl_basic_map_move_dims(map->p[i], dst_type, dst_pos, src_type,
                                        src_pos, n);
    if (!map->p[i])
      goto error;
  }
...
static __isl_give isl_basic_map *move_last(__isl_take isl_basic_map *bmap,
  ...
  for (t = isl_dim_param; t <= isl_dim_out; ++t) {
    ...
    if (size < 0)
      dim_map = isl_dim_map_free(dim_map);
    if (t == type) {
      isl_dim_map_dim_range(dim_map, space, t, 0, first, off);
      off += first;
      isl_dim_map_dim_range(dim_map, space, t, first, n,
                            total - bmap->n_div - n);
      isl_dim_map_dim_range(dim_map, space, t, first + n, size - (first + n),
                            off);
      off += size - (first + n);
    } else {
      isl_dim_map_dim(dim_map, space, t, off);
...
static __isl_give isl_basic_map *insert_div_rows(__isl_take isl_basic_map *bmap,
  ...
  if (!new_div)
    return isl_basic_map_free(bmap);
  for (i = 0; i < n; ++i) {
    new_div[i] = bmap->block2.data + (bmap->extra + i) * (1 + row_size);
 ...
 */
static __isl_give isl_basic_map *
drop_irrelevant_constraints(__isl_take isl_basic_map *bmap,
                            enum isl_dim_type type, unsigned first,
                            unsigned n) {
  int i;
  int *groups;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_project_out(__isl_take isl_basic_map *bmap,
                          enum isl_dim_type type, unsigned first, unsigned n) {
  isl_bool empty;
  isl_space *space;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_project_out(__isl_take isl_basic_set *bset,
                          enum isl_dim_type type, unsigned first, unsigned n) {
  return bset_from_bmap(
      isl_basic_map_project_out(bset_to_bmap(bset), type, first, n));
}
...
__isl_give isl_set *isl_set_project_out(__isl_take isl_set *set,
                                        enum isl_dim_type type, unsigned first,
                                        unsigned n) {
  return set_from_map(isl_map_project_out(set_to_map(set), type, first, n));
}
 ...
 */
__isl_give isl_set *
isl_set_project_out_param_id_list(__isl_take isl_set *set,
...
__isl_give isl_map *isl_set_project_onto_map(__isl_take isl_set *set,
  ...
  for (i = 0; i < n; ++i)
    map = isl_map_equate(map, isl_dim_in, first + i, isl_dim_out, i);
  return map;
error:
  isl_set_free(set);
  return NULL;
...
isl_bool isl_basic_map_applies_range(__isl_keep isl_basic_map *bmap1,
  ...
  space1 = isl_basic_map_peek_space(bmap1);
  space2 = isl_basic_map_peek_space(bmap2);
  return isl_space_tuple_is_equal(space1, isl_dim_out, space2, isl_dim_in);
}

/* Check that "bmap2" applies to the range of "bmap1" (ignoring parameters).
 */
static isl_stat
isl_basic_map_check_applies_range(__isl_keep isl_basic_map *bmap1,
                                  __isl_keep isl_basic_map *bmap2) {
  isl_bool equal;
...
__isl_give isl_basic_map *
isl_basic_map_apply_range(__isl_take isl_basic_map *bmap1,
                          __isl_take isl_basic_map *bmap2) {
  ...
  bmap = isl_basic_map_alloc_space(
      space_result, bmap1->n_div + bmap2->n_div + n, bmap1->n_eq + bmap2->n_eq,
...
__isl_give isl_basic_set *isl_basic_set_apply(__isl_take isl_basic_set *bset,
  ...
  return bset_from_bmap(isl_basic_map_apply_range(bset_to_bmap(bset), bmap));
error:
  isl_basic_set_free(bset);
  isl_basic_map_free(bmap);
  return NULL;
...
__isl_give isl_basic_map *
isl_basic_map_apply_domain(__isl_take isl_basic_map *bmap1,
                           __isl_take isl_basic_map *bmap2) {
  if (isl_basic_map_check_equal_params(bmap1, bmap2) < 0)
    goto error;
  if (!isl_space_tuple_is_equal(bmap1->dim, isl_dim_in, bmap2->dim, isl_dim_in))
    isl_die(isl_basic_map_get_ctx(bmap1), isl_error_invalid,
...
__isl_give isl_basic_map *isl_basic_map_sum(__isl_take isl_basic_map *bmap1,
  ...
  bmap = isl_basic_map_alloc_space(
      isl_space_copy(bmap1->dim), bmap1->n_div + bmap2->n_div + 2 * n_out,
      bmap1->n_eq + bmap2->n_eq + n_out, bmap1->n_ineq + bmap2->n_ineq);
  for (i = 0; i < n_out; ++i) {
...
__isl_give isl_map *isl_map_sum(__isl_take isl_map *map1,
  ...
  result = isl_map_alloc_space(isl_space_copy(map1->dim), map1->n * map2->n, 0);
  if (!result)
    goto error;
  for (i = 0; i < map1->n; ++i)
    for (j = 0; j < map2->n; ++j) {
      struct isl_basic_map *part;
      part = isl_basic_map_sum(isl_basic_map_copy(map1->p[i]),
                               isl_basic_map_copy(map2->p[j]));
...
__isl_give isl_basic_map *isl_basic_map_floordiv(__isl_take isl_basic_map *bmap,
  ...
  result =
      isl_basic_map_alloc_space(isl_space_copy(bmap->dim), bmap->n_div + n_out,
 ...
 */
static __isl_give isl_basic_map *
var_less_or_equal(__isl_take isl_basic_map *bmap, unsigned pos) {
  int i;
  isl_size nparam;
  isl_size n_in;
  isl_size total;
 ...
 */
static __isl_give isl_basic_map *
var_more_or_equal(__isl_take isl_basic_map *bmap, unsigned pos) {
  int i;
  isl_size nparam;
  isl_size n_in;
  isl_size total;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_less_or_equal_at(__isl_take isl_space *space, unsigned pos) {
  int i;
  isl_basic_map *bmap;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_more_or_equal_at(__isl_take isl_space *space, unsigned pos) {
  int i;
  isl_basic_map *bmap;
...
static __isl_give isl_map *map_lex_lte_first(__isl_take isl_space *space,
  ...
  for (i = 0; i + 1 < n; ++i)
    map = isl_map_add_basic_map(
        map, isl_basic_map_less_at(isl_space_copy(space), i));
  if (n > 0) {
    if (equal)
      map = isl_map_add_basic_map(map,
                                  isl_basic_map_less_or_equal_at(space, n - 1));
    else
      map = isl_map_add_basic_map(map, isl_basic_map_less_at(space, n - 1));
  } else
    isl_space_free(space);
...
static __isl_give isl_map *map_lex_gte_first(__isl_take isl_space *space,
  ...
  for (i = 0; i + 1 < n; ++i)
    map = isl_map_add_basic_map(
        map, isl_basic_map_more_at(isl_space_copy(space), i));
  if (n > 0) {
    if (equal)
      map = isl_map_add_basic_map(map,
                                  isl_basic_map_more_or_equal_at(space, n - 1));
    else
      map = isl_map_add_basic_map(map, isl_basic_map_more_at(space, n - 1));
  } else
    isl_space_free(space);
 ...
 */
static __isl_give isl_basic_map *
add_upper_div_constraint(__isl_take isl_basic_map *bmap, unsigned div) {
  int i;
 ...
 */
static __isl_give isl_basic_map *
add_lower_div_constraint(__isl_take isl_basic_map *bmap, unsigned div) {
  int i;
  isl_size v_div = isl_basic_map_var_offset(bmap, isl_dim_div);
  isl_size n_div;
  unsigned pos;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_add_div_constraints(__isl_take isl_basic_map *bmap,
                                  unsigned pos) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_add_known_div_constraints(__isl_take isl_basic_map *bmap) {
  isl_size n_div;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_add_div_constraint(__isl_take isl_basic_map *bmap, unsigned div,
                                 int sign) {
  if (sign < 0)
...
__isl_give isl_basic_set *
isl_basic_map_underlying_set(__isl_take isl_basic_map *bmap) {
  isl_space *space;
...
__isl_give isl_basic_set *
isl_basic_set_underlying_set(__isl_take isl_basic_set *bset) {
...
isl_basic_map_list_underlying_set(__isl_take isl_basic_map_list *list) {
  int i;
  isl_size n;
...
__isl_give isl_basic_map *
isl_basic_map_overlying_set(__isl_take isl_basic_set *bset,
  ...
  if (bmap->extra) {
    ...
    if (ltotal > total)
      ltotal = total;
    bmap->block2 =
        isl_blk_extend(ctx, bmap->block2, bmap->extra * (1 + 1 + total));
    if (isl_blk_is_error(bmap->block2))
      goto error;
...
__isl_give isl_basic_set *
isl_basic_set_from_underlying_set(__isl_take isl_basic_set *bset,
                                  __isl_take isl_basic_set *like) {
  return bset_from_bmap(isl_basic_map_overlying_set(bset, bset_to_bmap(like)));
}
...
__isl_give isl_set *isl_map_underlying_set(__isl_take isl_map *map) {
  ...
  for (i = 1; i < map->n; ++i)
    isl_assert(map->ctx, map->p[0]->n_div == map->p[i]->n_div, goto error);
  for (i = 0; i < map->n; ++i) {
    map->p[i] = bset_to_bmap(isl_basic_map_underlying_set(map->p[i]));
    if (!map->p[i])
      goto error;
  }
  if (map->n == 0)
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_reset_space(__isl_take isl_basic_map *bmap,
                          __isl_take isl_space *space) {
  isl_bool equal;
...
__isl_give isl_basic_set *
isl_basic_set_reset_space(__isl_take isl_basic_set *bset,
                          __isl_take isl_space *space) {
  return bset_from_bmap(isl_basic_map_reset_space(bset_to_bmap(bset), space));
}
...
__isl_give isl_map *isl_map_reset_space(__isl_take isl_map *map,
  ...
  for (i = 0; i < map->n; ++i) {
    map->p[i] = isl_basic_map_reset_space(map->p[i], isl_space_copy(space));
    if (!map->p[i])
      goto error;
  }
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_from_params(__isl_take isl_basic_set *bset) {
  isl_space *space;
  space = isl_basic_set_get_space(bset);
...
__isl_give isl_basic_map *
isl_basic_map_domain_map(__isl_take isl_basic_map *bmap) {
  int i;
  isl_space *space;
  ...
  for (i = 0; i < n_in; ++i)
    bmap = isl_basic_map_equate(bmap, isl_dim_in, i, isl_dim_out, i);
...
__isl_give isl_basic_map *
isl_basic_map_range_map(__isl_take isl_basic_map *bmap) {
  int i;
  isl_space *space;
  isl_basic_map *range;
  isl_size nparam, n_in, n_out;
  ...
  for (i = 0; i < n_out; ++i)
    bmap = isl_basic_map_equate(bmap, isl_dim_in, n_in + i, isl_dim_out, i);
 ...
 */
static __isl_give isl_map *isl_map_transform(
...
__isl_give isl_map *isl_map_range_map(__isl_take isl_map *map) {
  return isl_map_transform(map, &isl_space_range_map, &isl_basic_map_range_map);
}
...
__isl_give isl_basic_map *
isl_basic_map_from_domain(__isl_take isl_basic_set *bset) {
  return isl_basic_map_reverse(isl_basic_map_from_range(bset));
}

__isl_give isl_basic_map *
isl_basic_map_from_range(__isl_take isl_basic_set *bset) {
  isl_space *space;
  space = isl_basic_set_get_space(bset);
...
__isl_give isl_basic_map *
isl_basic_map_from_domain_and_range(__isl_take isl_basic_set *domain,
...
__isl_give isl_map *isl_map_alloc_space(__isl_take isl_space *space, int n,
  ...
  if (!space)
    return NULL;
  if (n < 0)
    isl_die(space->ctx, isl_error_internal, "negative number of basic maps",
            goto error);
...
__isl_give isl_basic_map *
isl_basic_map_nat_universe(__isl_take isl_space *space) {
  int i;
...
__isl_give isl_basic_set *
isl_basic_set_nat_universe(__isl_take isl_space *space) {
...
static __isl_give isl_basic_map *
isl_basic_map_fix_pos_si(__isl_take isl_basic_map *bmap, unsigned pos,
                         int value) {
  int j;
  isl_size total;
...
static __isl_give isl_basic_map *
isl_basic_map_fix_pos(__isl_take isl_basic_map *bmap, unsigned pos,
                      isl_int value) {
  int j;
  isl_size total;
...
__isl_give isl_basic_map *isl_basic_map_fix_si(__isl_take isl_basic_map *bmap,
  ...
  if (isl_basic_map_check_range(bmap, type, pos, 1) < 0)
    return isl_basic_map_free(bmap);
  return isl_basic_map_fix_pos_si(bmap, isl_basic_map_offset(bmap, type) + pos,
                                  value);
}
...
__isl_give isl_basic_set *isl_basic_set_fix_si(__isl_take isl_basic_set *bset,
                                               ...
                                               unsigned pos, int value) {
  return bset_from_bmap(
      isl_basic_map_fix_si(bset_to_bmap(bset), type, pos, value));
}
...
__isl_give isl_basic_set *isl_basic_set_fix(__isl_take isl_basic_set *bset,
                                            ...
                                            unsigned pos, isl_int value) {
  return bset_from_bmap(
      isl_basic_map_fix(bset_to_bmap(bset), type, pos, value));
}
 ...
 */
__isl_give isl_map *isl_map_inline_foreach_basic_map(
    __isl_take isl_map *map,
...
__isl_give isl_map *isl_map_fix(__isl_take isl_map *map, enum isl_dim_type type,
                                unsigned pos, isl_int value) {
  int i;
...
__isl_give isl_set *isl_set_fix(__isl_take isl_set *set, enum isl_dim_type type,
                                unsigned pos, isl_int value) {
...
__isl_give isl_map *isl_map_fix_val(__isl_take isl_map *map,
  ...
  if (!isl_val_is_int(v))
    isl_die(isl_map_get_ctx(map), isl_error_invalid, "expecting integer value",
            goto error);
  if (isl_map_check_range(map, type, pos, 1) < 0)
    goto error;
  for (i = map->n - 1; i >= 0; --i) {
    map->p[i] = isl_basic_map_fix_val(map->p[i], type, pos, isl_val_copy(v));
    map = remove_if_empty(map, i);
    if (!map)
      goto error;
  }
...
__isl_give isl_set *isl_set_fix_dim_si(__isl_take isl_set *set, unsigned dim,
                                       int value) {
  return set_from_map(isl_map_fix_si(set_to_map(set), isl_dim_set, dim, value));
}

static __isl_give isl_basic_map *
basic_map_bound_si(__isl_take isl_basic_map *bmap, enum isl_dim_type type,
...
__isl_give isl_basic_map *
isl_basic_map_lower_bound_si(__isl_take isl_basic_map *bmap,
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_upper_bound_si(__isl_take isl_basic_map *bmap,
                             enum isl_dim_type type, unsigned pos, int value) {
...
static __isl_give isl_map *map_bound_si(__isl_take isl_map *map,
  ...
  if (isl_map_check_range(map, type, pos, 1) < 0)
    return isl_map_free(map);
  for (i = 0; i < map->n; ++i) {
    map->p[i] = basic_map_bound_si(map->p[i], type, pos, value, upper);
    if (!map->p[i])
      goto error;
  }
  map = isl_map_unmark_normalized(map);
...
__isl_give isl_set *isl_set_lower_bound_si(__isl_take isl_set *set,
                                           ...
                                           int value) {
  return set_from_map(
      isl_map_lower_bound_si(set_to_map(set), type, pos, value));
}
 ...
 */
static __isl_give isl_set *set_bound_multi_val(
    __isl_take isl_set *set, __isl_take isl_multi_val *bound,
    __isl_give isl_map *map_bound(__isl_take isl_map *map, unsigned pos,
                                  __isl_take isl_val *value)) {
  isl_map *map;
 ...
 */
static __isl_give isl_set *set_bound_multi_pw_aff(
    __isl_take isl_set *set, __isl_take isl_multi_pw_aff *bound,
    __isl_give isl_map *set_bound(__isl_take isl_map *map, unsigned pos,
                                  __isl_take TYPE *value)) {
  isl_map *map;
 ...
 */
__isl_give isl_set *
isl_set_lower_bound_multi_val(__isl_take isl_set *set,
 ...
 */
__isl_give isl_map *
isl_map_lower_bound_multi_val(__isl_take isl_map *map,
                              __isl_take isl_multi_val *lower) {
 ...
 */
__isl_give isl_set *
isl_set_upper_bound_multi_val(__isl_take isl_set *set,
 ...
 */
__isl_give isl_map *
isl_map_upper_bound_multi_val(__isl_take isl_map *map,
                              __isl_take isl_multi_val *upper) {
 ...
 */
static __isl_give isl_map *
map_bound_pw_aff(__isl_take isl_map *map, unsigned pos,
 ...
 */
static __isl_give isl_map *
map_lower_bound_pw_aff(__isl_take isl_map *map, unsigned pos,
 ...
 */
static __isl_give isl_map *
map_upper_bound_pw_aff(__isl_take isl_map *map, unsigned pos,
 ...
 */
__isl_give isl_set *
isl_set_lower_bound_multi_pw_aff(__isl_take isl_set *set,
 ...
 */
__isl_give isl_set *
isl_set_upper_bound_multi_pw_aff(__isl_take isl_set *set,
 ...
 */
__isl_give isl_map *
isl_map_lower_bound_multi_pw_aff(__isl_take isl_map *map,
                                 __isl_take isl_multi_pw_aff *lower) {
 ...
 */
__isl_give isl_map *
isl_map_upper_bound_multi_pw_aff(__isl_take isl_map *map,
                                 __isl_take isl_multi_pw_aff *upper) {
...
isl_basic_set_bound(__isl_take isl_basic_set *bset, enum isl_dim_type type,
                    unsigned pos, isl_int value, int upper) {
  return bset_from_bmap(
      basic_map_bound(bset_to_bmap(bset), type, pos, value, upper));
}
 ...
 */
static __isl_give isl_basic_set *
isl_basic_set_bound_val(__isl_take isl_basic_set *bset, enum isl_dim_type type,
                        unsigned pos, __isl_take isl_val *value, int upper) {
  if (!value)
    goto error;
  if (!isl_val_is_int(value))
    isl_die(isl_basic_set_get_ctx(bset), isl_error_invalid,
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_lower_bound_val(__isl_take isl_basic_set *bset,
                              enum isl_dim_type type, unsigned pos,
                              __isl_take isl_val *value) {
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_upper_bound_val(__isl_take isl_basic_set *bset,
                              enum isl_dim_type type, unsigned pos,
                              __isl_take isl_val *value) {
...
__isl_give isl_map *isl_map_reverse(__isl_take isl_map *map) {
  return isl_map_transform(map, &isl_space_reverse, &isl_basic_map_reverse);
}
...
static __isl_give isl_pw_multi_aff *isl_map_partial_lexopt_aligned_pw_multi_aff(
  ...
  res = basic_map_partial_lexopt_pw_multi_aff(isl_basic_map_copy(map->p[0]),
  ...
  for (i = 1; i < map->n; ++i) {
    ...
    res_i = basic_map_partial_lexopt_pw_multi_aff(
        isl_basic_map_copy(map->p[i]), isl_set_copy(dom), empty, flags);
 ...
 */
static __isl_give isl_map *
isl_map_partial_lexopt_aligned(__isl_take isl_map *map, __isl_take isl_set *dom,
                               __isl_give isl_set **empty, unsigned flags) {
  int full;
  struct isl_map *res;
  ...
  if (map->n == 1) {
    res = basic_map_partial_lexopt(isl_basic_map_copy(map->p[0]), dom, empty,
                                   flags);
    isl_map_free(map);
    return res;
  }

  pma = isl_map_partial_lexopt_aligned_pw_multi_aff(map, dom, empty, flags);
...
__isl_give isl_set *isl_set_partial_lexmin(__isl_take isl_set *set,
                                           __isl_take isl_set *dom,
                                           __isl_give isl_set **empty) {
  return set_from_map(isl_map_partial_lexmin(set_to_map(set), dom, empty));
}

__isl_give isl_set *isl_set_partial_lexmax(__isl_take isl_set *set,
                                           __isl_take isl_set *dom,
                                           __isl_give isl_set **empty) {
  return set_from_map(isl_map_partial_lexmax(set_to_map(set), dom, empty));
}
...
isl_basic_set_lexmin_compute_divs(__isl_take isl_basic_set *bset) {
 ...
 */
static __isl_give isl_basic_set *
basic_set_parameter_preimage(__isl_take isl_basic_set *bset,
...
static __isl_give isl_set *set_parameter_preimage(__isl_take isl_set *set,
  ...
  space = isl_set_get_space(set);
  space = isl_space_move_dims(space, isl_dim_set, 0, isl_dim_param, 0, nparam);
  set = isl_set_reset_space(set, space);
  ...
  space = isl_set_get_space(set);
  space = isl_space_move_dims(space, isl_dim_param, 0, isl_dim_out, 0, nparam);
  set = isl_set_reset_space(set, space);
  return set;
error:
  isl_mat_free(mat);
 ...
 */
static __isl_give isl_basic_set *
basic_set_append_equalities(__isl_take isl_basic_set *bset,
...
static __isl_give isl_set *set_append_equalities(__isl_take isl_set *set,
  ...
  for (i = 0; i < set->n; ++i) {
    set->p[i] = basic_set_append_equalities(set->p[i], isl_mat_copy(eq));
    if (!set->p[i])
      goto error;
  }
  isl_mat_free(eq);
 ...
 */
static __isl_give isl_set *
parameter_compute_divs(__isl_take isl_basic_set *bset) {
  int i;
  struct isl_mat *eq;
  struct isl_mat *T, *T2;
  struct isl_set *set;
  ...
  eq =
      isl_mat_sub_alloc6(bset->ctx, bset->eq, i, bset->n_eq - i, 0, 1 + nparam);
  eq = isl_mat_cow(eq);
 ...
 */
static __isl_give isl_basic_map *
insert_divs_from_local_space(__isl_take isl_basic_map *bmap,
 ...
 */
static __isl_give isl_basic_map *
basic_replace_space_by_local_space(__isl_take isl_basic_map *bmap,
 ...
 */
static __isl_give isl_map *
replace_space_by_local_space(__isl_take isl_map *map,
                             __isl_take isl_local_space *ls) {
  int i;
  ...
  for (i = 0; i < map->n; ++i) {
    map->p[i] =
        basic_replace_space_by_local_space(map->p[i], isl_local_space_copy(ls));
    if (!map->p[i])
      goto error;
  }
  isl_space_free(isl_map_take_space(map));
...
static __isl_give isl_map *compute_divs(__isl_take isl_basic_map *bmap) {
  ...
  space = isl_space_set_alloc(bmap->ctx, nparam + n_in + n_out + n_known, 0);
  if (!space)
    goto error;

  ls = isl_basic_map_get_local_space(bmap);
  ls = isl_local_space_drop_dims(ls, isl_dim_div, n_known,
                                 bmap->n_div - n_known);
  if (n_known > 0) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_mark_div_unknown(__isl_take isl_basic_map *bmap, int div) {
  isl_bool unknown;
...
static __isl_give isl_map *map_union_disjoint(__isl_take isl_map *map1,
  ...
  if (!map)
    goto error;
  for (i = 0; i < map1->n; ++i) {
    map = isl_map_add_basic_map(map, isl_basic_map_copy(map1->p[i]));
    if (!map)
      goto error;
  }
  for (i = 0; i < map2->n; ++i) {
    map = isl_map_add_basic_map(map, isl_basic_map_copy(map2->p[i]));
    if (!map)
      goto error;
  }
  isl_map_free(map1);
...
__isl_give isl_set *isl_set_union_disjoint(__isl_take isl_set *set1,
                                           __isl_take isl_set *set2) {
  return set_from_map(
      isl_map_union_disjoint(set_to_map(set1), set_to_map(set2)));
}
 ...
 */
static __isl_give isl_map *map_intersect_set(
    __isl_take isl_map *map, __isl_take isl_space *space,
  ...
  if (ISL_F_ISSET(map, ISL_MAP_DISJOINT) && ISL_F_ISSET(set, ISL_MAP_DISJOINT))
    ISL_FL_SET(flags, ISL_MAP_DISJOINT);

  result = isl_map_alloc_space(space, map->n * set->n, flags);
  for (i = 0; result && i < map->n; ++i)
    for (j = 0; j < set->n; ++j) {
      result = isl_map_add_basic_map(result, fn(isl_basic_map_copy(map->p[i]),
...
__isl_give isl_map *isl_map_intersect_range(__isl_take isl_map *map,
  ...
  if (ok < 0)
    goto error;
  if (!ok)
    isl_die(set->ctx, isl_error_invalid, "incompatible spaces", goto error);

  space = isl_map_get_space(map);
  return map_intersect_set(map, space, set, &isl_basic_map_intersect_range);
error:
  isl_map_free(map);
  isl_set_free(set);
  return NULL;
...
__isl_give isl_map *isl_map_intersect_domain(__isl_take isl_map *map,
  ...
  return map_intersect_set(map, space, set, &isl_basic_map_intersect_domain);
error:
  isl_map_free(map);
  isl_set_free(set);
  return NULL;
 ...
 */
static __isl_give isl_map *
isl_map_intersect_factor(__isl_take isl_map *map, __isl_take isl_map *factor,
  ...
  if (has_id >= 0 && has_id)
    product = isl_map_set_tuple_id(product, control->preserve_type, id);
 ...
 */
static __isl_give isl_map *
isl_map_reverse_domain_product(__isl_take isl_map *map1,
                               __isl_take isl_map *map2) {
 ...
 */
static __isl_give isl_map *
isl_map_reverse_range_product(__isl_take isl_map *map1,
                              __isl_take isl_map *map2) {
 ...
 */
__isl_give isl_map *
isl_map_intersect_domain_factor_range(__isl_take isl_map *map,
 ...
 */
__isl_give isl_map *
isl_map_intersect_range_factor_domain(__isl_take isl_map *map,
                                      __isl_take isl_map *factor) {
  struct isl_intersect_factor_control control = {
 ...
 */
__isl_give isl_map *
isl_map_intersect_range_factor_range(__isl_take isl_map *map,
                                     __isl_take isl_map *factor) {
  struct isl_intersect_factor_control control = {
      .preserve_type = isl_dim_out,
 ...
 */
__isl_give isl_set *
isl_set_intersect_factor_domain(__isl_take isl_set *set,
  ...
  return set_from_map(
      isl_map_intersect_factor(set_to_map(set), set_to_map(domain), &control));
}
...
__isl_give isl_set *isl_set_intersect_factor_range(__isl_take isl_set *set,
  ...
  return set_from_map(
      isl_map_intersect_factor(set_to_map(set), set_to_map(range), &control));
}
...
__isl_give isl_map *isl_map_apply_range(__isl_take isl_map *map1,
  ...
  space = isl_space_join(isl_space_copy(map1->dim), isl_space_copy(map2->dim));
  ...
  for (i = 0; i < map1->n; ++i)
    for (j = 0; j < map2->n; ++j) {
      result = isl_map_add_basic_map(
          result, isl_basic_map_apply_range(isl_basic_map_copy(map1->p[i]),
                                            isl_basic_map_copy(map2->p[j])));
      if (!result)
        goto error;
    }
 ...
 */
static isl_stat
isl_basic_map_check_transformation(__isl_keep isl_basic_map *bmap) {
  isl_bool equal;
...
__isl_give isl_set *isl_map_deltas(__isl_take isl_map *map) {
  ...
  if (!result)
    goto error;
  for (i = 0; i < map->n; ++i)
    result = isl_set_add_basic_set(
        result, isl_basic_map_deltas(isl_basic_map_copy(map->p[i])));
  isl_map_free(map);
  return result;
error:
  isl_map_free(map);
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_deltas_map(__isl_take isl_basic_map *bmap) {
  int i, k;
  isl_space *space;
  isl_basic_map *domain;
  isl_size nparam, n;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_positive_orthant(__isl_take isl_space *space) {
  int i;
  isl_size nparam;
  isl_size dim;
  isl_size total;
...
__isl_give isl_set *isl_set_split_dims(__isl_take isl_set *set,
  ...
  for (i = 0; i < n; ++i) {
    nonneg = nonneg_halfspace(isl_set_get_space(set), offset + first + i);
...
static isl_stat foreach_orthant(__isl_take isl_set *set, int *signs, int first,
                                int len,
                                isl_stat (*fn)(__isl_take isl_set *orthant,
                                               int *signs, void *user),
                                void *user) {
  isl_set *half;
  ...
  signs[first] = 1;
  half = isl_set_from_basic_set(
      nonneg_halfspace(isl_set_get_space(set), 1 + first));
  ...
  signs[first] = -1;
  half =
      isl_set_from_basic_set(neg_halfspace(isl_set_get_space(set), 1 + first));
...
isl_stat isl_set_foreach_orthant(__isl_keep isl_set *set,
  ...
  r = foreach_orthant(isl_set_copy(set), signs, 0, nparam + nvar, fn, user);
...
isl_bool isl_basic_set_is_equal(__isl_keep isl_basic_set *bset1,
                                __isl_keep isl_basic_set *bset2) {
  return isl_basic_map_is_equal(bset_to_bmap(bset1), bset_to_bmap(bset2));
}
...
#include "isl_type_has_equal_space_bin_templ.c"
     ...
     */
    isl_stat
    isl_basic_set_check_equal_space(__isl_keep isl_basic_set *bset1,
                                    __isl_keep isl_basic_set *bset2) {
...
#include "isl_type_has_equal_space_templ.c"
     ...
     */
    isl_stat
    isl_set_basic_set_check_equal_space(__isl_keep isl_set *set,
                                        __isl_keep isl_basic_set *bset) {
...
isl_bool isl_basic_map_is_universe(__isl_keep isl_basic_map *bmap) {
  ...
  if (n_div == 0)
    return isl_bool_false;
  univ = isl_bool_true;
  if (isl_basic_map_foreach_constraint(bmap, &involves_divs, &univ) < 0 && univ)
    return isl_bool_error;
  if (univ < 0 || !univ)
    return univ;
...
__isl_give isl_set *isl_basic_set_union(__isl_take isl_basic_set *bset1,
                                        __isl_take isl_basic_set *bset2) {
  return set_from_map(
      isl_basic_map_union(bset_to_bmap(bset1), bset_to_bmap(bset2)));
}

/* Order divs such that any div only depends on previous divs */
__isl_give isl_basic_map *
isl_basic_map_order_divs(__isl_take isl_basic_map *bmap) {
  int i;
  isl_size off;
  ...
  for (i = 0; i < bmap->n_div; ++i) {
    ...
    if (isl_int_is_zero(bmap->div[i][0]))
      continue;
    pos =
        isl_seq_first_non_zero(bmap->div[i] + 1 + 1 + off + i, bmap->n_div - i);
    if (pos == -1)
      continue;
    if (pos == 0)
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_sort_divs(__isl_take isl_basic_set *bset) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_expand_divs(__isl_take isl_basic_map *bmap,
  ...
  if (div->n_row < bmap->n_div)
    isl_die(isl_mat_get_ctx(div), isl_error_invalid, "not an expansion",
            goto error);
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_expand_divs(__isl_take isl_basic_set *bset,
                          __isl_take isl_mat *div, int *exp) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_align_divs(__isl_take isl_basic_map *dst,
  ...
  if (!known)
    isl_die(isl_basic_map_get_ctx(src), isl_error_invalid,
            "some src divs are unknown", return isl_basic_map_free(dst));
  ...
  for (i = 0; i < src->n_div; ++i) {
    ...
    if (j == dst_n_div) {
      if (!extended) {
        ...
        if (!dst)
          goto error;
        dst = isl_basic_map_extend(dst, extra, 0, 2 * extra);
        extended = 1;
      }
 ...
 */
__isl_give isl_map *
isl_map_align_divs_to_basic_map_list(__isl_take isl_map *map,
...
isl_basic_map_list_align_divs_to_basic_map(__isl_take isl_basic_map_list *list,
...
__isl_give isl_set *isl_set_apply(__isl_take isl_set *set,
  ...
  if (ok < 0)
    goto error;
  if (!ok)
    isl_die(isl_set_get_ctx(set), isl_error_invalid, "incompatible spaces",
            goto error);
...
static __isl_give isl_basic_map *join_initial(__isl_keep isl_basic_set *bset1,
  ...
  bmap1 = isl_basic_map_move_dims(bmap1, isl_dim_in, 0, isl_dim_out, 0, pos);
  bmap2 = isl_basic_map_move_dims(bmap2, isl_dim_in, 0, isl_dim_out, 0, pos);
 ...
 */
static enum isl_lp_result
basic_set_maximal_difference_at(__isl_keep isl_basic_set *bset1,
  ...
  res = isl_basic_map_solve_lp(bmap1, 1, obj->block.data, ctx->one, opt, NULL,
                               NULL);
  isl_basic_map_free(bmap1);
  isl_vec_free(obj);
  return res;
...
int isl_basic_set_compare_at(__isl_keep isl_basic_set *bset1,
  ...
  if (res == isl_lp_empty)
    cmp = 0;
  else if ((res == isl_lp_ok && isl_int_is_pos(opt)) || res == isl_lp_unbounded)
    cmp = 1;
...
int isl_basic_set_follows_at(__isl_keep isl_basic_set *bset1,
  ...
  bmap = isl_basic_map_order_ge(bmap, isl_dim_out, 0, isl_dim_out, dim1 - pos);
  ...
  bmap = isl_basic_map_order_gt(bmap, isl_dim_out, 0, isl_dim_out, dim1 - pos);
  empty = isl_basic_map_is_empty(bmap);
  if (empty < 0)
    goto error;
  isl_basic_map_free(bmap);
 ...
 *	-2 if some error occurred.
 */
int isl_set_follows_at(__isl_keep isl_set *set1, __isl_keep isl_set *set2,
                       int pos) {
  int i, j;
  int follows = -1;
...
static isl_bool
isl_basic_map_plain_has_fixed_var(__isl_keep isl_basic_map *bmap, unsigned pos,
                                  isl_int *val) {
  int i;
  int d;
  isl_size total;
...
static isl_bool
isl_basic_set_plain_has_fixed_var(__isl_keep isl_basic_set *bset, unsigned pos,
                                  isl_int *val) {
  return isl_basic_map_plain_has_fixed_var(bset_to_bmap(bset), pos, val);
}
...
isl_bool isl_basic_map_plain_is_fixed(__isl_keep isl_basic_map *bmap,
  ...
  if (isl_basic_map_check_range(bmap, type, pos, 1) < 0)
    return isl_bool_error;
  return isl_basic_map_plain_has_fixed_var(
      bmap, isl_basic_map_offset(bmap, type) - 1 + pos, val);
}
 ...
 */
__isl_give isl_val *
isl_basic_map_plain_get_val_if_fixed(__isl_keep isl_basic_map *bmap,
                                     enum isl_dim_type type, unsigned pos) {
  isl_ctx *ctx;
  isl_val *v;
  isl_bool fixed;
...
isl_bool isl_map_plain_is_fixed(__isl_keep isl_map *map, enum isl_dim_type type,
                                unsigned pos, isl_int *val) {
  if (isl_map_check_range(map, type, pos, 1) < 0)
    return isl_bool_error;
  return isl_map_plain_has_fixed_var(map, map_offset(map, type) - 1 + pos, val);
}
...
isl_set_get_plain_multi_val_if_fixed(__isl_keep isl_set *set) {
  int i;
  isl_size n;
  isl_space *space;
  isl_multi_val *mv;
 ...
 */
int isl_basic_map_constraint_cmp(__isl_keep isl_basic_map *bmap, isl_int *c1,
                                 isl_int *c2) {
  isl_size total;
  unsigned size;
...
__isl_give isl_basic_map *
isl_basic_map_sort_constraints(__isl_take isl_basic_map *bmap) {
  isl_size total;
  unsigned size;
...
__isl_give isl_basic_set *
isl_basic_set_sort_constraints(__isl_take isl_basic_set *bset) {
  isl_basic_map *bmap = bset_to_bmap(bset);
  return bset_from_bmap(isl_basic_map_sort_constraints(bmap));
}

__isl_give isl_basic_map *
isl_basic_map_normalize(__isl_take isl_basic_map *bmap) {
...
isl_bool isl_basic_set_plain_is_equal(__isl_keep isl_basic_set *bset1,
                                      __isl_keep isl_basic_set *bset2) {
  return isl_basic_map_plain_is_equal(bset_to_bmap(bset1), bset_to_bmap(bset2));
}
 ...
 */
__isl_give isl_basic_map_list *
isl_map_get_basic_map_list(__isl_keep isl_map *map) {
  int i;
  isl_ctx *ctx;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_list_intersect(__isl_take isl_basic_map_list *list) {
  int i;
  isl_size n;
  isl_basic_map *bmap;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_list_intersect(__isl_take isl_basic_set_list *list) {
 ...
 */
__isl_give isl_set *
isl_basic_set_list_union(__isl_take isl_basic_set_list *list) {
  int i;
  isl_size n;
  isl_space *space;
  isl_basic_set *bset;
...
__isl_give isl_basic_map *
isl_basic_map_product(__isl_take isl_basic_map *bmap1,
                      __isl_take isl_basic_map *bmap2) {
  isl_space *space_result = NULL;
  struct isl_basic_map *bmap;
  ...
  if (isl_basic_map_check_equal_params(bmap1, bmap2) < 0)
    goto error;
  space_result =
      isl_space_product(isl_space_copy(bmap1->dim), isl_space_copy(bmap2->dim));
  ...
  bmap = isl_basic_map_alloc_space(space_result, bmap1->n_div + bmap2->n_div,
...
__isl_give isl_basic_map *
isl_basic_map_flat_product(__isl_take isl_basic_map *bmap1,
                           __isl_take isl_basic_map *bmap2) {
  isl_basic_map *prod;
...
__isl_give isl_basic_set *
isl_basic_set_flat_product(__isl_take isl_basic_set *bset1,
                           __isl_take isl_basic_set *bset2) {
  return isl_basic_map_flat_range_product(bset1, bset2);
}

__isl_give isl_basic_map *
isl_basic_map_domain_product(__isl_take isl_basic_map *bmap1,
                             __isl_take isl_basic_map *bmap2) {
  isl_space *space1, *space2;
  isl_space *space_result = NULL;
  isl_basic_map *bmap;
...
__isl_give isl_basic_map *
isl_basic_map_range_product(__isl_take isl_basic_map *bmap1,
                            __isl_take isl_basic_map *bmap2) {
  isl_bool rational;
  isl_space *space_result = NULL;
  isl_basic_map *bmap;
...
__isl_give isl_basic_map *
isl_basic_map_flat_range_product(__isl_take isl_basic_map *bmap1,
                                 __isl_take isl_basic_map *bmap2) {
  isl_basic_map *prod;
 ...
 * duplicates.
 */
static __isl_give isl_map *map_product(
  ...
  if (m < 0)
    goto error;
  if (!m)
    isl_die(isl_map_get_ctx(map1), isl_error_invalid, "parameters don't match",
            goto error);
  ...
  result = isl_map_alloc_space(
      space_product(isl_space_copy(map1->dim), isl_space_copy(map2->dim)),
      map1->n * map2->n, flags);
  if (!result)
    goto error;
  for (i = 0; i < map1->n; ++i)
...
__isl_give isl_map *isl_map_product(__isl_take isl_map *map1,
                                    __isl_take isl_map *map2) {
  isl_map_align_params_bin(&map1, &map2);
  return map_product(map1, map2, &isl_space_product, &isl_basic_map_product, 0);
}
...
__isl_give isl_map *isl_map_factor_domain(__isl_take isl_map *map) {
  ...
  if (!isl_space_domain_is_wrapping(map->dim) ||
    ...
    isl_die(isl_map_get_ctx(map), isl_error_invalid, "not a product",
            return isl_map_free(map));
...
__isl_give isl_map *isl_map_domain_factor_domain(__isl_take isl_map *map) {
  ...
  if (total < 0)
    return isl_map_free(map);
  if (!isl_space_domain_is_wrapping(map->dim))
    isl_die(isl_map_get_ctx(map), isl_error_invalid, "domain is not a product",
            return isl_map_free(map));
...
__isl_give isl_map *isl_map_range_factor_domain(__isl_take isl_map *map) {
  ...
  if (!isl_space_range_is_wrapping(map->dim))
    isl_die(isl_map_get_ctx(map), isl_error_invalid, "range is not a product",
            return isl_map_free(map));
...
isl_stat isl_map_foreach_basic_map(
...
isl_stat isl_set_foreach_basic_set(
    __isl_keep isl_set *set,
 ...
 */
isl_bool isl_set_every_basic_set(
    __isl_keep isl_set *set,
    isl_bool (*test)(__isl_keep isl_basic_set *bset, void *user), void *user) {
  int i;
 ...
 */
__isl_give isl_basic_set_list *
isl_set_get_basic_set_list(__isl_keep isl_set *set) {
  int i;
...
isl_bool isl_map_dim_is_bounded(__isl_keep isl_map *map, enum isl_dim_type type,
                                unsigned pos) {
  int i;
 ...
 * and a lower bound.
 */
isl_bool isl_set_dim_is_bounded(__isl_keep isl_set *set, enum isl_dim_type type,
                                unsigned pos) {
 ...
 */
static isl_bool
has_any_bound(__isl_keep isl_map *map, enum isl_dim_type type, unsigned pos,
...
isl_bool isl_set_dim_has_any_lower_bound(__isl_keep isl_set *set,
                                         enum isl_dim_type type, unsigned pos) {
  return has_any_bound(set, type, pos, &isl_basic_map_dim_has_lower_bound);
}
...
isl_bool isl_set_dim_has_any_upper_bound(__isl_keep isl_set *set,
                                         enum isl_dim_type type, unsigned pos) {
  return has_any_bound(set, type, pos, &isl_basic_map_dim_has_upper_bound);
}

/* Does "map" have a bound (according to "fn") for all of its basic maps?
 */
static isl_bool
has_bound(__isl_keep isl_map *map, enum isl_dim_type type, unsigned pos,
          isl_bool (*fn)(__isl_keep isl_basic_map *bmap, enum isl_dim_type type,
                         unsigned pos)) {
  int i;
 ...
 */
static int find_modulo_constraint_pair(__isl_keep isl_basic_map *bmap, int pos,
                                       isl_int m) {
  int i, j;
  isl_ctx *ctx;
  isl_size total;
  ...
  for (i = 0; i < bmap->n_ineq; ++i) {
    ...
    if (isl_seq_first_non_zero(bmap->ineq[i] + o_out + pos + 1,
                               n_out - (pos + 1)) != -1)
      continue;
    if (first_div_may_involve_output(bmap, bmap->ineq[i] + o_div, 0, n_div) <
        n_div)
      continue;
    for (j = i + 1; j < bmap->n_ineq; ++j) {
      if (!isl_int_abs_eq(bmap->ineq[j][o_out + pos], ctx->one))
        continue;
      if (!isl_seq_is_neg(bmap->ineq[i] + 1, bmap->ineq[j] + 1, total))
        continue;
      break;
    }
    if (j >= bmap->n_ineq)
      continue;
    isl_int_add(bmap->ineq[i][0], bmap->ineq[i][0], bmap->ineq[j][0]);
    less = isl_int_abs_lt(bmap->ineq[i][0], m);
    isl_int_sub(bmap->ineq[i][0], bmap->ineq[i][0], bmap->ineq[j][0]);
    if (!less)
      continue;
...
int isl_basic_map_output_defining_equality(__isl_keep isl_basic_map *bmap,
  ...
  for (j = 0; j < bmap->n_eq; ++j) {
    ...
    if (isl_seq_first_non_zero(bmap->eq[j] + o_out + pos + 1,
                               n_out - (pos + 1)) != -1)
      continue;
    k = first_div_may_involve_output(bmap, bmap->eq[j] + o_div, 0, n_div);
    if (k >= n_div)
      return j;
    if (!isl_int_is_one(bmap->eq[j][o_out + pos]) &&
        !isl_int_is_negone(bmap->eq[j][o_out + pos]))
      continue;
    if (first_div_may_involve_output(bmap, bmap->eq[j] + o_div, k + 1,
                                     n_div - (k + 1)) < n_div)
      continue;
    l = find_modulo_constraint_pair(bmap, pos, bmap->eq[j][o_div + k]);
    if (l < 0)
      return -1;
    if (l >= bmap->n_ineq)
      continue;
...
isl_bool isl_basic_map_plain_is_single_valued(__isl_keep isl_basic_map *bmap) {
  ...
  for (i = 0; i < n_out; ++i) {
    ...
    eq = isl_basic_map_output_defining_equality(bmap, i, NULL, NULL);
    if (eq < 0)
      return isl_bool_error;
    if (eq >= bmap->n_eq)
      return isl_bool_false;
 ...
 * if it is not.
 */
static __isl_give isl_map *isl_map_change_space(
    __isl_take isl_map *map, isl_bool (*can_change)(__isl_keep isl_map *map),
...
__isl_give isl_map *isl_set_unwrap(__isl_take isl_set *set) {
  return isl_map_change_space(set, &isl_set_is_wrapping, "not a wrapping set",
                              &isl_space_unwrap);
}
...
__isl_give isl_basic_map *
isl_basic_map_flatten(__isl_take isl_basic_map *bmap) {
  isl_space *space;
...
__isl_give isl_basic_set *
isl_basic_set_flatten(__isl_take isl_basic_set *bset) {
  return bset_from_bmap(isl_basic_map_flatten(bset_to_bmap(bset)));
}

__isl_give isl_basic_map *
isl_basic_map_flatten_domain(__isl_take isl_basic_map *bmap) {
  isl_space *space;
...
__isl_give isl_basic_map *
isl_basic_map_flatten_range(__isl_take isl_basic_map *bmap) {
  isl_space *space;
...
__isl_give isl_map *isl_set_flatten_map(__isl_take isl_set *set) {
  ...
  map = isl_map_identity(isl_space_join(isl_space_reverse(space), flat_space));
  map = isl_map_intersect_domain(map, set);
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_realign(__isl_take isl_basic_map *bmap,
                      __isl_take isl_space *space,
...
__isl_give isl_map *isl_map_align_params(__isl_take isl_map *map,
  ...
  if (!isl_space_has_named_params(model))
    isl_die(ctx, isl_error_invalid, "model has unnamed parameters", goto error);
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_align_params(__isl_take isl_basic_map *bmap,
                           __isl_take isl_space *model) {
  isl_ctx *ctx;
  ...
  if (!equal_params) {
    ...
    exp = isl_reordering_extend_space(exp, isl_basic_map_get_space(bmap));
    dim_map = isl_dim_map_from_reordering(exp);
    bmap = isl_basic_map_realign(bmap, isl_reordering_get_space(exp),
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_align_params(__isl_take isl_basic_set *bset,
                           __isl_take isl_space *model) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_drop_unused_params(__isl_take isl_basic_map *bmap) {
  isl_size nparam;
  int i;
  ...
  for (i = nparam - 1; i >= 0; i--) {
    ...
    involves = isl_basic_map_involves_dims(bmap, isl_dim_param, i, 1);
    if (involves < 0)
      return isl_basic_map_free(bmap);
    if (!involves)
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_drop_unused_params(__isl_take isl_basic_set *bset) {
  return bset_from_bmap(isl_basic_map_drop_unused_params(bset_to_bmap(bset)));
}
 ...
 */
static __isl_give isl_map *
unbind_params_insert_domain(__isl_take isl_set *set,
                            __isl_take isl_multi_id *tuple) {
  isl_space *space;
  isl_reordering *r;
...
static isl_stat isl_set_check_is_set(__isl_keep isl_set *set) {
  ...
  if (is_params < 0)
    ...
    isl_die(isl_set_get_ctx(set), isl_error_invalid, "expecting proper set",
            return isl_stat_error);
 ...
 */
__isl_give isl_map *
isl_set_unbind_params_insert_domain(__isl_take isl_set *set,
...
__isl_give isl_mat *isl_basic_map_equalities_matrix(
    __isl_keep isl_basic_map *bmap, enum isl_dim_type c1, enum isl_dim_type c2,
    enum isl_dim_type c3, enum isl_dim_type c4, enum isl_dim_type c5) {
  ...
  for (i = 0; i < bmap->n_eq; ++i)
    for (j = 0, pos = 0; j < 5; ++j) {
      ...
      for (k = 0; k < dim; ++k) {
        isl_int_set(mat->row[i][pos], bmap->eq[i][off + k]);
        ++pos;
      }
    }
  ...
  for (i = 0; i < bmap->n_ineq; ++i)
    for (j = 0, pos = 0; j < 5; ++j) {
      ...
      if (dim < 0)
        return isl_mat_free(mat);
      for (k = 0; k < dim; ++k) {
        isl_int_set(mat->row[i][pos], bmap->ineq[i][off + k]);
        ++pos;
      }
    }
...
__isl_give isl_basic_map *isl_basic_map_from_constraint_matrices(
    ...
    __isl_take isl_mat *ineq, enum isl_dim_type c1, enum isl_dim_type c2,
    enum isl_dim_type c3, enum isl_dim_type c4, enum isl_dim_type c5) {
  enum isl_dim_type c[5] = {c1, c2, c3, c4, c5};
  ...
  if (eq->n_col < total)
    isl_die(space->ctx, isl_error_invalid, "number of columns too small",
            goto error);

  extra = eq->n_col - total;

  bmap = isl_basic_map_alloc_space(isl_space_copy(space), extra, eq->n_row,
                                   ineq->n_row);
  if (!bmap)
    goto error;
  for (i = 0; i < extra; ++i) {
  ...
  for (i = 0; i < eq->n_row; ++i) {
    ...
    for (j = 0, pos = 0; j < 5; ++j) {
      ...
      if (dim < 0)
        goto error;
      for (k = 0; k < dim; ++k) {
        isl_int_set(bmap->eq[l][off + k], eq->row[i][pos]);
        ++pos;
      }
    }
  }
  for (i = 0; i < ineq->n_row; ++i) {
    ...
    for (j = 0, pos = 0; j < 5; ++j) {
      ...
      if (dim < 0)
        goto error;
      for (k = 0; k < dim; ++k) {
        isl_int_set(bmap->ineq[l][off + k], ineq->row[i][pos]);
        ++pos;
      }
    }
  }
...
__isl_give isl_mat *
isl_basic_set_equalities_matrix(__isl_keep isl_basic_set *bset,
                                enum isl_dim_type c1, enum isl_dim_type c2,
                                enum isl_dim_type c3, enum isl_dim_type c4) {
  return isl_basic_map_equalities_matrix(bset_to_bmap(bset), c1, c2, c3, c4,
                                         isl_dim_in);
}

__isl_give isl_mat *
isl_basic_set_inequalities_matrix(__isl_keep isl_basic_set *bset,
                                  enum isl_dim_type c1, enum isl_dim_type c2,
                                  enum isl_dim_type c3, enum isl_dim_type c4) {
  return isl_basic_map_inequalities_matrix(bset_to_bmap(bset), c1, c2, c3, c4,
                                           isl_dim_in);
}
...
__isl_give isl_basic_set *isl_basic_set_from_constraint_matrices(
    ...
    enum isl_dim_type c3, enum isl_dim_type c4) {
  isl_basic_map *bmap;
  bmap = isl_basic_map_from_constraint_matrices(space, eq, ineq, c1, c2, c3, c4,
                                                isl_dim_in);
  return bset_from_bmap(bmap);
}
...
__isl_give isl_basic_map *isl_basic_map_zip(__isl_take isl_basic_map *bmap) {
  ...
  if (!isl_basic_map_can_zip(bmap))
    isl_die(bmap->ctx, isl_error_invalid, "basic map cannot be zipped",
            goto error);
...
__isl_give isl_map *isl_map_zip(__isl_take isl_map *map) {
  ...
  if (!isl_map_can_zip(map))
    isl_die(map->ctx, isl_error_invalid, "map cannot be zipped", goto error);
...
__isl_give isl_basic_map *isl_basic_map_curry(__isl_take isl_basic_map *bmap) {
  ...
  if (!isl_basic_map_can_curry(bmap))
    isl_die(bmap->ctx, isl_error_invalid, "basic map cannot be curried",
            goto error);
  bmap = isl_basic_map_cow(bmap);
  if (!bmap)
    return NULL;
...
__isl_give isl_map *isl_map_curry(__isl_take isl_map *map) {
  return isl_map_change_space(map, &isl_map_can_curry, "map cannot be curried",
                              &isl_space_curry);
}
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_uncurry(__isl_take isl_basic_map *bmap) {

  if (!bmap)
    return NULL;

  if (!isl_basic_map_can_uncurry(bmap))
    isl_die(bmap->ctx, isl_error_invalid, "basic map cannot be uncurried",
            return isl_basic_map_free(bmap));
  bmap = isl_basic_map_cow(bmap);
  if (!bmap)
    return NULL;
...
static __isl_give isl_basic_map *equator(__isl_take isl_space *space,
  ...
  total = isl_space_dim(space, isl_dim_all);
  if (total < 0 || isl_space_check_range(space, type1, pos1, 1) < 0 ||
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_equate(__isl_take isl_basic_map *bmap, enum isl_dim_type type1,
...
constraint_order_ge(__isl_take isl_space *space, enum isl_dim_type type1,
                    int pos1, enum isl_dim_type type2, int pos2) {
  isl_constraint *c;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_order_ge(__isl_take isl_basic_map *bmap, enum isl_dim_type type1,
                       int pos1, enum isl_dim_type type2, int pos2) {
  isl_constraint *c;
  isl_space *space;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_order_gt(__isl_take isl_basic_map *bmap, enum isl_dim_type type1,
                       int pos1, enum isl_dim_type type2, int pos2) {
  isl_basic_map *gt;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_substitute(__isl_take isl_basic_set *bset, enum isl_dim_type type,
  ...
  if (!isl_space_is_equal(bset->dim, subs->ls->dim))
    isl_die(ctx, isl_error_invalid, "spaces don't match", goto error);
  n_div = isl_local_space_dim(subs->ls, isl_dim_div);
  if (n_div < 0)
    goto error;
  if (n_div != 0)
    isl_die(ctx, isl_error_unsupported, "cannot handle divs yet", goto error);
  if (!isl_int_is_one(subs->v->el[0]))
    isl_die(ctx, isl_error_invalid, "can only substitute integer expressions",
            goto error);
  ...
  for (i = 0; i < bset->n_eq; ++i) {
    ...
    isl_seq_combine(bset->eq[i], subs->v->el[0], bset->eq[i], v,
                    subs->v->el + 1, subs->v->size - 1);
  }
  ...
  for (i = 0; i < bset->n_ineq; ++i) {
    ...
    isl_seq_combine(bset->ineq[i], subs->v->el[0], bset->ineq[i], v,
                    subs->v->el + 1, subs->v->size - 1);
  }
  ...
  for (i = 0; i < bset->n_div; ++i) {
    ...
    isl_seq_combine(bset->div[i] + 1, subs->v->el[0], bset->div[i] + 1, v,
                    subs->v->el + 1, subs->v->size - 1);
 ...
 */
static isl_stat
check_basic_map_compatible_range_multi_aff(__isl_keep isl_basic_map *bmap,
                                           enum isl_dim_type type,
...
static __isl_give isl_basic_map *set_ma_divs(__isl_take isl_basic_map *bmap,
  ...
  for (i = 0; i < n_div; ++i) {
    ...
    o_bmap += n_before;
    isl_seq_cpy(bmap->div[i] + o_bmap, ls->div->row[i] + o_ls, n_set);
    o_bmap += n_set;
    o_ls += n_set;
    isl_seq_clr(bmap->div[i] + o_bmap, n_after);
    o_bmap += n_after;
    isl_seq_cpy(bmap->div[i] + o_bmap, ls->div->row[i] + o_ls, n_div);
    o_bmap += n_div;
    o_ls += n_div;
...
static __isl_give isl_basic_map *add_ma_strides(__isl_take isl_basic_map *bmap,
  ...
  for (i = 0; i < ma->n; ++i) {
    ...
    if (div < 0 || k < 0)
      goto error;
    isl_int_set_si(bmap->div[div][0], 0);
    isl_seq_cpy(bmap->eq[k] + o_bmap, ma->u.p[i]->v->el + o_ma, 1 + n_param);
    o_bmap += 1 + n_param;
    o_ma += 1 + n_param;
    isl_seq_clr(bmap->eq[k] + o_bmap, n_before);
    o_bmap += n_before;
    isl_seq_cpy(bmap->eq[k] + o_bmap, ma->u.p[i]->v->el + o_ma, n_in);
    o_bmap += n_in;
    o_ma += n_in;
    isl_seq_clr(bmap->eq[k] + o_bmap, n_after);
    o_bmap += n_after;
    isl_seq_cpy(bmap->eq[k] + o_bmap, ma->u.p[i]->v->el + o_ma, n_div_ma);
    o_bmap += n_div_ma;
    o_ma += n_div_ma;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_preimage_multi_aff(__isl_take isl_basic_map *bmap,
                                 enum isl_dim_type type,
  ...
  for (i = 0; i < bmap->n_eq; ++i) {
    ...
    if (k < 0)
      goto error;
    if (isl_seq_preimage(res->eq[k], bmap->eq[i], ma, n_before, n_after,
                         n_div_ma, n_div_bmap, f, c1, c2, g, 0) < 0)
      goto error;
  }
  ...
  for (i = 0; i < bmap->n_ineq; ++i) {
    ...
    if (k < 0)
      goto error;
    if (isl_seq_preimage(res->ineq[k], bmap->ineq[i], ma, n_before, n_after,
                         n_div_ma, n_div_bmap, f, c1, c2, g, 0) < 0)
      goto error;
  }
  ...
  for (i = 0; i < bmap->n_div; ++i) {
    ...
    if (isl_seq_preimage(res->div[n_div_ma + i], bmap->div[i], ma, n_before,
                         n_after, n_div_ma, n_div_bmap, f, c1, c2, g, 1) < 0)
      goto error;
  }
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_preimage_multi_aff(__isl_take isl_basic_set *bset,
                                 __isl_take isl_multi_aff *ma) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_preimage_domain_multi_aff(__isl_take isl_basic_map *bmap,
                                        __isl_take isl_multi_aff *ma) {
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_preimage_range_multi_aff(__isl_take isl_basic_map *bmap,
                                       __isl_take isl_multi_aff *ma) {
 ...
 */
static isl_stat
check_map_compatible_range_multi_aff(__isl_keep isl_map *map,
                                     enum isl_dim_type type,
                                     __isl_keep isl_multi_aff *ma) {
  isl_bool m;
  isl_space *ma_space;
  ...
  if (m < 0)
    return isl_stat_error;
  if (!m)
    isl_die(isl_map_get_ctx(map), isl_error_invalid, "spaces don't match",
            return isl_stat_error);
  return isl_stat_ok;
}
 ...
 */
static __isl_give isl_map *
map_preimage_multi_aff(__isl_take isl_map *map, enum isl_dim_type type,
                       __isl_take isl_multi_aff *ma) {
  int i;
  isl_space *space;
...
__isl_give isl_map *isl_map_preimage_multi_aff(__isl_take isl_map *map,
  ...
  if (!isl_space_has_named_params(ma->space))
    isl_die(map->ctx, isl_error_invalid, "unaligned unnamed parameters",
            goto error);
 ...
 */
__isl_give isl_map *
isl_map_preimage_domain_multi_aff(__isl_take isl_map *map,
                                  __isl_take isl_multi_aff *ma) {
 ...
 */
__isl_give isl_map *
isl_map_preimage_range_multi_aff(__isl_take isl_map *map,
                                 __isl_take isl_multi_aff *ma) {
 ...
 */
static __isl_give isl_map *
isl_map_preimage_pw_multi_aff_aligned(__isl_take isl_map *map,
                                      enum isl_dim_type type,
  ...
  if (type == isl_dim_in)
    res = isl_map_intersect_domain(res, isl_map_copy(pma->p[0].set));
  else
    res = isl_map_intersect_range(res, isl_map_copy(pma->p[0].set));
  ...
  for (i = 1; i < pma->n; ++i) {
    ...
    if (type == isl_dim_in)
      res_i = isl_map_intersect_domain(res_i, isl_map_copy(pma->p[i].set));
    else
      res_i = isl_map_intersect_range(res_i, isl_map_copy(pma->p[i].set));
 ...
 */
__isl_give isl_map *
isl_map_preimage_pw_multi_aff(__isl_take isl_map *map, enum isl_dim_type type,
                              __isl_take isl_pw_multi_aff *pma) {
  isl_bool aligned;
 ...
 */
__isl_give isl_set *
isl_set_preimage_pw_multi_aff(__isl_take isl_set *set,
                              __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_map *
isl_map_preimage_domain_pw_multi_aff(__isl_take isl_map *map,
                                     __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_map *
isl_map_preimage_range_pw_multi_aff(__isl_take isl_map *map,
                                    __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_map *
isl_map_preimage_multi_pw_aff(__isl_take isl_map *map, enum isl_dim_type type,
 ...
 */
__isl_give isl_map *
isl_map_preimage_domain_multi_pw_aff(__isl_take isl_map *map,
                                     __isl_take isl_multi_pw_aff *mpa) {
 ...
 */
__isl_give isl_set *
isl_set_preimage_multi_pw_aff(__isl_take isl_set *set,
                              __isl_take isl_multi_pw_aff *mpa) {
 ...
 */
__isl_give isl_mat *
isl_basic_set_extract_equalities(__isl_keep isl_basic_set *bset) {
  isl_ctx *ctx;
  isl_size total;
...
isl_bool isl_basic_map_equal_div_expr_except_constant(
    __isl_keep isl_basic_map *bmap1, int pos1, __isl_keep isl_basic_map *bmap2,
    int pos2) {
  isl_bool equal;
  ...
  equal = isl_basic_map_equal_div_expr_part(bmap1, pos1, bmap2, pos2, 0, 1);
  if (equal < 0 || !equal)
    return equal;
  equal = isl_basic_map_equal_div_expr_part(bmap1, pos1, bmap2, pos2, 1, 1);
  if (equal < 0 || equal)
    return isl_bool_not(equal);
  return isl_basic_map_equal_div_expr_part(bmap1, pos1, bmap2, pos2, 2, total);
}
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_tighten_outward(__isl_take isl_basic_set *bset,
                              __isl_keep isl_vec *vec) {
  int j;
 ...
 */
__isl_give isl_basic_map *
isl_basic_map_transform_dims(__isl_take isl_basic_map *bmap,
                             enum isl_dim_type type, unsigned first,
  ...
  if (isl_mat_sub_transform(bmap->eq, bmap->n_eq, pos, isl_mat_copy(trans)) < 0)
    goto error;
 ...
 */
__isl_give isl_basic_set *
isl_basic_set_transform_dims(__isl_take isl_basic_set *bset,
                             enum isl_dim_type type, unsigned first,
                             __isl_take isl_mat *trans) {
