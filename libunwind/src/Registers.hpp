...
public:
    ...
    void        jumpto() {
        __libunwind_Registers_x86_jumpto(this);
    }
...
public:
    ...
    static const char *getRegisterName(int num);
    void        jumpto() {
        __libunwind_Registers_x86_64_jumpto(this);
    }
    static int  lastDwarfRegNum() {
...
inline bool Registers_sparc::validFloatRegister(int) const {
    return false;
}
...
inline bool Registers_sparc::validVectorRegister(int) const {
    return false;
}
