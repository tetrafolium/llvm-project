...
const char* __future_error_category::name() const _NOEXCEPT { return "future"; }
...
future_error::future_error(error_code __ec)
    : logic_error(__ec.message()), __ec_(__ec) {}

future_error::~future_error() _NOEXCEPT {}

void __assoc_sub_state::__on_zero_shared() _NOEXCEPT { delete this; }
...
void __assoc_sub_state::__execute() {
  __throw_future_error(future_errc::no_state);
}

future<void>::future(__assoc_sub_state* __state) : __state_(__state) {
