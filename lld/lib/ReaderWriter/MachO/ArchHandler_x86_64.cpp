...
public:
  ...
  void updateReferenceToGOT(const Reference *ref, bool targetNowGOT) override {
    ...
    case ripRel32GotLoad:
      const_cast<Reference *>(ref)->setKindValue(
          targetNowGOT ? ripRel32 : ripRel32GotLoadNowLea);
      break;
    case imageOffsetGot:
  ...
  void generateAtomContent(
      ...
      FindAddressForAtom findSectionAddress, uint64_t imageBase,
...
llvm::Error ArchHandler_x86_64::getReferenceInfo(
...
llvm::Error ArchHandler_x86_64::getPairReferenceInfo(
...
void ArchHandler_x86_64::applyFixupFinal(
  ...
  case unwindInfoToEhFrame: {
    uint64_t val =
        targetAddress - findSectionAddress(*ref.target()) + ref.addend();
