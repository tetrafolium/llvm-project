...
_CLC_DEFINE_RELATIONAL_BINARY(int, islessequal, __builtin_islessequal, float,
                              float)
...
// The scalar version of islessequal(double, double) returns an int, but the
...
// The scalar version of islessequal(half, half) returns an int, but the vector
