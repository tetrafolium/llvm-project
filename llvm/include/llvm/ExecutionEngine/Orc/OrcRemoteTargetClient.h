...
public:
    ...
    private:
        ...
        public:
            ...
            JITTargetAddress getRemoteAddress() const {
                return RemoteAddr;
            }
    ...
    const std::string &getTargetTriple() const {
        return RemoteTargetTriple;
    }

    Error terminateSession() {
        return callB<utils::TerminateSession>();
    }
...
private:
    ...
    uint32_t getIndirectStubSize() const {
