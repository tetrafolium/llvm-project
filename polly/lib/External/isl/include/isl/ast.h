...
__isl_subclass(isl_ast_expr) enum isl_ast_expr_type
    isl_ast_expr_get_type(__isl_keep isl_ast_expr *expr);
__isl_export __isl_give isl_val *
isl_ast_expr_int_get_val(__isl_keep isl_ast_expr *expr);
__isl_give isl_val *isl_ast_expr_get_val(__isl_keep isl_ast_expr *expr);
__isl_export __isl_give isl_id *
isl_ast_expr_id_get_id(__isl_keep isl_ast_expr *expr);
__isl_give isl_id *isl_ast_expr_get_id(__isl_keep isl_ast_expr *expr);

__isl_subclass(isl_ast_expr_op) enum isl_ast_expr_op_type
...
__isl_export __isl_give isl_ast_expr *
isl_ast_expr_op_get_arg(__isl_keep isl_ast_expr *expr, int pos);
...
__isl_export __isl_give char *
isl_ast_expr_to_C_str(__isl_keep isl_ast_expr *expr);
...
__isl_subclass(isl_ast_node) enum isl_ast_node_type
    isl_ast_node_get_type(__isl_keep isl_ast_node *node);
...
__isl_export __isl_give isl_ast_node *
isl_ast_node_for_get_body(__isl_keep isl_ast_node *node);
__isl_export isl_bool
isl_ast_node_for_is_degenerate(__isl_keep isl_ast_node *node);
...
__isl_export isl_bool
isl_ast_node_if_has_else_node(__isl_keep isl_ast_node *node);
...
__isl_export __isl_give isl_ast_node_list *
isl_ast_node_block_get_children(__isl_keep isl_ast_node *node);

__isl_export __isl_give isl_id *
isl_ast_node_mark_get_id(__isl_keep isl_ast_node *node);
__isl_export __isl_give isl_ast_node *
...
__isl_export __isl_give char *
isl_ast_node_to_C_str(__isl_keep isl_ast_node *node);
