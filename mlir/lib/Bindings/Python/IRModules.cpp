...
public:
    ...
    static void bindDerived(ClassTy &c) {
        ...
        c.def_property_readonly(
            "value",
        [](PyBoolAttribute &self) {
            return mlirBoolAttrGetValue(self);
        },
...
public:
    ...
    static void bindDerived(ClassTy &c) {
        ...
        c.def_property_readonly(
            "width",
        [](PyIntegerType &self) {
            return mlirIntegerTypeGetWidth(self);
        },
...
void mlir::python::populateIRSubmodule(py::module &m) {
    ...
    .def_property_readonly(
        "dialects",
    [](PyMlirContext &self) {
        return PyDialects(self.getRef());
    },
    "Gets a container for accessing dialects by name")
    .def_property_readonly(
    "d", [](PyMlirContext &self) {
        return PyDialects(self.getRef());
    },
    "Alias for 'dialect'")
    .def(
    ...
    .def("__eq__", [](PyLocation &self, py::object other) {
        return false;
    })
    .def_property_readonly_static(
        "current",
    ...
    .def("__eq__",
    [](PyOperationBase &self, py::object other) {
        return false;
    })
    ...
    .def("__eq__", [](PyBlock &self, py::object &other) {
        return false;
    })
    .def(
        "__str__",
    ...
    .def("__eq__",
    [](PyAttribute &self, PyAttribute &other) {
        return self == other;
    })
    .def("__eq__", [](PyAttribute &self, py::object &other) {
        return false;
    })
    .def(
    "dump", [](PyAttribute &self) {
        mlirAttributeDump(self);
    },
    kDumpDocstring)
    .def(
        "__str__",
    ...
    .def("__eq__", [](PyType &self, PyType &other) {
        return self == other;
    })
    .def("__eq__", [](PyType &self, py::object &other) {
        return false;
    })
    .def(
    "dump", [](PyType &self) {
    ...
    .def("__eq__", [](PyValue &self, py::object other) {
        return false;
    })
    .def(
        "__str__",
