...
public:
  ...
  /// of the chain now is inlined-at the new call site. \param   InlinedAt The
  /// new outermost inlined-at in the chain. \param   ReplaceLast  Replace the
  /// last location in the inlined-at chain.
