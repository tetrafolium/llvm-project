...
public:
    ...
    Kind getKind() const {
        return static_cast<Kind>(DeclKind);
    }
...
public:
    ...
    pointer data() const {
        return Single ? &Single : Result.data();
    }
    size_t size() const {
        return Single ? 1 : Result.size();
    }
    reference front() const {
        return Single ? Single : Result.front();
    }
    reference back() const {
        return Single ? Single : Result.back();
    }
    reference operator[](size_t N) const {
        return Single ? Single : Result[N];
    }
...
public:
    ...
    bool isNamespace() const {
        return getDeclKind() == Decl::Namespace;
    }
    ...
    decl_range decls() const {
        return decl_range(decls_begin(), decls_end());
    }
    ...
    public:
        ...
        value_type operator*() const {
            return cast<SpecificDecl>(*Current);
        }
