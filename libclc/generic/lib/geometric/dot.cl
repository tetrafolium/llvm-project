...
_CLC_OVERLOAD _CLC_DEF float dot(float p0, float p1) { return p0 * p1; }
...
_CLC_OVERLOAD _CLC_DEF double dot(double p0, double p1) { return p0 * p1; }
...
_CLC_OVERLOAD _CLC_DEF half dot(half p0, half p1) { return p0 * p1; }
