...
class AArch64FastISel final : public FastISel {
    ...
    public:
        ...
        BaseKind getKind() const {
            return Kind;
        }
        void setExtendType(AArch64_AM::ShiftExtendType E) {
            ExtType = E;
        }
        AArch64_AM::ShiftExtendType getExtendType() const {
            return ExtType;
        }
        bool isRegBase() const {
            return Kind == RegBase;
        }
        bool isFIBase() const {
        ...
        void setOffset(int64_t O) {
            Offset = O;
        }
        int64_t getOffset() {
            return Offset;
        }
        void setShift(unsigned S) {
            Shift = S;
        }
        unsigned getShift() {
            return Shift;
        ...
        void setGlobalValue(const GlobalValue *G) {
            GV = G;
        }
