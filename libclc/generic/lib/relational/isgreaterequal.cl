...
_CLC_DEFINE_RELATIONAL_BINARY(int, isgreaterequal, __builtin_isgreaterequal,
                              float, float)
...
// The scalar version of isgreaterequal(double, double) returns an int, but the
...
// The scalar version of isgreaterequal(half, half) returns an int, but the
