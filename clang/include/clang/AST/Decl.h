...
public:
    ...
    static bool classofKind(Kind K) {
        return K >= firstNamed && K <= lastNamed;
    }
};
...
public:
    ...
    static bool classofKind(Kind K) {
        return K >= firstValue && K <= lastValue;
    }
};
...
protected:
    ...
    unsigned :
        ...
        /// declared.
    unsigned ScopeDepthOrObjCQuals :
...
public:
    ...
    bool isARCPseudoStrong() const {
        return VarDeclBits.ARCPseudoStrong;
    }
    void setARCPseudoStrong(bool PS) {
        VarDeclBits.ARCPseudoStrong = PS;
    }
...
public:
    ...
    void setVirtualAsWritten(bool V) {
        FunctionDeclBits.IsVirtualAsWritten = V;
    }
    ...
    void setTrivial(bool IT) {
        FunctionDeclBits.IsTrivial = IT;
    }

    bool isTrivialForCall() const {
        return FunctionDeclBits.IsTrivialForCall;
    }
    void setTrivialForCall(bool IT) {
        FunctionDeclBits.IsTrivialForCall = IT;
    }

    /// Whether this function is defaulted. Valid for e.g.
    /// special member functions, defaulted comparisions (not methods!).
    bool isDefaulted() const {
        return FunctionDeclBits.IsDefaulted;
    }
    void setDefaulted(bool D = true) {
        FunctionDeclBits.IsDefaulted = D;
    }
    ...
    bool usesSEHTry() const {
        return FunctionDeclBits.UsesSEHTry;
    }
    void setUsesSEHTry(bool UST) {
        FunctionDeclBits.UsesSEHTry = UST;
    }
    ...
    bool hasSkippedBody() const {
        return FunctionDeclBits.HasSkippedBody;
    }
    ...
    bool willHaveBody() const {
        return FunctionDeclBits.WillHaveBody;
    }
    void setWillHaveBody(bool V = true) {
        FunctionDeclBits.WillHaveBody = V;
    }
    ...
    /// function.
    bool isInlineSpecified() const {
        return FunctionDeclBits.IsInlineSpecified;
    }
...
public:
    ...
    static bool classofKind(Kind K) {
        return K >= firstField && K <= lastField;
    }
};
...
public:
    ...
    bool isCompleteDefinition() const {
        return TagDeclBits.IsCompleteDefinition;
    }
    ...
    bool isBeingDefined() const {
        return TagDeclBits.IsBeingDefined;
    }
    ...
    bool isFreeStanding() const {
        return TagDeclBits.IsFreeStanding;
    }
    ...
    void setTagKind(TagKind TK) {
        TagDeclBits.TagDeclKind = TK;
    }

    bool isStruct() const {
        return getTagKind() == TTK_Struct;
    }
    bool isInterface() const {
        return getTagKind() == TTK_Interface;
    }
    bool isClass()  const {
        return getTagKind() == TTK_Class;
    }
    bool isUnion()  const {
        return getTagKind() == TTK_Union;
    }
    bool isEnum()   const {
        return getTagKind() == TTK_Enum;
    }
...
public:
    ...
    void setIntegerType(QualType T) {
        IntegerType = T.getTypePtrOrNull();
    }
    ...
    unsigned getNumPositiveBits() const {
        return EnumDeclBits.NumPositiveBits;
    }
    ...
    unsigned getNumNegativeBits() const {
        return EnumDeclBits.NumNegativeBits;
    }
...
public:
    ...
    bool hasObjectMember() const {
        return RecordDeclBits.HasObjectMember;
    }
    void setHasObjectMember(bool val) {
        RecordDeclBits.HasObjectMember = val;
    }

    bool hasVolatileMember() const {
        return RecordDeclBits.HasVolatileMember;
    }
...
public:
    ...
    bool isVariadic() const {
        return BlockDeclBits.IsVariadic;
    }
    void setIsVariadic(bool value) {
        BlockDeclBits.IsVariadic = value;
    }
    ...
    bool hasCaptures() const {
        return NumCaptures || capturesCXXThis();
    }
    ...
    bool capturesCXXThis() const {
        return BlockDeclBits.CapturesCXXThis;
    }
    void setCapturesCXXThis(bool B = true) {
        BlockDeclBits.CapturesCXXThis = B;
    }
    ...
    bool doesNotEscape() const {
        return BlockDeclBits.DoesNotEscape;
    }
    void setDoesNotEscape(bool B = true) {
        BlockDeclBits.DoesNotEscape = B;
    }
...
class ImportDecl final : public Decl,
    ...
    void setImportComplete(bool C) {
        NextLocalImportAndComplete.setInt(C);
    }
