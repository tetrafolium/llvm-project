...
static const float Poly[] = {
    /* maxerr: 1.962 ulp.  */
    0x1.59977ap-10f, 0x1.3ce9e4p-7f, 0x1.c6bd32p-5f,
    0x1.ebf9bcp-3f,  0x1.62e422p-1f,
};
...
VPCS_ATTR
static v_f32_t specialcase(v_f32_t poly, v_f32_t n, v_u32_t e, v_f32_t absn,
                           v_u32_t cmp1, v_f32_t scale) {
...
VPCS_ATTR
v_f32_t V_NAME(exp2f)(v_f32_t x) {
