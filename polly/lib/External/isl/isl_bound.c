...
static isl_stat unwrapped_guarded_poly_bound(__isl_take isl_basic_set *bset,
  ...
  bound->pwf = isl_pw_qpolynomial_fold_zero(isl_space_copy(space), bound->type);
  ...
  bound->pwf =
      isl_pw_qpolynomial_fold_morph_domain(bound->pwf, isl_morph_copy(morph));
  bound->pwf_tight =
      isl_pw_qpolynomial_fold_morph_domain(bound->pwf_tight, morph);

  bound->pwf = isl_pw_qpolynomial_fold_fold(top_pwf, bound->pwf);
  bound->pwf_tight =
      isl_pw_qpolynomial_fold_fold(top_pwf_tight, bound->pwf_tight);
...
static isl_stat guarded_poly_bound(__isl_take isl_basic_set *bset,
  ...
  bset = isl_basic_set_move_dims(bset, isl_dim_param, nparam, isl_dim_set, 0,
                                 n_in);
  poly = isl_qpolynomial_move_dims(poly, isl_dim_param, nparam, isl_dim_in, 0,
                                   n_in);
  ...
  bound->pwf_tight = isl_pw_qpolynomial_fold_reset_space(
      bound->pwf_tight, isl_space_copy(bound->dim));
...
static isl_stat basic_guarded_fold(__isl_take isl_basic_set *bset, void *user) {
  ...
  bound->bset = bset;
  r = isl_qpolynomial_fold_foreach_qpolynomial(bound->fold, &guarded_qp, user);
  isl_basic_set_free(bset);
  return r;
}
...
isl_pw_qpolynomial_fold_bound(__isl_take isl_pw_qpolynomial_fold *pwf,
  ...
  bound.pwf =
      isl_pw_qpolynomial_fold_zero(isl_space_copy(bound.dim), pwf->type);
  bound.pwf_tight =
      isl_pw_qpolynomial_fold_zero(isl_space_copy(bound.dim), pwf->type);
  bound.check_tight = !!tight;

  if (isl_pw_qpolynomial_fold_foreach_lifted_piece(pwf, guarded_fold, &bound) <
      0)
    goto error;
...
isl_union_pw_qpolynomial_bound(__isl_take isl_union_pw_qpolynomial *upwqp,
  ...
  if (isl_union_pw_qpolynomial_foreach_pw_qpolynomial(upwqp, &bound_pw, &data) <
      0)
    goto error;
