...
public:
    ...
    void setName(const IntOrString &Name) {
        ResName = Name;
    }
    ...
    // don't have any.
    virtual Error applyStmts(Visitor *) const {
    ...
    virtual ResourceKind getKind() const {
        return RkBase;
    }
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitNullResource(this);
    }
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitLanguageStmt(this);
    }
    Twine getResourceTypeName() const override {
        return "LANGUAGE";
    }
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitIconResource(this);
    }
    ResourceKind getKind() const override {
        return RkIcon;
    }
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitHTMLResource(this);
    }
...
public:
    ...
    virtual uint16_t getResFlags() const {
        return 0;
    }
    virtual MenuDefKind getKind() const {
        return MkBase;
    }
};
...
public:
    ...
    MenuDefKind getKind() const override {
        return MkSeparator;
    }
...
public:
    ...
    uint16_t getResFlags() const override {
        return Flags;
    }
    MenuDefKind getKind() const override {
        return MkMenuItem;
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitMenuResource(this);
    }
    ResourceKind getKind() const override {
        return RkMenu;
    }
...
public:
    ...
    virtual StmtKind getKind() const {
        return StBase;
    }
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitVersionStmt(this);
    }
};
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitCaptionStmt(this);
    }
};
...
public:
    ...
    Error visit(Visitor *V) const override {
        return V->visitExStyleStmt(this);
    }
};
