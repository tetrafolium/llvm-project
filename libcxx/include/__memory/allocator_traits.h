...
template <class _Tp, class _Dp>
struct __pointer_type {
  typedef _LIBCPP_NODEBUG_TYPE typename __pointer_type_imp::__pointer_type<
...
struct __const_pointer<_Tp, _Ptr, _Alloc, false> {
  ...
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::template rebind<const _Tp>
          type;
#else
...
#ifndef _LIBCPP_CXX03_LANG
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::template rebind<void>
          type;
#else
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::template rebind<void>::other type;
#endif
};
...
#ifndef _LIBCPP_CXX03_LANG
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::template rebind<const void>
          type;
#else
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::template rebind<const void>::other type;
#endif
};
...
struct __propagate_on_container_copy_assignment<_Alloc, true> {
  typedef _LIBCPP_NODEBUG_TYPE
      typename _Alloc::propagate_on_container_copy_assignment type;
};
...
struct __propagate_on_container_move_assignment<_Alloc, true> {
  typedef _LIBCPP_NODEBUG_TYPE
      typename _Alloc::propagate_on_container_move_assignment type;
};
...
struct __propagate_on_container_swap<_Alloc, true> {
  typedef _LIBCPP_NODEBUG_TYPE
      typename _Alloc::propagate_on_container_swap type;
};
...
struct __allocator_traits_rebind<_Alloc<_Tp, _Args...>, _Up, true> {
  _LIBCPP_SUPPRESS_DEPRECATED_PUSH
  typedef _LIBCPP_NODEBUG_TYPE
      typename _Alloc<_Tp, _Args...>::template rebind<_Up>::other type;
  _LIBCPP_SUPPRESS_DEPRECATED_POP
};
...
template <class _Alloc, class _SizeType, class _ConstVoidPtr>
struct __has_allocate_hint : true_type {};
...
template <class _Alloc, class... _Args,
          class = decltype(
              _VSTD::declval<_Alloc>().construct(_VSTD::declval<_Args>()...))>
...
struct __has_select_on_container_copy_construction
    : decltype(_VSTD::__has_select_on_container_copy_construction_test(
          declval<_Alloc&>())) {};
...
struct __has_destroy<
    _Alloc, _Pointer,
    typename __void_t<decltype(_VSTD::declval<_Alloc>().destroy(
        _VSTD::declval<_Pointer>()))>::type> : true_type {};
...
struct __alloc_traits_difference_type {
  typedef _LIBCPP_NODEBUG_TYPE
      typename pointer_traits<_Ptr>::difference_type type;
};
...
struct __is_cpp17_copy_insertable<_Alloc, false>
    : integral_constant<
          bool, is_copy_constructible<typename _Alloc::value_type>::value &&
...
struct _LIBCPP_TEMPLATE_VIS allocator_traits {
  ...
  _LIBCPP_NODISCARD_AFTER_CXX17
      _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static pointer
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static void
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static size_type
  max_size(const allocator_type& __a) _NOEXCEPT {
    return __max_size(__has_max_size<const allocator_type>(), __a);
  }

  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static allocator_type
...
private:
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static size_type
  __max_size(true_type, const allocator_type& __a) _NOEXCEPT {
    _LIBCPP_SUPPRESS_DEPRECATED_PUSH
    return __a.max_size();
    _LIBCPP_SUPPRESS_DEPRECATED_POP
  }
  ...
  _LIBCPP_INLINE_VISIBILITY _LIBCPP_CONSTEXPR_AFTER_CXX17 static size_type
  __max_size(false_type, const allocator_type&) _NOEXCEPT {
...
#ifndef _LIBCPP_CXX03_LANG
  typedef _LIBCPP_NODEBUG_TYPE typename _Traits::template rebind_alloc<_Tp>
      type;
#else
