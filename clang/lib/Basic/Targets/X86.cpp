...
// and
// http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.126.4216&rep=rep1&type=pdf
// (page 29) | | i586/Pentium MMX                   |                      32 |
// https://www.7-cpu.com/cpu/P-MMX.html | | i686/Pentium                       |
// 32 | https://www.7-cpu.com/cpu/P6.html | | Netburst/Pentium4 | 64 |
// https://www.7-cpu.com/cpu/P4-180.html | | Atom |                      64 |
// https://www.7-cpu.com/cpu/Atom.html | | Westmere                           |
// 64 |
// https://en.wikichip.org/wiki/intel/microarchitectures/sandy_bridge_(client)
// "Cache Architecture" | | Sandy Bridge                       | 64 |
// https://en.wikipedia.org/wiki/Sandy_Bridge and
// https://www.7-cpu.com/cpu/SandyBridge.html | | Ivy Bridge | 64 |
// https://blog.stuffedcow.net/2013/01/ivb-cache-replacement/ and
// https://www.7-cpu.com/cpu/IvyBridge.html | | Haswell | 64 |
// https://www.7-cpu.com/cpu/Haswell.html | | Boadwell |                      64
// | https://www.7-cpu.com/cpu/Broadwell.html | | Skylake (including
// skylake-avx512) |                      64 |
// https://www.nas.nasa.gov/hecc/support/kb/skylake-processors_550.html "Cache
// Hierarchy" | | Cascade Lake                       |                      64 |
// https://www.nas.nasa.gov/hecc/support/kb/cascade-lake-processors_579.html
// "Cache Hierarchy" | | Skylake                            | 64 |
// https://en.wikichip.org/wiki/intel/microarchitectures/kaby_lake "Memory
// Hierarchy" | | Ice Lake                           |                      64 |
// https://www.7-cpu.com/cpu/Ice_Lake.html | | Knights Landing | 64 |
// https://software.intel.com/en-us/articles/intel-xeon-phi-processor-7200-family-memory-management-optimizations
// "The Intel® Xeon Phi™ Processor Architecture" | | Knights Mill | 64 |
// https://software.intel.com/sites/default/files/managed/9e/bc/64-ia-32-architectures-optimization-manual.pdf?countrylabel=Colombia
// "2.5.5.2 L1 DCache "       |
// +------------------------------------+-------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
void X86TargetInfo::fillValidTuneCPUList(
