...
public:
    ...
    INLINE int InParallelRegion() const {
        return items.flags & TaskDescr_InPar;
    }
    ...
    INLINE int IsTaskConstruct() const {
        return !IsParallelConstruct();
    }
    // methods for other fields
    INLINE uint16_t &ThreadId() {
        return items.threadId;
    }
    INLINE uint64_t &RuntimeChunkSize() {
        return items.runtimeChunkSize;
    }
    INLINE omptarget_nvptx_TaskDescr *GetPrevTaskDescr() const {
        return prev;
    }
...
public:
    // access to data
    INLINE omptarget_nvptx_TaskDescr *WorkTaskDescr() {
        return &masterTaskICV;
    }
...
public:
    ...
    INLINE kmp_sched_t &ScheduleType(int tid) {
        return schedule[tid];
    }
    INLINE int64_t &Chunk(int tid) {
        return chunk[tid];
    }
    INLINE int64_t &LoopUpperBound(int tid) {
        return loopUpperBound[tid];
    }
    INLINE int64_t &NextLowerBound(int tid) {
        return nextLowerBound[tid];
    }
    INLINE int64_t &Stride(int tid) {
        return stride[tid];
    }
