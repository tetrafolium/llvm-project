...
public:
    ...
    llvm::iterator_range<iterator> pointer_types() {
        return PointerTypes;
    }
    ...
    llvm::iterator_range<iterator> vector_types() {
        return VectorTypes;
    }
    llvm::iterator_range<iterator> matrix_types() {
        return MatrixTypes;
    }

    bool containsMatrixType(QualType Ty) const {
...
ExprResult Sema::BuildCallToMemberFunction(Scope *S, Expr *MemExprE,
    ...
    auto BuildRecoveryExpr = [&](QualType Type) {
        ...
        llvm::for_each(Args, [&SubExprs](Expr *E) {
