...
// Returns the linked symbol table and associated string table for a given
// section.
template <class ELFT>
...
template <class ELFT> void GNUStyle<ELFT>::printStackSizes() {
...
template <class ELFT> void LLVMStyle<ELFT>::printStackSizes() {
