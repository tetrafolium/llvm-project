...
#define ISL_ARG_LONG(st, f, s, lo, d, h)                                       \
  {.type = isl_arg_long,                                                       \
   ...
   .offset = offsetof(st, f),                                                  \
   .help_msg = h,                                                              \
   .u = {.l = {.default_value = d, .default_selected = d, .set = NULL}}},
#define ISL_ARG_USER_LONG(st, f, s, lo, setter, d, h)                          \
  {.type = isl_arg_long,                                                       \
   ...
   .offset = offsetof(st, f),                                                  \
   .help_msg = h,                                                              \
   .u = {.l = {.default_value = d, .default_selected = d, .set = setter}}},
#define ISL_ARG_OPT_LONG(st, f, s, lo, d, ds, h)                               \
  {.type = isl_arg_long,                                                       \
   ...
   .offset = offsetof(st, f),                                                  \
   .help_msg = h,                                                              \
   .u = {.l = {.default_value = d, .default_selected = ds, .set = NULL}}},
...
#define ISL_ARG_VERSION(print)                                                 \
  {.type = isl_arg_version, .u = {.version = {.print_version = print}}},
...
#define ISL_ARG_DEF(prefix, st, args)                                          \
  st *prefix##_new_with_defaults() {                                           \
    ...
    return opt;                                                                \
                                                                               ...
                                                                               \
  void prefix##_free(st *opt) { isl_args_free(&(args), opt); }                 \
                                                                               \
  int prefix##_parse(st *opt, int argc, char **argv, unsigned flags) {         \
