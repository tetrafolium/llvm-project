...
public:
    ...
    uint16_t getVersion() const {
        return FormParams.Version;
    }
    dwarf::DwarfFormat getFormat() const {
        return FormParams.Format;
    }
...
public:
    ...
    uint8_t getAddressByteSize() const {
        return Header.getAddressByteSize();
    }
    uint8_t getRefAddrByteSize() const {
        return Header.getRefAddrByteSize();
    }
    uint8_t getDwarfOffsetByteSize() const {
    ...
    uint8_t getUnitType() const {
        return Header.getUnitType();
    }
    bool isTypeUnit() const {
        return Header.isTypeUnit();
    }
    uint64_t getAbbrOffset() const {
        return Header.getAbbrOffset();
    }
    uint64_t getNextUnitOffset() const {
        return Header.getNextUnitOffset();
    }
