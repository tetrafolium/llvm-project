...
public:
    ...
    void reset() {
        MostRecentlyCreated = nullptr;
    }

    void setCreateNewNodes(bool CNN) {
        CreateNewNodes = CNN;
    }
    ...
    bool isMostRecentlyCreated(Node *N) const {
        return MostRecentlyCreated == N;
    }
