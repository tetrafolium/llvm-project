 ...
 * is computed.
 */
static __isl_give TYPE *SF(isl_basic_map_partial_lexopt,
                           SUFFIX)(__isl_take isl_basic_map *bmap,
                                   __isl_take isl_basic_set *dom,
                                   __isl_give isl_set **empty, unsigned flags) {
  return SF(isl_tab_basic_map_partial_lexopt, SUFFIX)(bmap, dom, empty, flags);
}
...
__isl_give TYPE *SF(isl_basic_set_partial_lexmin,
                    SUFFIX)(__isl_take isl_basic_set *bset,
                            __isl_take isl_basic_set *dom,
                            __isl_give isl_set **empty) {
 ...
 */
static __isl_give TYPE *SF(basic_map_partial_lexopt,
                           SUFFIX)(__isl_take isl_basic_map *bmap,
  ...
  if (ISL_FL_ISSET(flags, ISL_OPT_FULL))
    return SF(isl_basic_map_partial_lexopt, SUFFIX)(bmap, NULL, empty, flags);
  ...
  res = SF(isl_basic_map_partial_lexopt, SUFFIX)(
      isl_basic_map_copy(bmap), isl_basic_set_copy(dom->p[0]), empty, flags);
  ...
  for (i = 1; i < dom->n; ++i) {
    ...
    res_i = SF(isl_basic_map_partial_lexopt, SUFFIX)(
        isl_basic_map_copy(bmap), isl_basic_set_copy(dom->p[i]), empty, flags);
...
__isl_give TYPE *SF(isl_basic_map_lexopt,
                    SUFFIX)(__isl_take isl_basic_map *bmap, unsigned flags) {
...
static __isl_give TYPE *SF(isl_map_partial_lexopt_aligned,
                           SUFFIX)(__isl_take isl_map *map,
                                   __isl_take isl_set *dom,
                                   __isl_give isl_set **empty, unsigned flags);
/* This function is currently only used when TYPE is defined as isl_map. */
static __isl_give TYPE *SF(isl_map_partial_lexopt,
                           SUFFIX)(__isl_take isl_map *map,
                                   __isl_take isl_set *dom,
                                   __isl_give isl_set **empty, unsigned flags)
...
static __isl_give TYPE *SF(isl_map_partial_lexopt,
  ...
  if (aligned < 0)
    goto error;
  if (aligned)
    return SF(isl_map_partial_lexopt_aligned, SUFFIX)(map, dom, empty, flags);
...
__isl_give TYPE *SF(isl_map_lexopt, SUFFIX)(__isl_take isl_map *map,
                                            unsigned flags) {
  ISL_FL_SET(flags, ISL_OPT_FULL);
  return SF(isl_map_partial_lexopt_aligned, SUFFIX)(map, NULL, NULL, flags);
}
