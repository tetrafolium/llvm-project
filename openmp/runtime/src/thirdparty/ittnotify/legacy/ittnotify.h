...
#define ITTNOTIFY_VOID_D0(n, d)                                                \
  (!(d)->flags) ? (void)0                                                      \
                : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d)
#define ITTNOTIFY_VOID_D1(n, d, x)                                             \
  (!(d)->flags) ? (void)0                                                      \
                : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d, x)
#define ITTNOTIFY_VOID_D2(n, d, x, y)                                          \
  (!(d)->flags) ? (void)0                                                      \
                : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d, x, y)
#define ITTNOTIFY_VOID_D3(n, d, x, y, z)                                       \
  (!(d)->flags)                                                                \
      ? (void)0                                                                \
      : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d, x, y, z)
#define ITTNOTIFY_VOID_D4(n, d, x, y, z, a)                                    \
  (!(d)->flags)                                                                \
      ? (void)0                                                                \
      : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d, x, y, z, a)
#define ITTNOTIFY_VOID_D5(n, d, x, y, z, a, b)                                 \
  (!(d)->flags)                                                                \
      ? (void)0                                                                \
      : (!ITTNOTIFY_NAME(n)) ? (void)0 : ITTNOTIFY_NAME(n)(d, x, y, z, a, b)
...
#define ITTNOTIFY_DATA_D4(n, d, x, y, z, a)                                    \
  (!(d)->flags) ? 0                                                            \
                : (!ITTNOTIFY_NAME(n)) ? 0 : ITTNOTIFY_NAME(n)(d, x, y, z, a)
#define ITTNOTIFY_DATA_D5(n, d, x, y, z, a, b)                                 \
  (!(d)->flags)                                                                \
      ? 0                                                                      \
      : (!ITTNOTIFY_NAME(n)) ? 0 : ITTNOTIFY_NAME(n)(d, x, y, z, a, b)
#define ITTNOTIFY_DATA_D6(n, d, x, y, z, a, b, c)                              \
  (!(d)->flags)                                                                \
      ? 0                                                                      \
      : (!ITTNOTIFY_NAME(n)) ? 0 : ITTNOTIFY_NAME(n)(d, x, y, z, a, b, c)
