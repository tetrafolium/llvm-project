...
protected:
    ...
    void setSize(CharUnits NewSize) {
        Size = Context.toBits(NewSize);
    }
    void setSize(uint64_t NewSize) {
        Size = NewSize;
    }

    CharUnits getAligment() const {
        return Alignment;
    }
    ...
    uint64_t getDataSizeInBits() const {
        return DataSize;
    }

    void setDataSize(CharUnits NewSize) {
