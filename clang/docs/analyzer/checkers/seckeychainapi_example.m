...
void test() {
  ...
  OSStatus st = SecKeychainItemCopyContent(2, ptr, ptr, length, outData);
...
void test() {
  ...
  OSStatus st = SecKeychainItemCopyAttributesAndData(
      itemRef, info, itemClass, &attrList, length, &outData);
