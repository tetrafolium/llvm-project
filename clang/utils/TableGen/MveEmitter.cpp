...
public:
    ...
    bool requiresFloat() const override {
        return false;
    }
    bool requiresMVE() const override {
        return false;
    }
    ...
    std::string acleSuffix(std::string) const override {
        return "";
    }
};
...
public:
    ...
    bool requiresFloat() const override {
        return Pointee->requiresFloat();
    }
    bool requiresMVE() const override {
        return Pointee->requiresMVE();
    }
    std::string cName() const override {
...
public:
    ...
    ScalarTypeKind kind() const {
        return Kind;
    }
    std::string suffix() const {
        return toLetter(Kind) + utostr(Bits);
    }
    ...
    bool isInteger() const {
        return Kind != ScalarTypeKind::Float;
    }
    bool requiresFloat() const override {
        return !isInteger();
    }
...
public:
    ...
    unsigned sizeInBits() const override {
        return Lanes * Element->sizeInBits();
    }
    unsigned lanes() const {
        return Lanes;
    }
    bool requiresFloat() const override {
        return Element->requiresFloat();
    }
    bool requiresMVE() const override {
        return true;
    }
...
public:
    ...
    virtual bool hasIntegerConstantValue() const {
        return false;
    }
    virtual uint32_t integerConstantValue() const {
        return 0;
    }
    virtual bool hasIntegerValue() const {
        return false;
    }
    ...
    void setVarname(const StringRef s) {
        VarName = std::string(s);
    }
    bool varnameUsed() const {
        return VarNameUsed;
    }
...
public:
    ...
    bool hasIntegerConstantValue() const override {
        return true;
    }
    uint32_t integerConstantValue() const override {
        return IntegerValue;
    }
};
...
public:
    ...
    StringRef builtinExtension() const {
    ...
    bool requiresMVE() const {
        ...
        any_of(ArgTypes, [](const Type *T) {
            return T->requiresMVE();
        });
    }
    bool polymorphic() const {
        return ShortName != FullName;
    }
    bool polymorphicOnly() const {
        return PolymorphicOnly;
    }
    bool nonEvaluating() const {
        return NonEvaluating;
    }
