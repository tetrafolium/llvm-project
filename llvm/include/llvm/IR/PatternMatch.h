...
inline class_match<UndefValue> m_Undef() {
...
struct m_SplatOrUndefMask {
    ...
    bool match(ArrayRef<int> Mask) {
        auto First = find_if(Mask, [](int Elem) {
            return Elem != -1;
        });
        if (First == Mask.end())
            return false;
