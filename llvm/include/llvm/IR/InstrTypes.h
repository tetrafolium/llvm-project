...
public:
    ...
    Predicate getPredicate() const {
        return getSubclassData<PredicateField>();
    }

    /// Set the predicate for this instruction to the specified value.
    void setPredicate(Predicate P) {
        setSubclassData<PredicateField>(P);
    }
    ...
    bool isFPPredicate() const {
        return isFPPredicate(getPredicate());
    }
    bool isIntPredicate() const {
        return isIntPredicate(getPredicate());
    }
    ...
    bool isStrictPredicate() const {
        return isStrictPredicate(getPredicate());
    }
...
public:
    ...
    bool doesNoCfCheck() const {
        return hasFnAttr(Attribute::NoCfCheck);
    }
    ...
    bool cannotDuplicate() const {
        return hasFnAttr(Attribute::NoDuplicate);
    }
    ...
    bool cannotMerge() const {
        return hasFnAttr(Attribute::NoMerge);
    }
    void setCannotMerge() {
    ...
    bool isConvergent() const {
        return hasFnAttr(Attribute::Convergent);
    }
    void setConvergent() {
...
public:
    ...
    op_range arg_operands() {
        return op_range(op_begin(), op_end() - 1);
    }
