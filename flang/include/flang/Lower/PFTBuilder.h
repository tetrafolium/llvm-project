...
public:
    ...
    constexpr auto visit(VISITOR &&visitor) const {
        return std::visit(
        common::visitors{[&visitor](auto ref) {
            return visitor(ref.get());
        }},
        u);
    }
...
struct Evaluation : EvaluationVariant {
    ...
    constexpr bool isActionStmt() const {
        return visit(common::visitors{
            [](auto &r) {
                return pft::isActionStmt<std::decay_t<decltype(r)>>;
            }});
    }
    constexpr bool isOtherStmt() const {
        return visit(common::visitors{
            [](auto &r) {
                return pft::isOtherStmt<std::decay_t<decltype(r)>>;
            }});
    }
    ...
    constexpr bool isConstruct() const {
        return visit(common::visitors{
            [](auto &r) {
                return pft::isConstruct<std::decay_t<decltype(r)>>;
            }});
    }
    constexpr bool isDirective() const {
        return visit(common::visitors{
            [](auto &r) {
                return pft::isDirective<std::decay_t<decltype(r)>>;
            }});
    }
...
struct FunctionLikeUnit : public ProgramUnit {
    ...
    std::vector<Variable> getOrderedSymbolTable() {
        return varList[0];
    }
    ...
    static parser::CharBlock stmtSourceLoc(const FunctionStatement &stmt) {
        return stmt.visit(common::visitors{[](const auto &x) {
            return x.source;
        }});
    }
