...
public:
  cpp_generator(SourceManager &SM, set<RecordDecl *> &exported_types,
                ...
                set<FunctionDecl *> functions, bool checked = false)
...
private:
  ...
  void print_protected_constructors_decl(ostream &os, const isl_class &clazz);
  void print_copy_assignment_decl(ostream &os, const isl_class &clazz);
  void print_public_constructors_decl(ostream &os, const isl_class &clazz);
  ...
  void print_isa_type_template(ostream &os, int indent, const isl_class &super);
  void print_downcast_decl(ostream &os, const isl_class &clazz);
  void print_ctx_decl(ostream &os);
  void print_persistent_callback_prototype(ostream &os, const isl_class &clazz,
                                           FunctionDecl *method,
                                           bool is_declaration);
  ...
  void print_persistent_callback_data(ostream &os, const isl_class &clazz,
                                      FunctionDecl *method);
  void print_persistent_callbacks_decl(ostream &os, const isl_class &clazz);
  ...
  template <enum method_part>
  void print_method(ostream &os, const isl_class &clazz, FunctionDecl *method,
                    function_kind kind);
  template <enum method_part>
  void print_method(ostream &os, const isl_class &clazz, FunctionDecl *method,
  ...
  void print_protected_constructors_impl(ostream &os, const isl_class &clazz);
  void print_public_constructors_impl(ostream &os, const isl_class &clazz);
  ...
  void print_check_no_persistent_callback(ostream &os, const isl_class &clazz,
                                          FunctionDecl *fd);
  ...
  void print_persistent_callbacks_impl(ostream &os, const isl_class &clazz);
  ...
  void print_argument_validity_check(ostream &os, FunctionDecl *method,
                                     function_kind kind);
  void print_save_ctx(ostream &os, FunctionDecl *method, function_kind kind);
  void print_on_error_continue(ostream &os);
  void print_exceptional_execution_check(ostream &os, const isl_class &clazz,
                                         FunctionDecl *method,
                                         function_kind kind);
  ...
  void print_set_enums_impl(ostream &os, const isl_class &clazz);
  template <enum method_part>
  void print_get_method(ostream &os, const isl_class &clazz, FunctionDecl *fd);
  ...
  void print_method_header(ostream &os, const isl_class &clazz,
                           FunctionDecl *method, const string &cname,
                           int num_params, bool is_declaration,
                           function_kind kind,
                           const std::vector<bool> &convert = {});
  void print_named_method_header(ostream &os, const isl_class &clazz,
                                 FunctionDecl *method, string name,
  ...
  void print_wrapped_call(std::ostream &os, int indent, const std::string &call,
                          QualType rtype);
  ...
  function_kind get_method_kind(const isl_class &clazz, FunctionDecl *method);
