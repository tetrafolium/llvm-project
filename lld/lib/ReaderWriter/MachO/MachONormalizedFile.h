...
struct Relocation {
  Relocation()
      : offset(0), scattered(false), type(llvm::MachO::GENERIC_RELOC_VANILLA),
        length(0), pcRel(false), isExtern(false), value(0), symbol(0) {}
...
struct Section {
  Section()
      : type(llvm::MachO::S_REGULAR), attributes(0), alignment(1), address(0) {}
