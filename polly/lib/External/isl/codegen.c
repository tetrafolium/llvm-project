...
set_universe(__isl_take isl_union_map *opt, __isl_keep isl_union_map *schedule,
             const char *name) {
  isl_ctx *ctx;
...
set_options(__isl_take isl_ast_build *build, __isl_take isl_union_map *opt,
...
node_set_options(__isl_take isl_schedule_node *node, void *user) {
...
schedule_set_options(__isl_take isl_schedule *schedule,
                     struct options *options) {
 ...
 */
static __isl_give isl_ast_node *
construct_ast_from_schedule(__isl_take isl_schedule *schedule) {
  isl_ast_build *build;
  isl_ast_node *tree;
  struct options *options;
