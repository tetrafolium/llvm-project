...
public:
    ...
    bool isValid() const {
        return Data.getOpaqueValue() != nullptr;
    }
    Stmt *getStmt() {
    ...
    Kind getKind() const {
        return static_cast<Kind>(Data.getInt());
    }
...
class CFGBlock {
    ...
    public:
        ...
        void push_back(CFGElement e, BumpVectorContext &C) {
            Impl.push_back(e, C);
        }
    ...
    public:
        ...
        CFGBlockPtr getParent() {
            return Parent;
        }
        CFGBlockPtr getParent() const {
            return Parent;
        }
...
public:
    ...
    const_iterator nodes_begin() const {
        return const_iterator(Blocks.begin());
    }
    const_iterator nodes_end() const {
        return const_iterator(Blocks.end());
    }
