...
public:
  explicit MacroDefinitionRecord(const IdentifierInfo *Name, SourceRange Range)
...
public:
  ...
  public:
    ...
    PreprocessedEntity *operator*() const {
      ...
      unsigned Index = isLoaded
                           ? Self->LoadedPreprocessedEntities.size() + this->I
                           : this->I;
  ...
  iterator end() { return iterator(this, PreprocessedEntities.size()); }

  /// Begin iterator for local, non-loaded, preprocessed entities.
  iterator local_begin() { return iterator(this, 0); }

  /// End iterator for local, non-loaded, preprocessed entities.
  iterator local_end() { return iterator(this, PreprocessedEntities.size()); }
