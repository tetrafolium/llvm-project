...
public:
    ...
    Expr *getAllocator() const {
        return cast_or_null<Expr>(Allocator);
    }

    child_range children() {
        return child_range(&Allocator, &Allocator + 1);
    }
...
class OMPAllocateClause final
    ...
    void setColonLoc(SourceLocation CL) {
        ColonLoc = CL;
    }
...
class OMPNumThreadsClause : public OMPClause, public OMPClauseWithPreInit {
    ...
    /// Set condition.
    void setNumThreads(Expr *NThreads) {
        NumThreads = NThreads;
    }
...
public:
    ...
    Expr *getNumThreads() const {
        return cast_or_null<Expr>(NumThreads);
    }

    child_range children() {
        return child_range(&NumThreads, &NumThreads + 1);
    }
...
public:
    ...
    Expr *getSafelen() const {
        return cast_or_null<Expr>(Safelen);
    }

    child_range children() {
        return child_range(&Safelen, &Safelen + 1);
    }
...
public:
    ...
    Expr *getSimdlen() const {
        return cast_or_null<Expr>(Simdlen);
    }

    child_range children() {
        return child_range(&Simdlen, &Simdlen + 1);
    }
...
class OMPScheduleClause : public OMPClause, public OMPClauseWithPreInit {
    ...
    void setScheduleKind(OpenMPScheduleClauseKind K) {
        Kind = K;
    }
...
class OMPLastprivateClause final
    ...
    void setKind(OpenMPLastprivateModifier Kind) {
        LPKind = Kind;
    }
    /// Sets location of the lastprivate kind.
    void setKindLoc(SourceLocation Loc) {
        LPKindLoc = Loc;
    }
...
class OMPReductionClause final
    ...
    void setModifier(OpenMPReductionClauseModifier M) {
        Modifier = M;
    }
    ...
    void setNameInfo(DeclarationNameInfo DNI) {
        NameInfo = DNI;
    }

    /// Sets the nested name specifier.
    void setQualifierLoc(NestedNameSpecifierLoc NSL) {
        QualifierLoc = NSL;
    }
...
class OMPDependClause final
    ...
    /// Set dependency kind.
    void setDependencyKind(OpenMPDependClauseKind K) {
        DepKind = K;
    }
...
class OMPDeviceClause : public OMPClause, public OMPClauseWithPreInit {
    ...
    /// Sets modifier.
    void setModifier(OpenMPDeviceClauseModifier M) {
        Modifier = M;
    }
...
private:
    ...
    void setMapType(OpenMPMapClauseKind T) {
        MapType = T;
    }
    ...
    void setMapLoc(SourceLocation TLoc) {
        MapLoc = TLoc;
    }
...
public:
    ...
    Expr *getGrainsize() const {
        return cast_or_null<Expr>(Grainsize);
    }
...
public:
    ...
    Expr *getNumTasks() const {
        return cast_or_null<Expr>(NumTasks);
    }
...
class OMPDistScheduleClause : public OMPClause, public OMPClauseWithPreInit {
    ...
    ///
    /// \param K Schedule kind.
    void setDistScheduleKind(OpenMPDistScheduleClauseKind K) {
        Kind = K;
    }
...
class OMPDefaultmapClause : public OMPClause {
    ...
    void setDefaultmapKind(OpenMPDefaultmapClauseKind K) {
        Kind = K;
    }
...
class OMPOrderClause final : public OMPClause {
    ...
    ///
    /// \param K Argument of clause.
    void setKind(OpenMPOrderClauseKind K) {
        Kind = K;
    }
    ...
    ///
    /// \param KLoc Argument location.
    void setKindKwLoc(SourceLocation KLoc) {
        KindKwLoc = KLoc;
    }
...
public:
    ...
    Expr *getEventHandler() const {
        return cast_or_null<Expr>(Evt);
    }

    child_range children() {
        return child_range(&Evt, &Evt + 1);
    }
