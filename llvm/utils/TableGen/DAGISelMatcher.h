...
public:
    ...
    const Matcher *getNext() const {
        return Next.get();
    }
    void setNext(Matcher *C) {
        Next.reset(C);
    }
    Matcher *takeNext() {
        return Next.release();
    ...
    std::unique_ptr<Matcher> &getNextPtr() {
        return Next;
    }
...
public:
    ...
    Matcher *getChild(unsigned i) {
        return Children[i];
    }
    const Matcher *getChild(unsigned i) const {
        return Children[i];
    }
...
public:
    ...
    const std::string &getWhatFor() const {
        return WhatFor;
    }
    unsigned getResultNo() const {
        return ResultNo;
    }
...
public:
    ...
    const SDNodeInfo &getOpcode() const {
        return Opcode;
    }
...
public:
    ...
    const SDNodeInfo &getCaseOpcode(unsigned i) const {
        return *Cases[i].first;
    }
    Matcher *getCaseMatcher(unsigned i) {
        return Cases[i].second;
    }
    const Matcher *getCaseMatcher(unsigned i) const {
        return Cases[i].second;
    }
...
public:
    ...
    MVT::SimpleValueType getType() const {
        return Type;
    }
...
public:
    ...
    MVT::SimpleValueType getCaseType(unsigned i) const {
        return Cases[i].first;
    }
    Matcher *getCaseMatcher(unsigned i) {
        return Cases[i].second;
...
public:
    ...
    StringRef getCondCodeName() const {
        return CondCodeName;
    }
...
public:
    ...
    const ComplexPattern &getPattern() const {
        return Pattern;
    }
    unsigned getMatchNumber() const {
        return MatchNumber;
...
public:
    ...
    MVT::SimpleValueType getVT() const {
        return VT;
    }
...
public:
    ...
    unsigned getSrcSlot() const {
        return SrcSlot;
    }
    const CodeGenRegister *getDestPhysReg() const {
        return DestPhysReg;
    }
...
public:
    ...
    const SmallVectorImpl<MVT::SimpleValueType> &getVTList() const {
        return VTs;
    }
    const SmallVectorImpl<unsigned> &getOperandList() const {
        return Operands;
    }
    ...
    bool hasInFlag() const {
        return HasInGlue;
    }
    bool hasOutFlag() const {
        return HasOutGlue;
    }
    bool hasMemRefs() const {
        return HasMemRefs;
    }
    int getNumFixedArityOperands() const {
...
public:
    ...
    unsigned getFirstResultSlot() const {
...
public:
    ...
    const PatternToMatch &getPattern() const {
        return Pattern;
    }
...
public:
    ...
    unsigned getResult(unsigned R) const {
        return Results[R];
    }
    const PatternToMatch &getPattern() const {
        return Pattern;
