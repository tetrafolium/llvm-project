...
public:
    ...
    /// No scope specifier.
    bool isEmpty() const {
        return Range.isInvalid() && getScopeRep() == nullptr;
    }
    ...
    bool isInvalid() const {
        return Range.isValid() && getScopeRep() == nullptr;
    }
    /// A scope specifier is present, and it refers to a real scope.
    bool isValid() const {
        return getScopeRep() != nullptr;
    }
...
public:
    ...
    bool isTypeRep() const {
        return isTypeRep((TST) TypeSpecType);
    }
    ...
    SourceRange getTypeofParensRange() const {
        return TypeofParensRange;
    }
    void setTypeofParensRange(SourceRange range) {
        TypeofParensRange = range;
    }
...
public:
    ...
    bool isOverrideSpecified() const {
        return Specifiers & VS_Override;
    }
    SourceLocation getOverrideLoc() const {
        return VS_overrideLoc;
    }
