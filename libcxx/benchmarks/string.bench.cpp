...
struct StringCopy {
    ...
    static std::string name() {
        return "BM_StringCopy" + Length::name();
    }
};
...
struct StringDestroy {
    ...
    static std::string name() {
        return "BM_StringDestroy" + Length::name();
    }
};
...
struct StringMove {
    ...
    static std::string name() {
        return "BM_StringMove" + Length::name();
    }
};
...
void sanityCheckGeneratedStrings() {
    ...
    for (auto L : {
                Length::Small, Length::Large, Length::Huge
            }) {
...
bool StringEqCStr(const std::string& a, const char* b) {
    return a == b;
}
bool CStrEqString(const char* a, const std::string& b) {
    return a == b;
}
