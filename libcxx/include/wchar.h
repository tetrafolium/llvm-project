...
extern "C++" {
    ...
    wchar_t* __libcpp_wcschr(const wchar_t* __s, wchar_t __c) {
    ...
    inline _LIBCPP_INLINE_VISIBILITY _LIBCPP_PREFERRED_OVERLOAD
    wchar_t* wcschr(      wchar_t* __s, wchar_t __c) {
        return __libcpp_wcschr(__s, __c);
    }
    ...
    inline _LIBCPP_INLINE_VISIBILITY
    wchar_t* __libcpp_wcsrchr(const wchar_t* __s, wchar_t __c) {
    ...
    inline _LIBCPP_INLINE_VISIBILITY
    wchar_t* __libcpp_wcsstr(const wchar_t* __s1, const wchar_t* __s2) {
