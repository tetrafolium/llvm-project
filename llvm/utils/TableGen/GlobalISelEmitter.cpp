...
public:
    ...
    bool operator==(const LLTCodeGen &B) const {
        return Ty == B.Ty;
    }
};
...
public:
    ...
    bool isWithCoverage() const {
        return IsWithCoverage;
    }
...
public:
    ...
    action_iterator actions_begin() {
        return Actions.begin();
    }
    action_iterator actions_end() {
        return Actions.end();
    }
    ...
    InstructionMatcher &insnmatchers_front() const {
        return *Matchers.front();
    }

    unsigned allocateOutputInsnID() {
        return NextOutputInsnID++;
    }
    unsigned allocateTempRegID() {
        return NextTempRegID++;
    }

    iterator_range<MatchersTy::iterator> insnmatchers() {
        return make_range(Matchers.begin(), Matchers.end());
    }
    bool insnmatchers_empty() const {
        return Matchers.empty();
    }
...
public:
    ...
    /// matcher.
    virtual unsigned countRendererFns() const {
        return 0;
    }
};
...
public:
    ...
    bool hasSymbolicName() const {
        return !SymbolicName.empty();
    }
    const StringRef getSymbolicName() const {
        return SymbolicName;
    }
    ...
    InstructionMatcher &getInstructionMatcher() const {
        return Insn;
    }
...
public:
    ...
    StringRef getSymbolicName() const {
        return SymbolicName;
    }
    unsigned getNumOperands() const {
        return Operands.size();
    }
    OperandVec::iterator operands_begin() {
        return Operands.begin();
    }
    OperandVec::iterator operands_end() {
        return Operands.end();
    }
    ...
    StringRef getOpcode() {
        return getOpcodeMatcher().getOpcode();
    }
};
...
public:
    ...
    InstructionMatcher &getInsnMatcher() const {
        return *InsnMatcher;
    }
...
public:
    ...
    unsigned getInsnID() const {
        return InsnID;
    }
    const CodeGenInstruction *getCGI() const {
        return I;
    }
