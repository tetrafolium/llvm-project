...
isl_stat isl_tab_track_bmap(struct isl_tab *tab,
                            __isl_take isl_basic_map *bmap) WARN_UNUSED;
isl_stat isl_tab_track_bset(struct isl_tab *tab,
                            __isl_take isl_basic_set *bset) WARN_UNUSED;
...
isl_stat isl_tab_rollback(struct isl_tab *tab,
                          struct isl_tab_undo *snap) WARN_UNUSED;
...
__isl_give isl_map *
isl_tab_basic_map_partial_lexopt(__isl_take isl_basic_map *bmap,
...
isl_stat isl_tab_push(struct isl_tab *tab,
                      enum isl_tab_undo_type type) WARN_UNUSED;
