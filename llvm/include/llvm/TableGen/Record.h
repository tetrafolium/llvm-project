...
public:
    ...
    const_record_iterator classes_begin() const {
        return getClasses().begin();
    }
    const_record_iterator classes_end() const {
        return getClasses().end();
    }
...
public:
    ...
    const_iterator begin() const {
        return getTrailingObjects<Init *>();
    }
...
public:
    ...
    Init *getOperand(unsigned i) const override {
        switch (i) {
        default:
            llvm_unreachable("Invalid operand id for binary operator");
        case 0:
            return getLHS();
        case 1:
            return getRHS();
...
public:
    ...
    Init *getOperand(unsigned i) const override {
        switch (i) {
        default:
            llvm_unreachable("Invalid operand id for ternary operator");
        case 0:
            return getLHS();
        case 1:
            return getMHS();
...
public:
    ...
    inline const_case_iterator  arg_begin() const {
        return getConds().begin();
    }
    inline const_case_iterator  arg_end  () const {
        return getConds().end();
    }
    ...
    inline const_val_iterator name_begin() const {
        return getVals().begin();
    }
    inline const_val_iterator name_end  () const {
        return getVals().end();
    }
...
public:
    ...
    static bool classof(const Init *I) {
        return I->getKind() == IK_FoldOpInit;
    }
...
public:
    ...
    ArrayRef<Init *> args() const {
        return makeArrayRef(args_begin(), NumArgs);
    }
...
public:
    ...
    inline const_name_iterator name_end  () const {
        return getArgNames().end();
    }
...
public:
    ...
    bool getPrefix() const {
        return TyAndPrefix.getInt();
    }

    /// Get the type of the field value as a RecTy.
    RecTy *getType() const {
        return TyAndPrefix.getPointer();
    }
