...
public:
    ...
    InstructionSet::iterator begin() {
        return Set.begin();
    }
    InstructionSet::iterator end() {
        return Set.end();
    }
    InstructionSet::const_iterator begin() const {
        return Set.begin();
    }
    InstructionSet::const_iterator end() const {
        return Set.end();
    }
    bool empty() const {
        return Set.empty();
    ...
    /// this is null.
    const Loop *getClonedLoop() const {
        return ClonedLoop;
    }
...
public:
    ...
    AccessesType::const_iterator begin() const {
        return Accesses.begin();
    }
    AccessesType::const_iterator end() const {
        return Accesses.end();
    }
...
public:
    ...
    const Optional<bool> &isForced() const {
        return IsForced;
    }
