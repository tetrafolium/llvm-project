...
public:
    ...
    class ClusterId {
    public:
        static ClusterId noise() {
            return ClusterId(kNoise);
        }
        static ClusterId error() {
            return ClusterId(kError);
        }
    ...
    const std::vector<InstructionBenchmark> &getPoints() const {
        return Points_;
    }
    ...
    const std::vector<Cluster> &getValidClusters() const {
        return Clusters_;
    }
