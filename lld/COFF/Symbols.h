...
public:
    ...
    uint64_t getRVA() {
        return va - config->imageBase;
    }
    void setVA(uint64_t v) {
        va = v;
    }
...
public:
    ...
    StringRef getDLLName() {
        return file->dllName;
    }
    StringRef getExternalName() {
        return file->externalName;
    }
    uint16_t getOrdinal() {
