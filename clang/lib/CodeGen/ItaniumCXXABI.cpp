...
protected:
    ...
    /// across a program.
    virtual bool shouldRTTIBeUnique() const {
        return true;
    }
...
private:
    ...
    bool canCallMismatchedFunctionType() const override {
        return false;
    }
};
...
public:
    ...
    bool useSinitAndSterm() const override {
        return true;
    }
...
void ItaniumCXXABI::EmitFundamentalRTTIDescriptors(const CXXRecordDecl *RD) {
    ...
    for (const QualType &FundamentalType : FundamentalTypes) {
        ...
        for (QualType Type : {
                    FundamentalType, PointerType, PointerTypeConst
                })
