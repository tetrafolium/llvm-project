...
struct Copy {
    ...
    static std::string name() {
        return "BM_Copy" + FunctionType::name();
    }
};
...
struct OperatorBool {
    ...
    static std::string name() {
        return "BM_OperatorBool" + FunctionType::name();
    }
};
...
struct Invoke {
    ...
    static bool skip() {
        return FunctionType() == ::FunctionType::Null;
    }

    static std::string name() {
        return "BM_Invoke" + FunctionType::name();
    }
};
