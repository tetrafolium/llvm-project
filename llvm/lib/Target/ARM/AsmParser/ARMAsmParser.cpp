...
public:
    ...
    bool hasFnStart() const {
        return !FnStartLocs.empty();
    }
    bool cantUnwind() const {
        return !CantUnwindLocs.empty();
    }
    bool hasHandlerData() const {
    ...
    void recordFnStart(SMLoc L) {
        FnStartLocs.push_back(L);
    }
    void recordCantUnwind(SMLoc L) {
        CantUnwindLocs.push_back(L);
    }
    void recordPersonality(SMLoc L) {
        PersonalityLocs.push_back(L);
    }
    void recordHandlerData(SMLoc L) {
        HandlerDataLocs.push_back(L);
    }
    void recordPersonalityIndex(SMLoc L) {
        PersonalityIndexLocs.push_back(L);
    }

    void saveFPReg(int Reg) {
        FPReg = Reg;
    }
    int getFPReg() const {
        return FPReg;
...
class ARMAsmParser : public MCTargetAsmParser {
    ...
    bool inExplicitITBlock() {
        return inITBlock() && ITState.IsExplicit;
    }
    bool inImplicitITBlock() {
        return inITBlock() && !ITState.IsExplicit;
    }
...
public:
    ...
    bool isDPRRegList() const {
        return Kind == k_DPRRegisterList;
    }
    bool isSPRRegList() const {
        return Kind == k_SPRRegisterList;
    }
    bool isFPSRegListWithVPR() const {
        return Kind == k_FPSRegisterListWithVPR;
    }
    bool isFPDRegListWithVPR() const {
        return Kind == k_FPDRegisterListWithVPR;
    }
    bool isToken() const override {
        return Kind == k_Token;
    }
    bool isMemBarrierOpt() const {
        return Kind == k_MemBarrierOpt;
    }
    bool isInstSyncBarrierOpt() const {
        return Kind == k_InstSyncBarrierOpt;
    }
    bool isTraceSyncBarrierOpt() const {
    ...
    bool isMSRMask() const {
        return Kind == k_MSRMask;
    }
    bool isBankedReg() const {
        return Kind == k_BankedReg;
    }
    bool isProcIFlags() const {
