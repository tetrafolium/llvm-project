...
private:
    ...
    public:
        ...
        SourceLocation getCurDiagStateLoc() const {
...
public:
    ...
    void setErrorsAsFatal(bool Val) {
        GetCurDiagState()->ErrorsAsFatal = Val;
    }
    bool getErrorsAsFatal() const {
        return GetCurDiagState()->ErrorsAsFatal;
    }
    ...
    bool hasAllExtensionsSilenced() {
        return AllExtensionsSilenced != 0;
    }
...
public:
    ...
    unsigned getNumArgs() const {
        return DiagObj->DiagStorage.NumDiagArgs;
    }
