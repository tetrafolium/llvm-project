...
extern __inline __m128
  ...
  static const __vector unsigned int float_exp_mask = {0x7f800000, 0x7f800000,
...
extern __inline __m128
  ...
  const __vector unsigned short zero = {0, 0, 0, 0, 0, 0, 0, 0};
...
extern __inline __m128
  ...
  const __vector unsigned char zero = {0, 0, 0, 0, 0, 0, 0, 0};
  ...
  vi4 = (__vector unsigned int)vec_mergeh(vs8, (__vector unsigned short)zero);
#else
  vs8 = (__vector unsigned short)vec_mergel(zero, vc16);
  vi4 = (__vector unsigned int)vec_mergeh((__vector unsigned short)zero, vs8);
#endif
  vf1 = (__vector float)vec_ctf(vi4, 0);
...
extern __inline __m64
  ...
  const __vector unsigned int zero = {0, 0, 0, 0};
