...
inline StringRef getTypeAttrName() {
    return "type";
}
...
public:
    ...
    void push_back(Block *block) {
        getBody().push_back(block);
    }
    void push_front(Block *block) {
        getBody().push_front(block);
    }
    ...
    static StringRef getTypeAttrName() {
        return ::mlir::impl::getTypeAttrName();
    }
