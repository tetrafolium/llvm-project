...
public:
    ...
    bool isInstr() const {
        return !OpIdx.hasValue();
    }
    StringRef getName() const {
        return Name;
    }
    unsigned getInstrID() const {
        return InstrID;
    }
...
public:
    GIMatchTreeLeafInfo() {
        llvm_unreachable("Cannot default-construct");
    }
    ...
    bool isFullyTraversed() const {
        return IsFullyTraversed;
    }
    void setIsFullyTraversed(bool V) {
        IsFullyTraversed = V;
    }
    bool isFullyTested() const {
        return IsFullyTested;
    }
    void setIsFullyTested(bool V) {
        IsFullyTested = V;
    }
...
public:
    ...
    GIMatchTreePartitioner *getPartitioner() const {
    ...
    std::vector<GIMatchTree>::iterator children_end() {
        return Children.end();
    }
...
public:
    ...
    const GIMatchDagInstr *getInstrNode() const {
        return InstrNode;
    }
};
...
public:
    ...
    GIMatchTreeLeafInfo &getInfo() {
        return Info;
    }
    const GIMatchTreeLeafInfo &getInfo() const {
        return Info;
    }
    const GIMatchDag &getMatchDag() const {
        return MatchDag;
    }
    unsigned getRootIdx() const {
        return Info.getRootIdx();
    }
...
public:
    ...
    void addLeaf(const GIMatchTreeBuilderLeafInfo &L) {
        Leaves.push_back(L);
    }
    ...
    LeafVec &getPossibleLeaves() {
        return Leaves;
    }

    unsigned allocInstrID() {
        return NextInstrID++;
    }
