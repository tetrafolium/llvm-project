...
#define _CLC_SHUFFLE_DEFINE2(ARGTYPE, ARGSIZE, MASKTYPE)                       \
  _CLC_DEF _CLC_OVERLOAD ARGTYPE##2 shuffle(ARGTYPE##ARGSIZE x,                \
                                            MASKTYPE##2 mask) {                \
    ARGTYPE##2 ret_val;                                                        \
...
#define _CLC_SHUFFLE_DEFINE4(ARGTYPE, ARGSIZE, MASKTYPE)                       \
  _CLC_DEF _CLC_OVERLOAD ARGTYPE##4 shuffle(ARGTYPE##ARGSIZE x,                \
                                            MASKTYPE##4 mask) {                \
    ARGTYPE##4 ret_val;                                                        \
...
#define _CLC_SHUFFLE_DEFINE8(ARGTYPE, ARGSIZE, MASKTYPE)                       \
  _CLC_DEF _CLC_OVERLOAD ARGTYPE##8 shuffle(ARGTYPE##ARGSIZE x,                \
                                            MASKTYPE##8 mask) {                \
    ARGTYPE##8 ret_val;                                                        \
...
#define _CLC_SHUFFLE_DEFINE16(ARGTYPE, ARGSIZE, MASKTYPE)                      \
  _CLC_DEF _CLC_OVERLOAD ARGTYPE##16 shuffle(ARGTYPE##ARGSIZE x,               \
                                             MASKTYPE##16 mask) {              \
    ARGTYPE##16 ret_val;                                                       \
