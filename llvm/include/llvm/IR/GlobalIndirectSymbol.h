...
public:
  ...
  void setIndirectSymbol(Constant *Symbol) { setOperand(0, Symbol); }
  const Constant *getIndirectSymbol() const { return getOperand(0); }
  ...
  GlobalObject *getBaseObject(const DataLayout &DL, APInt &Offset) {
    return const_cast<GlobalObject *>(
        static_cast<const GlobalIndirectSymbol *>(this)->getBaseObject(DL,
                                                                       Offset));
  }
