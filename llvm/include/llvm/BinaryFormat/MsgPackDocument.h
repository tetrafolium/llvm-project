...
public:
    ...
    // Type methods
    bool isMap() const {
        return getKind() == Type::Map;
    }
    bool isArray() const {
        return getKind() == Type::Array;
    }
    bool isScalar() const {
        return !isMap() && !isArray();
    }
    bool isString() const {
        return getKind() == Type::String;
    }
    ...
    bool isEmpty() const {
        return !KindAndDoc || getKind() == Type::Empty;
    }
    Type getKind() const {
...
public:
    MapDocNode() {}
    MapDocNode(DocNode &N) : DocNode(N) {
...
public:
    ArrayDocNode() {}
    ArrayDocNode(DocNode &N) : DocNode(N) {
