...
__isl_export __isl_give isl_ast_build *
isl_ast_build_from_context(__isl_take isl_set *set);
...
__isl_export __isl_give isl_ast_build *isl_ast_build_set_at_each_domain(
...
__isl_overload __isl_give isl_ast_expr *
...
__isl_overload __isl_give isl_ast_node *
isl_ast_build_node_from_schedule(__isl_keep isl_ast_build *build,
                                 __isl_take isl_schedule *schedule);
__isl_export __isl_give isl_ast_node *
isl_ast_build_node_from_schedule_map(__isl_keep isl_ast_build *build,
                                     __isl_take isl_union_map *schedule);
__isl_give isl_ast_node *
isl_ast_build_ast_from_schedule(__isl_keep isl_ast_build *build,
                                __isl_take isl_union_map *schedule);
