...
/* int -> t -> unit */
CAMLprim value llvm_pmbuilder_use_inliner_with_threshold(value Threshold,
                                                         value PMB) {
...
/* bool -> t -> unit */
CAMLprim value
llvm_pmbuilder_set_disable_unit_at_a_time(value DisableUnitAtATime, value PMB) {
...
/* bool -> t -> unit */
CAMLprim value llvm_pmbuilder_set_disable_unroll_loops(value DisableUnroll,
                                                       value PMB) {
...
CAMLprim value
llvm_pmbuilder_populate_module_pass_manager(LLVMPassManagerRef PM, value PMB) {
...
CAMLprim value llvm_pmbuilder_populate_lto_pass_manager(LLVMPassManagerRef PM,
                                                        value Internalize,
                                                        value RunInliner,
                                                        value PMB) {
