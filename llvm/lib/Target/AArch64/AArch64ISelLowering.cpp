...
#undef LCALLNAME5
    ...
    if (Subtarget->hasSVE()) {
        ...
        for (auto VT : {
                    MVT::nxv16i1, MVT::nxv8i1, MVT::nxv4i1, MVT::nxv2i1
                }) {
        ...
        for (auto VT : {
                    MVT::nxv2bf16, MVT::nxv4bf16, MVT::nxv8bf16
                }) {
            setOperationAction(ISD::MGATHER, VT, Custom);
            setOperationAction(ISD::MSCATTER, VT, Custom);
        }
        ...
        if (Subtarget->useSVEForFixedLengthVectors()) {
            ...
            for (auto VT : {
                        MVT::v8i8, MVT::v16i8, MVT::v4i16, MVT::v8i16,
...
static bool isWideDUPMask(ArrayRef<int> M, EVT VT, unsigned BlockSize,
    ...
    auto FirstRealEltIter = find_if(BlockElts, [](int Elt) {
        return Elt >= 0;
    });
...
static bool isEXTMask(ArrayRef<int> M, EVT VT, bool &ReverseEXT,
    ...
    const int *FirstRealElt = find_if(M, [](int Elt) {
        return Elt >= 0;
    });
