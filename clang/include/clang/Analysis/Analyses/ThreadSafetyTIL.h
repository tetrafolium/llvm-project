...
public:
    ...
    TIL_Opcode opcode() const {
        return static_cast<TIL_Opcode>(Opcode);
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_Variable;
    }

    /// Return the kind of variable (let, function param, or self)
    VariableKind kind() const {
        return static_cast<VariableKind>(Flags);
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_LiteralPtr;
    }
...
public:
    ...
    AllocKind kind() const {
        return static_cast<AllocKind>(Flags);
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_Store;
    }

    SExpr *destination() {
        return Dest;    // Address to store to
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_ArrayIndex;
    }
...
public:
    ...
    UnaryOp(const UnaryOp &U, SExpr *E) : SExpr(U), Expr0(E) {
        Flags = U.Flags;
    }

    static bool classof(const SExpr *E) {
        return E->opcode() == COP_UnaryOp;
    }
...
public:
    Cast(TIL_CastOpcode Op, SExpr *E) : SExpr(COP_Cast), Expr0(E) {
        Flags = Op;
    }
    Cast(const Cast &C, SExpr *E) : SExpr(C), Expr0(E) {
        Flags = C.Flags;
    }

    static bool classof(const SExpr *E) {
        return E->opcode() == COP_Cast;
    }
...
public:
    ...
    Status status() const {
        return static_cast<Status>(Flags);
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_BasicBlock;
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_Identifier;
    }
...
public:
    ...
    static bool classof(const SExpr *E) {
        return E->opcode() == COP_IfThenElse;
    }

    SExpr *condition() {
        return Condition;    // Address to store to
    }
    const SExpr *condition() const {
        return Condition;
    }
    ...
    SExpr *thenExpr() {
        return ThenExpr;    // Value to store
    }
    ...
    SExpr *elseExpr() {
        return ElseExpr;    // Value to store
    }
