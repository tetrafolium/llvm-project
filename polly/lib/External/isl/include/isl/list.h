...
#define ISL_DECLARE_LIST_FN3(EL, CONSTRUCTOR, EXPORT)                          \
  ...
  __isl_give isl_##EL##_list *isl_##EL##_list_add(                             \
      __isl_take isl_##EL##_list *list, __isl_take isl_##EL *el);              \
  EXPORT                                                                       \
  ...
  __isl_give isl_##EL##_list *isl_##EL##_list_swap(                            \
      __isl_take isl_##EL##_list *list, unsigned pos1, unsigned pos2);         \
  __isl_give isl_##EL##_list *isl_##EL##_list_reverse(                         \
      __isl_take isl_##EL##_list *list);                                       \
  EXPORT                                                                       \
  __isl_give isl_##EL##_list *isl_##EL##_list_concat(                          \
      __isl_take isl_##EL##_list *list1, __isl_take isl_##EL##_list *list2);   \
  EXPORT                                                                       \
  ...
  EXPORT                                                                       \
  isl_stat isl_##EL##_list_foreach(                                            \
      __isl_keep isl_##EL##_list *list,                                        \
      isl_stat (*fn)(__isl_take isl_##EL * el, void *user), void *user);       \
  isl_bool isl_##EL##_list_every(                                              \
      __isl_keep isl_##EL##_list *list,                                        \
      isl_bool (*test)(__isl_keep isl_##EL * el, void *user), void *user);     \
  __isl_give isl_##EL##_list *isl_##EL##_list_map(                             \
      __isl_take isl_##EL##_list *list,                                        \
      __isl_give isl_##EL *(*fn)(__isl_take isl_##EL * el, void *user),        \
      void *user);                                                             \
  __isl_give isl_##EL##_list *isl_##EL##_list_sort(                            \
      ...
      void *user);                                                             \
  isl_stat isl_##EL##_list_foreach_scc(                                        \
      __isl_keep isl_##EL##_list *list,                                        \
      ...
      void *fn_user);                                                          \
  __isl_give char *isl_##EL##_list_to_str(__isl_keep isl_##EL##_list *list);   \
