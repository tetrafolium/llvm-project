...
constexpr auto statusExpr {
    construct<StatusExpr>(scalarDefaultCharExpr)
};
constexpr auto errLabel {
    construct<ErrLabel>(label)
};
...
constexpr auto idVariable {
    construct<IdVariable>(scalarIntVariable)
};
...
constexpr auto endLabel {
    construct<EndLabel>(label)
};
constexpr auto eorLabel {
    construct<EorLabel>(label)
};
...
constexpr auto ioImpliedDoControl {
...
constexpr auto idExpr {
    construct<IdExpr>(scalarIntExpr)
};
...
constexpr auto mandatoryWidth {
    construct<std::optional<int>>(width)
};
constexpr auto digits {
    repeat
};
constexpr auto noInt {
    construct<std::optional<int>>()
};
constexpr auto mandatoryDigits {
    construct<std::optional<int>>("." >> width)
};
