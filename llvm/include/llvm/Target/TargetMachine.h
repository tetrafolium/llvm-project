...
public:
    ...
    bool requiresStructuredCFG() const {
        return RequireStructuredCFG;
    }
    void setRequiresStructuredCFG(bool Value) {
        RequireStructuredCFG = Value;
    }
    ...
    void setFastISel(bool Enable) {
        Options.EnableFastISel = Enable;
    }
    bool getO0WantsFastISel() {
        return O0WantsFastISel;
    }
    void setO0WantsFastISel(bool Enable) {
        O0WantsFastISel = Enable;
    }
    void setGlobalISel(bool Enable) {
        Options.EnableGlobalISel = Enable;
    }
    ...
    bool getUniqueSectionNames() const {
        return Options.UniqueSectionNames;
    }
    ...
    bool getXCOFFTracebackTable() const {
        return Options.XCOFFTracebackTable;
    }
