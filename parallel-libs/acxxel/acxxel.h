...
protected:
    ...
    void *getStreamHandle(Stream &Stream) {
        return Stream.TheHandle.get();
    }
    void *getEventHandle(Event &Event) {
        return Event.TheHandle.get();
    }
