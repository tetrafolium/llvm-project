...
public:
    ...
    bool operator()(const Constant<SomeDerived> &) const {
        return true;
    }
...
struct IsActuallyConstantHelper {
    template <typename A> bool operator()(const A &) {
        return false;
    }
    template <typename T> bool operator()(const Constant<T> &) {
        return true;
    }
...
public:
    ...
    bool emittedMessage() const {
        return emittedMessage_;
    }

    bool operator()(const BOZLiteralConstant &) const {
        return false;
    }
    ...
    bool operator()(const StaticDataObject &) const {
        return false;
    }
    ...
    bool operator()(const Relational<SomeType> &) const {
        return false;
    }
...
private:
    ...
    static bool IsProhibitedFunction(std::string name) {
        return false;
    }
};
...
public:
    ...
    Result operator()(const ComplexPart &) const {
        return false;
    }
