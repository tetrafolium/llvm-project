...
struct TemplateIdAnnotation final
  ...
  Create(SourceLocation TemplateKWLoc, SourceLocation TemplateNameLoc,
    ...
    TemplateIdAnnotation *TemplateId = new (llvm::safe_malloc(
        ...
        TemplateIdAnnotation(TemplateKWLoc, TemplateNameLoc, Name, OperatorKind,
                             OpaqueTemplateName, TemplateKind, LAngleLoc,
                             RAngleLoc, TemplateArgs, ArgsInvalid);
  ...
  bool mightBeType() const {
    return Kind == TNK_Non_template || Kind == TNK_Type_template ||
...
private:
  ...
  TemplateIdAnnotation(SourceLocation TemplateKWLoc,
                       ...
                       TemplateNameKind TemplateKind, SourceLocation LAngleLoc,
                       SourceLocation RAngleLoc,
