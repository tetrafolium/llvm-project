...
#define _mm512_mask_exp2a23_round_pd(S, M, A, R)                               \
  (__m512d) __builtin_ia32_exp2pd_mask(                                        \
      (__v8df)(__m512d)(A), (__v8df)(__m512d)(S), (__mmask8)(M), (int)(R))
...
#define _mm512_mask_exp2a23_round_ps(S, M, A, R)                               \
  (__m512) __builtin_ia32_exp2ps_mask(                                         \
      (__v16sf)(__m512)(A), (__v16sf)(__m512)(S), (__mmask16)(M), (int)(R))
...
#define _mm512_mask_rsqrt28_round_pd(S, M, A, R)                               \
  (__m512d) __builtin_ia32_rsqrt28pd_mask(                                     \
      (__v8df)(__m512d)(A), (__v8df)(__m512d)(S), (__mmask8)(M), (int)(R))
...
#define _mm512_mask_rsqrt28_round_ps(S, M, A, R)                               \
  (__m512) __builtin_ia32_rsqrt28ps_mask(                                      \
      (__v16sf)(__m512)(A), (__v16sf)(__m512)(S), (__mmask16)(M), (int)(R))
...
#define _mm512_mask_rcp28_round_ps(S, M, A, R)                                 \
  (__m512) __builtin_ia32_rcp28ps_mask(                                        \
      (__v16sf)(__m512)(A), (__v16sf)(__m512)(S), (__mmask16)(M), (int)(R))
...
#define _mm_rcp28_round_ss(A, B, R)                                            \
  (__m128) __builtin_ia32_rcp28ss_round_mask(                                  \
      (__v4sf)(__m128)(A), (__v4sf)(__m128)(B), (__v4sf)_mm_setzero_ps(),      \
      (__mmask8)-1, (int)(R))
...
#define _mm_rcp28_round_sd(A, B, R)                                            \
  (__m128d) __builtin_ia32_rcp28sd_round_mask(                                 \
      (__v2df)(__m128d)(A), (__v2df)(__m128d)(B), (__v2df)_mm_setzero_pd(),    \
      (__mmask8)-1, (int)(R))
