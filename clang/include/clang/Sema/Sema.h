...
public:
    ...
    public:
        ...
        Kind getKind() const {
            return static_cast<Kind>(Pair.getInt());
        }
        void setKind(Kind K) {
            Pair.setInt(K);
        }
...
public:
    ...
    public:
        ...
        bool isSpecialMember() const {
            return SpecialMember != CXXInvalid;
        }
...
public:
    ...
    public:
        ...
        bool isRequired() const {
            return TemplateKW != SourceLocation();
        }
        explicit operator bool() const {
            return isRequired();
        }
...
public:
    ...
    bool isInOpenMPAssumeScope() const {
        return !OMPAssumeScoped.empty();
    }

    /// Check if there is an active global `omp assumes` directive.
    bool hasGlobalOpenMPAssumes() const {
        return !OMPAssumeGlobal.empty();
    }
...
private:
    ...
    public:
        SavePendingParsedClassStateRAII(Sema &S) : S(S) {
            swapSavedState();
        }
    ...
    struct MisalignedMember {
        ...
        bool operator==(const MisalignedMember &m) {
            return this->E == m.E;
        }
    };
