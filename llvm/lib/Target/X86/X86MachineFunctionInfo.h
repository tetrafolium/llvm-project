...
public:
    ...
    bool getHasPushSequences() const {
        return HasPushSequences;
    }
    void setHasPushSequences(bool HasPush) {
        HasPushSequences = HasPush;
    }

    bool getRestoreBasePointer() const {
        return RestoreBasePointerOffset!=0;
    }
    ...
    int getFAIndex() const {
        return FrameAddrIndex;
    }
    void setFAIndex(int Index) {
        FrameAddrIndex = Index;
    }
    ...
    void setArgumentStackSize(unsigned size) {
        ArgumentStackSize = size;
    }

    unsigned getNumLocalDynamicTLSAccesses() const {
        return NumLocalDynamics;
    }
    ...
    bool hasPreallocatedCall() const {
        return HasPreallocatedCall;
    }
    void setHasPreallocatedCall(bool v) {
        HasPreallocatedCall = v;
    }
