...
COMPILER_RT_VISIBILITY
extern char NamesStart __asm("section$start$__DATA$" INSTR_PROF_NAME_SECT_NAME);
COMPILER_RT_VISIBILITY
...
COMPILER_RT_VISIBILITY
extern uint32_t OrderFileStart __asm(
    "section$start$__DATA$" INSTR_PROF_ORDERFILE_SECT_NAME);
...
COMPILER_RT_VISIBILITY
ValueProfNode *__llvm_profile_begin_vnodes(void) { return &VNodesStart; }
COMPILER_RT_VISIBILITY
