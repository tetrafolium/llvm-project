...
public:
    ...
    StringRef getSDClassName() const {
        return SDClassName;
    }
...
public:
    ...
    TreePattern *getOrigPatFragRecord() const {
        return PatFragRec;
    }
...
public:
    ...
    const std::vector<TypeSetByHwMode> &getExtTypes() const {
        return Types;
    }
    const TypeSetByHwMode &getExtType(unsigned ResNo) const {
        return Types[ResNo];
    }
    TypeSetByHwMode &getExtType(unsigned ResNo) {
        return Types[ResNo];
    }
    void setType(unsigned ResNo, const TypeSetByHwMode &T) {
        Types[ResNo] = T;
    }
    ...
    unsigned getNumResults() const {
        return ResultPerm.size();
    }
    unsigned getResultIndex(unsigned ResNo) const {
        return ResultPerm[ResNo];
    }
    void setResultIndex(unsigned ResNo, unsigned RI) {
        ResultPerm[ResNo] = RI;
    }
    ...
    TreePatternNode *getChild(unsigned N) const {
        return Children[N].get();
    }
    const TreePatternNodePtr &getChildShared(unsigned N) const {
        return Children[N];
    }
    void setChild(unsigned i, TreePatternNodePtr N) {
        Children[i] = N;
    }
    ...
    Record *getTransformFn() const {
        return TransformFn;
    }
    void setTransformFn(Record *Fn) {
        TransformFn = Fn;
    }
...
public:
    ...
    ///
    const std::vector<TreePatternNodePtr> &getTrees() const {
        return Trees;
    }
    unsigned getNumTrees() const {
        return Trees.size();
    }
    const TreePatternNodePtr &getTree(unsigned i) const {
        return Trees[i];
    }
    ...
    CodeGenDAGPatterns &getDAGPatterns() const {
        return CDP;
    }
...
public:
    ...
    unsigned getNumImpResults() const {
        return ImpResults.size();
    }
    const std::vector<Record*>& getImpResults() const {
        return ImpResults;
    }
    ...
    TreePatternNodePtr getSrcPattern() const {
        return SrcPattern;
    }
    TreePatternNodePtr getResultPattern() const {
...
public:
    ...
    Record          *getSrcRecord()  const {
        return SrcRecord;
    }
    TreePatternNode *getSrcPattern() const {
        return SrcPattern.get();
    }
    TreePatternNodePtr getSrcPatternShared() const {
        return SrcPattern;
    }
    TreePatternNode *getDstPattern() const {
        return DstPattern.get();
    }
    TreePatternNodePtr getDstPatternShared() const {
        return DstPattern;
    }
    const std::vector<Record*> &getDstRegs() const {
        return Dstregs;
    }
    int         getAddedComplexity() const {
...
public:
    ...
    CodeGenTarget &getTargetInfo() {
        return Target;
    }
    const CodeGenTarget &getTargetInfo() const {
        return Target;
    }
    ...
    pf_iterator pf_begin() const {
        return PatternFragments.begin();
    }
    pf_iterator pf_end() const {
        return PatternFragments.end();
    }
    iterator_range<pf_iterator> ptfs() const {
        return PatternFragments;
    }

    // Patterns to match information.
    typedef std::vector<PatternToMatch>::const_iterator ptm_iterator;
    ptm_iterator ptm_begin() const {
        return PatternsToMatch.begin();
    }
    ptm_iterator ptm_end() const {
        return PatternsToMatch.end();
    }
    iterator_range<ptm_iterator> ptms() const {
