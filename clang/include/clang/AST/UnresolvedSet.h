...
private:
    ...
    UnresolvedSetImpl &operator=(UnresolvedSetImpl &&) {
        return *this;
    }
...
public:
    ...
    iterator begin() {
        return iterator(decls().begin());
    }
    iterator end() {
        return iterator(decls().end());
    }

    const_iterator begin() const {
        return const_iterator(decls().begin());
    }
    const_iterator end() const {
        return const_iterator(decls().end());
    }
    ...
    void append(iterator I, iterator E) {
        decls().append(I.I, E.I);
    }

    template<typename Iter> void assign(Iter I, Iter E) {
        decls().assign(I, E);
    }
