...
public:
    ...
    DeclNode getBase() const {
        return DeclNode(ASTNode::getBase().getRecord());
    }
...
public:
    ...
    TypeNode getBase() const {
        return TypeNode(ASTNode::getBase().getRecord());
    }
...
public:
    ...
    llvm::StringRef getClassName() const;
    StmtNode getBase() const {
        return StmtNode(ASTNode::getBase().getRecord());
    }
