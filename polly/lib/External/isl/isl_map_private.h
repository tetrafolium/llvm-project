...
__isl_give isl_basic_map *
isl_basic_map_sort_divs(__isl_take isl_basic_map *bmap);
...
__isl_give isl_basic_map *
isl_basic_map_implicit_equalities(__isl_take isl_basic_map *bmap);
__isl_give isl_basic_set *
...
isl_basic_map_add_div_constraint(__isl_take isl_basic_map *bmap, unsigned div,
                                 int sign);
__isl_give isl_basic_map *
isl_basic_map_add_div_constraints(__isl_take isl_basic_map *bmap, unsigned div);
__isl_give isl_basic_map *
...
__isl_give isl_basic_set *
isl_basic_set_recession_cone(__isl_take isl_basic_set *bset);
__isl_give isl_basic_set *
isl_basic_set_lineality_space(__isl_take isl_basic_set *bset);
__isl_give isl_basic_set *
isl_set_combined_lineality_space(__isl_take isl_set *set);
...
__isl_give isl_basic_map *
isl_basic_map_from_multi_aff2(__isl_take isl_multi_aff *maff, int rational);
__isl_give isl_map *
isl_map_from_multi_aff_internal(__isl_take isl_multi_aff *ma);
__isl_give isl_map *isl_map_from_pw_aff_internal(__isl_take isl_pw_aff *pa);
__isl_give isl_map *
isl_map_from_pw_multi_aff_internal(__isl_take isl_pw_multi_aff *pma);
...
isl_int *isl_set_wrap_facet(__isl_keep isl_set *set, isl_int *facet,
                            isl_int *ridge);
...
__isl_give isl_basic_map *
isl_basic_map_expand_divs(__isl_take isl_basic_set *bmap,
                          __isl_take isl_mat *div, int *exp);
...
isl_stat isl_basic_set_check_range(__isl_keep isl_basic_set *bset,
                                   enum isl_dim_type type, unsigned first,
                                   unsigned n);
isl_stat isl_set_check_range(__isl_keep isl_set *set, enum isl_dim_type type,
                             unsigned first, unsigned n);
...
__isl_give isl_basic_set *
isl_basic_set_plain_affine_hull(__isl_take isl_basic_set *bset);
__isl_give isl_basic_map *
isl_basic_map_plain_affine_hull(__isl_take isl_basic_map *bmap);

isl_stat isl_basic_set_dim_residue_class(__isl_keep isl_basic_set *bset,
                                         int pos, isl_int *modulo,
                                         isl_int *residue);
isl_stat isl_set_dim_residue_class(__isl_keep isl_set *set, int pos,
                                   isl_int *modulo, isl_int *residue);
...
int isl_basic_set_count_upto(__isl_keep isl_basic_set *bset, isl_int max,
                             isl_int *count);
