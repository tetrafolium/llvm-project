...
public:
    ...
    Fortran::parser::AllSources &allSources() const {
        return *allSources_;
    }

    bool HasAllSources() const {
        return allSources_ != nullptr;
    }
    ...
    Fortran::parser::Parsing &parsing() const {
        return *parsing_;
    }
    ...
    llvm::raw_ostream &semaOutputStream() {
        return *semaOutputStream_;
    }
