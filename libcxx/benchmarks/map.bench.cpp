...
struct Base {
    ...
    std::string baseName() const {
        return "_MapSize=" + std::to_string(MapSize);
    }
};
...
struct ConstructorIterator : Base {
    ...
    std::string name() const {
        return "BM_ConstructorIterator" + baseName();
    }
};
...
struct ConstructorCopy : Base {
    ...
    std::string name() const {
        return "BM_ConstructorCopy" + baseName();
    }
};
...
struct ConstructorMove : Base {
    ...
    std::string name() const {
        return "BM_ConstructorMove" + baseName();
    }
};
