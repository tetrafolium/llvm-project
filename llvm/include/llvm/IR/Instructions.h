...
public:
    ...
    void setSwiftError(bool V) {
        setSubclassData<SwiftErrorField>(V);
    }
...
public:
    ...
    void setVolatile(bool V) {
        setSubclassData<VolatileField>(V);
    }
...
public:
    ...
    void setWeak(bool IsWeak) {
        setSubclassData<WeakField>(IsWeak);
    }
...
public:
    ...
    BinOp getOperation() const {
        return getSubclassData<OperationField>();
    }
...
public:
    ...
    bool isMustTailCall() const {
        return getTailCallKind() == TCK_MustTail;
    }

    bool isNoTailCall() const {
        return getTailCallKind() == TCK_NoTail;
    }
...
public:
    ...
    void setCleanup(bool V) {
        setSubclassData<CleanupField>(V);
    }
...
public:
    ...
    SwitchInstProfUpdateWrapper(SwitchInst &SI) : SI(SI) {
        init();
    }
...
public:
    ...
    bool hasUnwindDest() const {
        return getSubclassData<UnwindDestField>();
    }
...
private:
    static BasicBlock *handler_helper(Value *V) {
