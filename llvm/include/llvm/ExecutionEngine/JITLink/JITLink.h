...
public:
    ...
    const_iterator begin() const {
        return AddrToBlock.begin();
    }
    const_iterator end() const {
        return AddrToBlock.end();
    }
...
createLookupContinuation(Continuation Cont) {
    ...
    public:
        ...
        void run(Expected<AsyncLookupResult> LR) override {
            C(std::move(LR));
        }
