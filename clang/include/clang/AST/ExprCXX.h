...
public:
    ...
    bool isAssignmentOp() const {
        return isAssignmentOp(getOperator());
    }
    ...
    bool isComparisonOp() const {
        return isComparisonOp(getOperator());
    }
...
public:
    ...
    bool isReversed() const {
        return CXXRewrittenBinaryOperatorBits.IsReversed;
    }

    BinaryOperatorKind getOperator() const {
        return getDecomposedForm().Opcode;
    }
...
public:
    ...
    bool getValue() const {
        return CXXBoolLiteralExprBits.Value;
    }
    void setValue(bool V) {
        CXXBoolLiteralExprBits.Value = V;
    }
    ...
    SourceLocation getLocation() const {
        return CXXBoolLiteralExprBits.Loc;
    }
    void setLocation(SourceLocation L) {
        CXXBoolLiteralExprBits.Loc = L;
    }
...
public:
    ...
    SourceLocation getLocation() const {
        return CXXNullPtrLiteralExprBits.Loc;
    }
    void setLocation(SourceLocation L) {
        CXXNullPtrLiteralExprBits.Loc = L;
    }
...
public:
    ...
    Expr *getSubExpr() {
        return static_cast<Expr*>(SubExpr);
    }
    const Expr *getSubExpr() const {
        return static_cast<const Expr*>(SubExpr);
    }
...
public:
    ...
    bool isTypeOperand() const {
        return Operand.is<TypeSourceInfo *>();
    }
...
public:
    ...
    bool isImplicit() const {
        return CXXThisExprBits.IsImplicit;
    }
    void setImplicit(bool I) {
        CXXThisExprBits.IsImplicit = I;
    }
...
public:
    ...
    const Expr *getSubExpr() const {
        return cast_or_null<Expr>(Operand);
    }
    Expr *getSubExpr() {
        return cast_or_null<Expr>(Operand);
    }
    ...
    SourceLocation getThrowLoc() const {
        return CXXThrowExprBits.ThrowLoc;
    }
...
public:
    ...
    SourceLocation getUsedLocation() const {
        return CXXDefaultArgExprBits.Loc;
    }
...
public:
    ...
    SourceLocation getBeginLoc() const {
        return CXXDefaultInitExprBits.Loc;
    }
    SourceLocation getEndLoc() const {
        return CXXDefaultInitExprBits.Loc;
    }
...
public:
    ...
    SourceLocation getLocation() const {
        return CXXConstructExprBits.Loc;
    }
    ...
    bool isElidable() const {
        return CXXConstructExprBits.Elidable;
    }
    void setElidable(bool E) {
        CXXConstructExprBits.Elidable = E;
    }
    ...
    Expr **getArgs() {
        return reinterpret_cast<Expr **>(getTrailingArgs());
    }
    ...
    SourceRange getParenOrBraceRange() const {
        return ParenOrBraceRange;
    }
    void setParenOrBraceRange(SourceRange Range) {
        ParenOrBraceRange = Range;
    }
...
public:
    ...
    unsigned capture_size() const {
        return LambdaExprBits.NumCaptures;
    }
    ...
    bool isGenericLambda() const {
        return getTemplateParameterList();
    }
    ...
    bool hasExplicitParameters() const {
        return LambdaExprBits.ExplicitParams;
    }
...
class CXXNewExpr final
    ...
    unsigned arraySizeOffset() const {
        return 0;
    }
    unsigned initExprOffset() const {
...
public:
    ...
    bool isParenTypeId() const {
        return CXXNewExprBits.IsParenTypeId;
    }
    ...
    bool isGlobalNew() const {
        return CXXNewExprBits.IsGlobalNew;
    }
    ...
    bool passAlignment() const {
        return CXXNewExprBits.ShouldPassAlignment;
    }
...
public:
    ...
    bool isGlobalDelete() const {
        return CXXDeleteExprBits.GlobalDelete;
    }
    bool isArrayForm() const {
        return CXXDeleteExprBits.ArrayForm;
    }
...
public:
    ...
    ArrayTypeTrait getTrait() const {
        return static_cast<ArrayTypeTrait>(ATT);
    }
...
public:
    ...
    ExpressionTrait getTrait() const {
        return static_cast<ExpressionTrait>(ET);
    }
...
public:
    ...
    unsigned getNumDecls() const {
        return OverloadExprBits.NumResults;
    }
...
public:
    ...
    bool requiresADL() const {
        return UnresolvedLookupExprBits.RequiresADL;
    }

    /// True if this lookup is overloaded.
    bool isOverloaded() const {
        return UnresolvedLookupExprBits.Overloaded;
    }
...
public:
    ...
    unsigned getNumObjects() const {
        return ExprWithCleanupsBits.NumObjects;
    }
...
public:
    ...
    unsigned getNumArgs() const {
        return CXXUnresolvedConstructExprBits.NumArgs;
    }
...
public:
    ...
    bool isArrow() const {
        return CXXDependentScopeMemberExprBits.IsArrow;
    }
...
public:
    ...
    /// operator; otherwise, it used the '.' operator.
    bool isArrow() const {
        return UnresolvedMemberExprBits.IsArrow;
    }
...
public:
    ...
    bool getValue() const {
        return CXXNoexceptExprBits.Value;
    }
...
public:
    ...
    Expr *getPattern() {
        return reinterpret_cast<Expr *>(Pattern);
    }
...
public:
    ...
    Expr *getLHS() const {
        return static_cast<Expr*>(SubExprs[SubExpr::LHS]);
    }
    Expr *getRHS() const {
        return static_cast<Expr*>(SubExprs[SubExpr::RHS]);
    }
...
public:
    ...
    bool isImplicit() const {
        return CoawaitBits.IsImplicit;
    }
    void setIsImplicit(bool value = true) {
        CoawaitBits.IsImplicit = value;
    }
