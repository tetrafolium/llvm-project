...
public:
    ...
    StringLiteral *getString() {
        return cast<StringLiteral>(String);
    }
...
public:
    ...
    bool isSuperReceiver() const {
        return Receiver.is<const Type*>();
    }
    bool isClassReceiver() const {
        return Receiver.is<ObjCInterfaceDecl*>();
    }
...
private:
    ...
    void setSuperReceiver(QualType T) {
        Receiver = T.getTypePtr();
    }
    void setClassReceiver(ObjCInterfaceDecl *D) {
        Receiver = D;
    }
    ...
    void setReceiverLocation(SourceLocation Loc) {
        ReceiverLoc = Loc;
    }
