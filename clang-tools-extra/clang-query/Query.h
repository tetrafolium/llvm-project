...
struct SetExclusiveOutputQuery : Query {
    ...
    static bool classof(const Query *Q) {
        return Q->Kind == QK_SetOutputKind;
    }
...
struct EnableOutputQuery : SetNonExclusiveOutputQuery {
    ...
    static bool classof(const Query *Q) {
        return Q->Kind == QK_EnableOutputKind;
    }
};
