...
public:
  ...
  virtual bool storeOfVectorConstantIsCheap(EVT MemVT, unsigned NumElem,
  ...
  virtual bool isCheapToSpeculateCttz() const { return false; }

  /// Return true if it is cheap to speculate a call to intrinsic ctlz.
  virtual bool isCheapToSpeculateCtlz() const { return false; }
  ...
  /// type.
  virtual bool hasBitPreservingFPLogic(EVT VT) const { return false; }
...
public:
  ...
  /// (Limit). It returns the types of the sequence of memory ops to perform
