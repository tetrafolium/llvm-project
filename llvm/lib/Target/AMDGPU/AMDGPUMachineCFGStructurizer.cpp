...
public:
    ...
    void setRegionMRT(RegionMRT *Region) {
        RMRT = Region;
    }
    ...
    void setParent(LinearizedRegion *P) {
        Parent = P;
    }

    LinearizedRegion *getParent() {
        return Parent;
    }
...
public:
    ...
    void setBBSelectRegOut(unsigned Reg) {
        BBSelectRegOut = Reg;
    }

    virtual RegionMRT *getRegionMRT() {
        return nullptr;
    }

    virtual MBBMRT *getMBBMRT() {
        return nullptr;
    }

    bool isRegion() {
        return getRegionMRT() != nullptr;
    }

    bool isMBB() {
        return getMBBMRT() != nullptr;
    }
    ...
    void setParent(RegionMRT *Region) {
        Parent = Region;
    }
...
public:
    ...
    RegionMRT *getRegionMRT() override {
        return this;
    }
    ...
    LinearizedRegion *getLinearizedRegion() {
        return LRegion;
    }

    MachineRegion *getMachineRegion() {
        return Region;
    }
    ...
    void addChild(MRT *Tree) {
        Children.insert(Tree);
    }

    SetVector<MRT *> *getChildren() {
        return &Children;
    }
    ...
    void setSucc(MachineBasicBlock *MBB) {
        Succ = MBB;
    }

    MachineBasicBlock *getSucc() {
        return Succ;
    }
...
bool LinearizedRegion::getHasLoop() {
    return HasLoop;
}

void LinearizedRegion::addLiveOut(unsigned VReg) {
    LiveOuts.insert(VReg);
}
...
MachineBasicBlock *LinearizedRegion::getEntry() {
    return Entry;
}

void LinearizedRegion::setExit(MachineBasicBlock *NewExit) {
    Exit = NewExit;
}

MachineBasicBlock *LinearizedRegion::getExit() {
    return Exit;
}

void LinearizedRegion::addMBB(MachineBasicBlock *MBB) {
    MBBs.insert(MBB);
}
...
public:
    ...
    void setRegionMRT(RegionMRT *RegionTree) {
        RMRT = RegionTree;
    }
