...
public:
    ...
    bool isPredicate() const {
        return Flags & (1 << MCOI::Predicate);
    }

    /// Set if this operand is a optional def.
    bool isOptionalDef() const {
        return Flags & (1 << MCOI::OptionalDef);
    }

    /// Set if this operand is a branch target.
    bool isBranchTarget() const {
        return Flags & (1 << MCOI::BranchTarget);
    }
...
public:
    ...
    bool isPreISelOpcode() const {
        return Flags & (1ULL << MCID::PreISelOpcode);
    }
    ...
    bool isVariadic() const {
        return Flags & (1ULL << MCID::Variadic);
    }

    /// Set if this instruction has an optional definition, e.g.
    /// ARM instructions which can set condition code if 's' bit is set.
    bool hasOptionalDef() const {
        return Flags & (1ULL << MCID::HasOptionalDef);
    }

    /// Return true if this is a pseudo instruction that doesn't
    /// correspond to a real machine instruction.
    bool isPseudo() const {
        return Flags & (1ULL << MCID::Pseudo);
    }

    /// Return true if the instruction is a return.
    bool isReturn() const {
        return Flags & (1ULL << MCID::Return);
    }

    /// Return true if the instruction is an add instruction.
    bool isAdd() const {
        return Flags & (1ULL << MCID::Add);
    }

    /// Return true if this instruction is a trap.
    bool isTrap() const {
        return Flags & (1ULL << MCID::Trap);
    }

    /// Return true if the instruction is a register to register move.
    bool isMoveReg() const {
        return Flags & (1ULL << MCID::MoveReg);
    }

    ///  Return true if the instruction is a call.
    bool isCall() const {
        return Flags & (1ULL << MCID::Call);
    }
    ...
    bool isBarrier() const {
        return Flags & (1ULL << MCID::Barrier);
    }
    ...
    bool isTerminator() const {
        return Flags & (1ULL << MCID::Terminator);
    }
    ...
    bool isPredicable() const {
        return Flags & (1ULL << MCID::Predicable);
    }

    /// Return true if this instruction is a comparison.
    bool isCompare() const {
        return Flags & (1ULL << MCID::Compare);
    }

    /// Return true if this instruction is a move immediate
    /// (including conditional moves) instruction.
    bool isMoveImmediate() const {
        return Flags & (1ULL << MCID::MoveImm);
    }

    /// Return true if this instruction is a bitcast instruction.
    bool isBitcast() const {
        return Flags & (1ULL << MCID::Bitcast);
    }

    /// Return true if this is a select instruction.
    bool isSelect() const {
        return Flags & (1ULL << MCID::Select);
    }
    ...
    bool canFoldAsLoad() const {
        return Flags & (1ULL << MCID::FoldableAsLoad);
    }
    ...
    bool isRegSequenceLike() const {
        return Flags & (1ULL << MCID::RegSequence);
    }
    ...
    bool isConvergent() const {
        return Flags & (1ULL << MCID::Convergent);
    }
    ...
    bool mayLoad() const {
        return Flags & (1ULL << MCID::MayLoad);
    }
    ...
    bool mayStore() const {
        return Flags & (1ULL << MCID::MayStore);
    }
    ...
    bool isCommutable() const {
        return Flags & (1ULL << MCID::Commutable);
    }
    ...
    bool isAsCheapAsAMove() const {
        return Flags & (1ULL << MCID::CheapAsAMove);
    }
