...
public:
    ...
    ElementCount getVectorFactor() const {
        return VF;
    }
...
public:
    ...
    bool hasBranchDivergence() override {
    ...
    bool isTypeLegal(Type *Ty) override {
    ...
    bool haveFastSqrt(Type *Ty) override {
    ...
    int getFPOpCost(Type *Ty) override {
