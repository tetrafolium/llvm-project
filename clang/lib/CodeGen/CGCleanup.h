...
public:
    ...
    Kind getKind() const {
        return static_cast<Kind>(CommonBits.Kind);
    }
...
public:
    ...
    bool isNormalCleanup() const {
        return CleanupBits.IsNormalCleanup;
    }
    ...
    bool isEHCleanup() const {
        return CleanupBits.IsEHCleanup;
    }
    ...
    void setActive(bool A) {
        CleanupBits.IsActive = A;
    }

    bool isLifetimeMarker() const {
        return CleanupBits.IsLifetimeMarker;
    }
    void setLifetimeMarker() {
        CleanupBits.IsLifetimeMarker = true;
    }

    bool hasActiveFlag() const {
        return ActiveFlag != nullptr;
    }
    ...
    size_t getCleanupSize() const {
        return CleanupBits.CleanupSize;
    }
...
public:
    ...
    static size_t getSize() {
        return sizeof(EHTerminateScope);
    }
...
struct EHPersonality {
    ...
    bool isWasmPersonality() const {
        return this == &GNU_Wasm_CPlusPlus;
    }
