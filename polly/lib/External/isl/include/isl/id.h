...
__isl_give isl_id *isl_id_alloc(isl_ctx *ctx, __isl_keep const char *name,
                                void *user);
...
__isl_constructor __isl_give isl_multi_id *
isl_multi_id_read_from_str(isl_ctx *ctx, const char *str);
