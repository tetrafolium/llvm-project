 ...
 */
static isl_bool printed_before(__isl_keep isl_printer *p,
 ...
 */
static void ppcg_macros_free(void *user) { free(user); }
...
ppcg_ast_expr_print_macros(__isl_keep isl_ast_expr *expr,
                           __isl_take isl_printer *p) {
 ...
 */
__isl_give isl_printer *
ppcg_print_body_macros(__isl_take isl_printer *p,
...
ppcg_attach_multi_pw_aff(__isl_take isl_multi_pw_aff *mpa,
 ...
 */
__isl_give isl_printer *
ppcg_print_declaration_with_size(__isl_take isl_printer *p,
 ...
 */
__isl_give isl_printer *
ppcg_print_declaration(__isl_take isl_printer *p, struct pet_array *array,
                       __isl_keep isl_ast_build *build) {
 ...
 */
__isl_give isl_printer *
ppcg_print_exposed_declarations(__isl_take isl_printer *p,
                                struct ppcg_scop *scop) {
 ...
 */
__isl_give isl_printer *
ppcg_print_hidden_declarations(__isl_take isl_printer *p,
                               struct ppcg_scop *scop) {
