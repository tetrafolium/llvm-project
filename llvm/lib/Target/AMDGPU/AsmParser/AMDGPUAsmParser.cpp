...
public:
    ...
    bool isR128A16() const {
        return isImmTy(ImmTyR128A16);
    }
    bool isGFX10A16() const {
    ...
    bool isInterpSlot() const {
        return isImmTy(ImmTyInterpSlot);
    }
    bool isInterpAttr() const {
...
public:
    ...
    void setForcedDPP(bool ForceDPP_) {
        ForcedDPP = ForceDPP_;
    }
    void setForcedSDWA(bool ForceSDWA_) {
        ForcedSDWA = ForceSDWA_;
    }
    ...
    bool isForcedDPP() const {
        return ForcedDPP;
    }
    bool isForcedSDWA() const {
        return ForcedSDWA;
    }
