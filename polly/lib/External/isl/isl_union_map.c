...
isl_union_map_alloc(__isl_take isl_space *space, int size) {
  isl_union_map *umap;
...
isl_union_map_empty_space(__isl_take isl_space *space) {
...
isl_union_set_empty_space(__isl_take isl_space *space) {
...
static isl_stat align_entry(void **entry, void *user) {
  ...
  data->res =
      isl_union_map_add_map(data->res, isl_map_realign(isl_map_copy(map), exp));
 ...
 */
__isl_give isl_union_map *
isl_union_map_align_params(__isl_take isl_union_map *umap,
  ...
  data.res =
      isl_union_map_alloc(isl_reordering_get_space(data.exp), umap->table.n);
  if (isl_hash_table_foreach(umap->dim->ctx, &umap->table, &align_entry,
                             &data) < 0)
    goto error;
...
__isl_give isl_union_set *
isl_union_set_align_params(__isl_take isl_union_set *uset,
                           __isl_take isl_space *model) {
...
__isl_null isl_union_map *isl_union_map_free(__isl_take isl_union_map *umap) {
  ...
  isl_hash_table_foreach(umap->dim->ctx, &umap->table, &free_umap_entry, NULL);
...
__isl_give isl_union_map *isl_union_map_add_map(__isl_take isl_union_map *umap,
  ...
  entry = isl_hash_table_find(umap->dim->ctx, &umap->table, hash, &has_space,
                              map->dim, 1);
  if (!entry)
    goto error;
...
__isl_give isl_union_map *
isl_union_map_from_basic_map(__isl_take isl_basic_map *bmap) {
  return isl_union_map_from_map(isl_map_from_basic_map(bmap));
}

__isl_give isl_union_set *
isl_union_set_from_basic_set(__isl_take isl_basic_set *bset) {
...
isl_stat isl_union_map_foreach_map(__isl_keep isl_union_map *umap,
                                   isl_stat (*fn)(__isl_take isl_map *map,
                                                  void *user),
                                   void *user) {
  ...
  return isl_hash_table_foreach(umap->dim->ctx, &umap->table, &call_on_copy,
                                &data);
}
...
isl_union_map_get_map_list(__isl_keep isl_union_map *umap) {
  isl_size n_maps;
  isl_ctx *ctx;
  isl_map_list *list;
...
isl_union_set_get_set_list(__isl_keep isl_union_set *uset) {
  return set_list_from_map_list(isl_union_map_get_map_list(uset_to_umap(uset)));
}
...
isl_stat isl_union_set_foreach_set(__isl_keep isl_union_set *uset,
  ...
  return isl_union_map_foreach_map(
      uset, (isl_stat(*)(__isl_take isl_map *, void *))fn, user);
}
...
isl_bool isl_union_set_every_set(__isl_keep isl_union_set *uset,
  ...
  return isl_union_map_every_map(uset_to_umap(uset), &test_set_from_map, &data);
}
 ...
 */
static __isl_give isl_union_map *
bin_add_pair(__isl_take isl_union_map *res, __isl_keep isl_map *map1,
...
static __isl_keep isl_maybe_isl_map bin_try_get_match(
  ...
  entry2 = isl_hash_table_find(isl_union_map_get_ctx(data->umap2),
                               &data->umap2->table, hash, &has_space, space, 0);
  isl_space_free(space);
  if (entry2)
 ...
 */
static __isl_give isl_union_map *
gen_bin_op(__isl_take isl_union_map *umap1, __isl_take isl_union_map *umap2,
           struct isl_bin_op_control *control) {
  ...
  data.umap2 = umap2;
  data.res = isl_union_map_alloc(isl_space_copy(umap1->dim), umap1->table.n);
  if (isl_hash_table_foreach(umap1->dim->ctx, &umap1->table, &gen_bin_entry,
                             &data) < 0)
    goto error;
...
__isl_give isl_union_map *
isl_union_map_subtract(__isl_take isl_union_map *umap1,
                       __isl_take isl_union_map *umap2) {
  struct isl_bin_op_control control = {
      .subtract = 1,
...
__isl_give isl_union_set *
isl_union_set_subtract(__isl_take isl_union_set *uset1,
                       __isl_take isl_union_set *uset2) {
...
static __isl_give isl_union_map *
gen_bin_set_op(__isl_take isl_union_map *umap, __isl_take isl_set *set,
  ...
  data.set = set;
  data.res = isl_union_map_alloc(isl_space_copy(umap->dim), umap->table.n);
  if (isl_hash_table_foreach(umap->dim->ctx, &umap->table, fn, &data) < 0)
    goto error;
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_params(__isl_take isl_union_map *umap,
                               __isl_take isl_set *set) {
  int is_universe;
...
__isl_give isl_union_set *
isl_union_set_intersect_params(__isl_take isl_union_set *uset,
                               __isl_take isl_set *set) {
  return isl_union_map_intersect_params(uset, set);
}

static __isl_give isl_union_map *
union_map_intersect_params(__isl_take isl_union_map *umap,
                           __isl_take isl_union_set *uset) {
  return isl_union_map_intersect_params(umap, isl_set_from_union_set(uset));
}

static __isl_give isl_union_map *
union_map_gist_params(__isl_take isl_union_map *umap,
                      __isl_take isl_union_set *uset) {
...
static isl_stat match_bin_entry(void **entry, void *user) {
  ...
  hash = isl_space_get_hash(map->dim);
  entry2 = isl_hash_table_find(data->umap2->dim->ctx, &data->umap2->table, hash,
                               &has_space, map->dim, 0);
  if (!entry2)
    return isl_stat_error;
...
static __isl_give isl_union_map *match_bin_op(
  ...
  data.umap2 = umap2;
  data.res = isl_union_map_alloc(isl_space_copy(umap1->dim), umap1->table.n);
  if (isl_hash_table_foreach(umap1->dim->ctx, &umap1->table, &match_bin_entry,
                             &data) < 0)
    goto error;
...
__isl_give isl_union_map *
isl_union_map_intersect(__isl_take isl_union_map *umap1,
                        __isl_take isl_union_map *umap2) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_intersect(__isl_take isl_union_set *uset1,
                        __isl_take isl_union_set *uset2) {
  int p1, p2;
...
__isl_give isl_union_map *
isl_union_map_gist_params(__isl_take isl_union_map *umap,
                          __isl_take isl_set *set) {
  return gen_bin_set_op(umap, set, &gist_params_entry);
}

__isl_give isl_union_set *
isl_union_set_gist_params(__isl_take isl_union_set *uset,
                          __isl_take isl_set *set) {
  return isl_union_map_gist_params(uset, set);
}

__isl_give isl_union_map *
isl_union_map_gist(__isl_take isl_union_map *umap,
                   __isl_take isl_union_map *context) {
  return match_bin_op(umap, context, &isl_map_gist);
}

__isl_give isl_union_set *
isl_union_set_gist(__isl_take isl_union_set *uset,
 ...
 */
__isl_give isl_union_map *
isl_union_map_plain_gist(__isl_take isl_union_map *umap,
                         __isl_take isl_union_map *context) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_plain_gist(__isl_take isl_union_set *uset,
                         __isl_take isl_union_set *context) {
...
__isl_give isl_union_map *
isl_union_set_lex_lt_union_set(__isl_take isl_union_set *uset1,
                               __isl_take isl_union_set *uset2) {
  return match_bin_op(uset1, uset2, &lex_lt_set);
}

__isl_give isl_union_map *
isl_union_set_lex_le_union_set(__isl_take isl_union_set *uset1,
                               __isl_take isl_union_set *uset2) {
  return match_bin_op(uset1, uset2, &lex_le_set);
}

__isl_give isl_union_map *
isl_union_set_lex_gt_union_set(__isl_take isl_union_set *uset1,
                               __isl_take isl_union_set *uset2) {
  return isl_union_map_reverse(isl_union_set_lex_lt_union_set(uset2, uset1));
}

__isl_give isl_union_map *
isl_union_set_lex_ge_union_set(__isl_take isl_union_set *uset1,
                               __isl_take isl_union_set *uset2) {
  return isl_union_map_reverse(isl_union_set_lex_le_union_set(uset2, uset1));
}

__isl_give isl_union_map *
isl_union_map_lex_gt_union_map(__isl_take isl_union_map *umap1,
                               __isl_take isl_union_map *umap2) {
  return isl_union_map_reverse(isl_union_map_lex_lt_union_map(umap2, umap1));
}

__isl_give isl_union_map *
isl_union_map_lex_ge_union_map(__isl_take isl_union_map *umap1,
                               __isl_take isl_union_map *umap2) {
 ...
 */
static __isl_give isl_union_map *
union_map_intersect_domain(__isl_take isl_union_map *umap,
                           __isl_take isl_union_set *uset) {
  struct isl_bin_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_domain_union_set(__isl_take isl_union_map *umap,
                                         __isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_domain(__isl_take isl_union_map *umap,
                               __isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_subtract_domain(__isl_take isl_union_map *umap,
 ...
 */
__isl_give isl_union_map *
isl_union_map_subtract_range(__isl_take isl_union_map *umap,
                             __isl_take isl_union_set *dom) {
  struct isl_bin_op_control control = {
      .subtract = 1,
 ...
 */
static __isl_give isl_union_map *
union_map_gist_domain(__isl_take isl_union_map *umap,
                      __isl_take isl_union_set *uset) {
  struct isl_bin_op_control control = {
      .match_space = &isl_space_domain,
 ...
 */
__isl_give isl_union_map *
isl_union_map_gist_domain(__isl_take isl_union_map *umap,
                          __isl_take isl_union_set *uset) {
  if (isl_union_set_is_params(uset))
 ...
 */
__isl_give isl_union_map *
isl_union_map_gist_range(__isl_take isl_union_map *umap,
                         __isl_take isl_union_set *uset) {
  struct isl_bin_op_control control = {
      .match_space = &isl_space_range,
...
__isl_give isl_union_map *
isl_union_map_intersect_range_union_set(__isl_take isl_union_map *umap,
                                        __isl_take isl_union_set *uset) {
  struct isl_bin_op_control control = {
      .match_space = &isl_space_range,
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_range(__isl_take isl_union_map *umap,
                              __isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_domain_factor_range(__isl_take isl_union_map *umap,
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_range_factor_domain(__isl_take isl_union_map *umap,
                                            __isl_take isl_union_map *factor) {
  struct isl_bin_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_range_factor_range(__isl_take isl_union_map *umap,
                                           __isl_take isl_union_map *factor) {
  struct isl_bin_op_control control = {
      .filter = &isl_map_range_is_wrapping,
...
static isl_stat apply_range_entry(void **entry, void *user) {
  ...
  match = isl_map_tuple_is_equal(data->map, isl_dim_out, map2, isl_dim_in);
  if (match < 0)
    return isl_stat_error;
  if (!match)
    return isl_stat_ok;
...
static __isl_give isl_union_map *
bin_op(__isl_take isl_union_map *umap1, __isl_take isl_union_map *umap2,
       isl_stat (*fn)(void **entry, void *user)) {
  ...
  data.umap2 = umap2;
  data.res = isl_union_map_alloc(isl_space_copy(umap1->dim), umap1->table.n);
  if (isl_hash_table_foreach(umap1->dim->ctx, &umap1->table, &bin_entry,
                             &data) < 0)
    goto error;
...
__isl_give isl_union_map *
isl_union_map_apply_range(__isl_take isl_union_map *umap1,
                          __isl_take isl_union_map *umap2) {
  return bin_op(umap1, umap2, &apply_range_entry);
}

__isl_give isl_union_map *
isl_union_map_apply_domain(__isl_take isl_union_map *umap1,
                           __isl_take isl_union_map *umap2) {
...
static isl_stat map_lex_lt_entry(void **entry, void *user) {
  ...
  match = isl_map_tuple_is_equal(data->map, isl_dim_out, map2, isl_dim_out);
  if (match < 0)
    return isl_stat_error;
  if (!match)
    return isl_stat_ok;
...
__isl_give isl_union_map *
isl_union_map_lex_lt_union_map(__isl_take isl_union_map *umap1,
                               __isl_take isl_union_map *umap2) {
...
__isl_give isl_union_map *
isl_union_map_lex_le_union_map(__isl_take isl_union_map *umap1,
                               __isl_take isl_union_map *umap2) {
...
__isl_give isl_union_map *
isl_union_map_product(__isl_take isl_union_map *umap1,
                      __isl_take isl_union_map *umap2) {
...
__isl_give isl_union_set *
isl_union_set_product(__isl_take isl_union_set *uset1,
                      __isl_take isl_union_set *uset2) {
...
static isl_stat domain_product_entry(void **entry, void *user) {
  ...
  map2 = isl_map_domain_product(isl_map_copy(data->map), isl_map_copy(map2));
 ...
 */
__isl_give isl_union_map *
isl_union_map_domain_product(__isl_take isl_union_map *umap1,
                             __isl_take isl_union_map *umap2) {
...
static isl_stat range_product_entry(void **entry, void *user) {
  ...
  map2 = isl_map_range_product(isl_map_copy(data->map), isl_map_copy(map2));
...
__isl_give isl_union_map *
isl_union_map_range_product(__isl_take isl_union_map *umap1,
                            __isl_take isl_union_map *umap2) {
...
static isl_stat flat_domain_product_entry(void **entry, void *user) {
  ...
  map2 =
      isl_map_flat_domain_product(isl_map_copy(data->map), isl_map_copy(map2));
 ...
 */
__isl_give isl_union_map *
isl_union_map_flat_domain_product(__isl_take isl_union_map *umap1,
                                  __isl_take isl_union_map *umap2) {
...
static isl_stat flat_range_product_entry(void **entry, void *user) {
  ...
  map2 =
      isl_map_flat_range_product(isl_map_copy(data->map), isl_map_copy(map2));
...
__isl_give isl_union_map *
isl_union_map_flat_range_product(__isl_take isl_union_map *umap1,
                                 __isl_take isl_union_map *umap2) {
...
__isl_give isl_union_map *
isl_union_map_from_range(__isl_take isl_union_set *uset) {
  struct isl_un_op_control control = {
...
__isl_give isl_union_map *
isl_union_map_from_domain(__isl_take isl_union_set *uset) {
  return isl_union_map_reverse(isl_union_map_from_range(uset));
}

__isl_give isl_union_map *
isl_union_map_from_domain_and_range(__isl_take isl_union_set *domain,
 ...
 */
static __isl_give isl_union_map *
total(__isl_take isl_union_map *umap,
...
__isl_give isl_union_map *
isl_union_map_affine_hull(__isl_take isl_union_map *umap) {
  return total(umap, &isl_map_affine_hull_map);
}

__isl_give isl_union_set *
isl_union_set_affine_hull(__isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_combined_lineality_space(__isl_take isl_union_set *uset) {
  struct isl_un_op_control control = {
...
isl_map_polyhedral_hull_map(__isl_take isl_map *map) {
  return isl_map_from_basic_map(isl_map_polyhedral_hull(map));
}

__isl_give isl_union_map *
isl_union_map_polyhedral_hull(__isl_take isl_union_map *umap) {
  return total(umap, &isl_map_polyhedral_hull_map);
}

__isl_give isl_union_set *
isl_union_set_polyhedral_hull(__isl_take isl_union_set *uset) {
...
__isl_give isl_union_map *
isl_union_map_simple_hull(__isl_take isl_union_map *umap) {
  return total(umap, &isl_map_simple_hull_map);
}

__isl_give isl_union_set *
isl_union_set_simple_hull(__isl_take isl_union_set *uset) {
  return isl_union_map_simple_hull(uset);
}

static __isl_give isl_union_map *
inplace(__isl_take isl_union_map *umap,
        __isl_give isl_map *(*fn)(__isl_take isl_map *)) {
  struct isl_un_op_control control = {
      .inplace = 1,
      .fn_map = fn,
 ...
 */
__isl_give isl_union_map *
isl_union_map_remove_redundancies(__isl_take isl_union_map *umap) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_remove_redundancies(__isl_take isl_union_set *uset) {
  return isl_union_map_remove_redundancies(uset);
}

__isl_give isl_union_map *
isl_union_map_coalesce(__isl_take isl_union_map *umap) {
  return inplace(umap, &isl_map_coalesce);
}

__isl_give isl_union_set *
isl_union_set_coalesce(__isl_take isl_union_set *uset) {
  return isl_union_map_coalesce(uset);
}

__isl_give isl_union_map *
isl_union_map_detect_equalities(__isl_take isl_union_map *umap) {
  return inplace(umap, &isl_map_detect_equalities);
}

__isl_give isl_union_set *
isl_union_set_detect_equalities(__isl_take isl_union_set *uset) {
  return isl_union_map_detect_equalities(uset);
}

__isl_give isl_union_map *
isl_union_map_compute_divs(__isl_take isl_union_map *umap) {
  return inplace(umap, &isl_map_compute_divs);
}

__isl_give isl_union_set *
isl_union_set_compute_divs(__isl_take isl_union_set *uset) {
...
__isl_give isl_union_map *
isl_union_map_universe(__isl_take isl_union_map *umap) {
  struct isl_un_op_control control = {
      .fn_map = &universe,
  };
  return un_op(umap, &control);
...
__isl_give isl_union_set *
isl_union_set_universe(__isl_take isl_union_set *uset) {
  return isl_union_map_universe(uset);
}

__isl_give isl_union_map *
isl_union_map_reverse(__isl_take isl_union_map *umap) {
  struct isl_un_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_map_range_reverse(__isl_take isl_union_map *umap) {
...
__isl_give isl_union_map *
isl_union_map_domain_map(__isl_take isl_union_map *umap) {
  struct isl_un_op_control control = {
...
isl_union_map_domain_map_union_pw_multi_aff(__isl_take isl_union_map *umap) {
...
__isl_give isl_union_map *
isl_union_map_range_map(__isl_take isl_union_map *umap) {
  struct isl_un_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_set_wrapped_domain_map(__isl_take isl_union_set *uset) {
...
__isl_give isl_union_map *
isl_union_map_deltas_map(__isl_take isl_union_map *umap) {
  struct isl_un_op_control control = {
      .filter = &equal_tuples,
...
__isl_give isl_union_map *
isl_union_set_identity(__isl_take isl_union_set *uset) {
  struct isl_un_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_map_domain_factor_domain(__isl_take isl_union_map *umap) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_domain_factor_range(__isl_take isl_union_map *umap) {
  struct isl_un_op_drop_user_data data = {&isl_map_domain_is_wrapping};
  struct isl_un_op_control control = {
      .filter = &un_op_filter_drop_user,
      .filter_user = &data,
 ...
 */
__isl_give isl_union_map *
isl_union_map_range_factor_domain(__isl_take isl_union_map *umap) {
  struct isl_un_op_drop_user_data data = {&isl_map_range_is_wrapping};
  struct isl_un_op_control control = {
      .filter = &un_op_filter_drop_user,
      .filter_user = &data,
 ...
 */
__isl_give isl_union_map *
isl_union_map_range_factor_range(__isl_take isl_union_map *umap) {
  struct isl_un_op_drop_user_data data = {&isl_map_range_is_wrapping};
  struct isl_un_op_control control = {
      .filter = &un_op_filter_drop_user,
      .filter_user = &data,
 ...
 */
__isl_give isl_union_map *
isl_union_map_factor_domain(__isl_take isl_union_map *umap) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_factor_range(__isl_take isl_union_map *umap) {
  struct isl_un_op_drop_user_data data = {&isl_map_is_product};
  struct isl_un_op_control control = {
      .filter = &un_op_filter_drop_user,
      .filter_user = &data,
...
isl_bool isl_union_map_is_subset(__isl_keep isl_union_map *umap1,
  ...
  data.umap2 = umap2;
  if (isl_hash_table_foreach(umap1->dim->ctx, &umap1->table, &is_subset_entry,
                             &data) < 0 &&
      data.is_subset)
    goto error;
...
isl_bool isl_union_map_is_disjoint(__isl_keep isl_union_map *umap1,
  ...
  data.umap2 = umap2;
  if (isl_hash_table_foreach(umap1->dim->ctx, &umap1->table, &is_disjoint_entry,
                             &data) < 0 &&
      data.is_disjoint)
    goto error;
...
__isl_give isl_basic_map *isl_union_map_sample(__isl_take isl_union_map *umap) {
  ...
  if (isl_hash_table_foreach(umap->dim->ctx, &umap->table, &sample_entry,
                             &sample) < 0 &&
      !sample)
    goto error;
...
isl_union_set_sample_point(__isl_take isl_union_set *uset) {
...
static isl_bool union_map_forall(__isl_keep isl_union_map *umap,
  ...
  if (isl_hash_table_foreach(umap->dim->ctx, &umap->table, &forall_entry,
                             &data) < 0 &&
      data.res)
    return isl_bool_error;
...
static isl_bool union_map_forall_user(__isl_keep isl_union_map *umap,
  ...
  if (isl_hash_table_foreach(umap->dim->ctx, &umap->table, &forall_user_entry,
                             &data) < 0 &&
      data.res)
    return isl_bool_error;
...
static isl_stat single_valued_on_domain(__isl_take isl_set *set, void *user) {
  ...
  umap = isl_union_map_intersect_domain(umap, isl_union_set_from_set(set));
...
isl_bool isl_union_map_is_single_valued(__isl_keep isl_union_map *umap) {
  ...
  data.umap = umap;
  if (isl_union_set_foreach_set(domain, &single_valued_on_domain, &data) < 0 &&
      data.sv)
    data.sv = isl_bool_error;
 ...
 */
static isl_bool
isl_union_map_plain_is_not_identity(__isl_keep isl_union_map *umap) {
...
static int separates(struct isl_fixed_map *v, int n,
  ...
  for (i = 0; i + 1 < n; ++i) {
    ...
    for (k = i; k < j; ++k)
      part = isl_union_map_add_map(part, isl_map_copy(v[k].map));
...
static isl_bool plain_injective_on_range_wrap(__isl_keep isl_set *ran,
  ...
  umap = isl_union_map_copy(umap);
  umap = isl_union_map_intersect_range(
      umap, isl_union_set_from_set(isl_set_copy(ran)));
 ...
 */
__isl_give isl_union_map *
isl_union_map_uncurry(__isl_take isl_union_map *umap) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_range_curry(__isl_take isl_union_map *umap) {
...
__isl_give isl_union_set *
isl_union_set_coefficients(__isl_take isl_union_set *uset) {
  isl_ctx *ctx;
  isl_space *space;
  isl_union_set *res;
  ...
  if (isl_hash_table_foreach(uset->dim->ctx, &uset->table, &coefficients_entry,
                             &res) < 0)
    goto error;
...
__isl_give isl_union_set *
isl_union_set_solutions(__isl_take isl_union_set *uset) {
  ...
  if (isl_hash_table_foreach(uset->dim->ctx, &uset->table, &solutions_entry,
                             &res) < 0)
    goto error;
...
static __isl_give isl_union_map *preimage_pw_multi_aff(
  ...
  umap = isl_union_map_align_params(umap, isl_pw_multi_aff_get_space(pma));
  ...
  data.match = match;
  data.fn = fn;
  if (isl_hash_table_foreach(ctx, &umap->table, &preimage_entry, &data) < 0)
    data.res = isl_union_map_free(data.res);
 ...
 */
__isl_give isl_union_map *
isl_union_map_preimage_domain_pw_multi_aff(__isl_take isl_union_map *umap,
                                           __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_preimage_range_pw_multi_aff(__isl_take isl_union_map *umap,
                                          __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_preimage_pw_multi_aff(__isl_take isl_union_set *uset,
                                    __isl_take isl_pw_multi_aff *pma) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_preimage_domain_multi_aff(__isl_take isl_union_map *umap,
                                        __isl_take isl_multi_aff *ma) {
  return isl_union_map_preimage_domain_pw_multi_aff(
      umap, isl_pw_multi_aff_from_multi_aff(ma));
}
 ...
 */
__isl_give isl_union_map *
isl_union_map_preimage_range_multi_aff(__isl_take isl_union_map *umap,
                                       __isl_take isl_multi_aff *ma) {
  return isl_union_map_preimage_range_pw_multi_aff(
      umap, isl_pw_multi_aff_from_multi_aff(ma));
}
 ...
 */
__isl_give isl_union_map *
isl_union_set_preimage_multi_aff(__isl_take isl_union_set *uset,
                                 __isl_take isl_multi_aff *ma) {
  return isl_union_set_preimage_pw_multi_aff(
...
static __isl_give isl_union_map *preimage_multi_pw_aff(
  ...
  umap = isl_union_map_align_params(umap, isl_multi_pw_aff_get_space(mpa));
  ...
  data.match = match;
  data.fn = fn;
  if (isl_hash_table_foreach(ctx, &umap->table, &preimage_mpa_entry, &data) < 0)
    data.res = isl_union_map_free(data.res);
 ...
 */
__isl_give isl_union_map *
isl_union_map_preimage_domain_multi_pw_aff(__isl_take isl_union_map *umap,
                                           __isl_take isl_multi_pw_aff *mpa) {
...
static __isl_give isl_union_map *preimage_union_pw_multi_aff(
    __isl_take isl_union_map *umap, __isl_take isl_union_pw_multi_aff *upma,
    __isl_give isl_union_map *(*fn)(__isl_take isl_union_map *umap,
                                    __isl_take isl_pw_multi_aff *pma)) {
  ...
  data.fn = fn;
  if (isl_union_pw_multi_aff_foreach_pw_multi_aff(upma, &preimage_upma, &data) <
      0)
    data.res = isl_union_map_free(data.res);
...
__isl_give isl_union_map *isl_union_map_preimage_domain_union_pw_multi_aff(
    __isl_take isl_union_map *umap, __isl_take isl_union_pw_multi_aff *upma) {
  return preimage_union_pw_multi_aff(
      umap, upma, &isl_union_map_preimage_domain_pw_multi_aff);
}
...
__isl_give isl_union_map *isl_union_map_preimage_range_union_pw_multi_aff(
    __isl_take isl_union_map *umap, __isl_take isl_union_pw_multi_aff *upma) {
  return preimage_union_pw_multi_aff(
      umap, upma, &isl_union_map_preimage_range_pw_multi_aff);
}
...
__isl_give isl_union_set *isl_union_set_preimage_union_pw_multi_aff(
    __isl_take isl_union_set *uset, __isl_take isl_union_pw_multi_aff *upma) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_reset_user(__isl_take isl_union_map *umap) {
  umap = isl_union_map_cow(umap);
  if (!umap)
    return NULL;
 ...
 */
__isl_give isl_union_set *
isl_union_set_reset_user(__isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_remove_divs(__isl_take isl_union_map *umap) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_remove_divs(__isl_take isl_union_set *uset) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_project_out(__isl_take isl_union_map *umap,
  ...
  if (type != isl_dim_param)
    isl_die(isl_union_map_get_ctx(umap), isl_error_invalid,
            "can only project out parameters", return isl_union_map_free(umap));
 ...
 */
__isl_give isl_union_set *
isl_union_set_project_out(__isl_take isl_union_set *uset,
                          enum isl_dim_type type, unsigned first, unsigned n) {
 ...
 */
__isl_give isl_union_set *
isl_union_set_project_out_all_params(__isl_take isl_union_set *uset) {
...
static isl_bool map_excludes(__isl_keep isl_map *map, void *user) {
  ...
  involves = isl_map_involves_dims(map, isl_dim_param, data->first, data->n);
 ...
 */
__isl_give isl_union_map *
isl_union_map_reset_range_space(__isl_take isl_union_map *umap,
                                __isl_take isl_space *space) {
 ...
 */
__isl_give isl_union_map *
isl_union_map_reset_equal_dim_space(__isl_take isl_union_map *umap,
                                    __isl_take isl_space *space) {
 ...
 */
static __isl_give isl_union_map *
intersect_explicit_domain(__isl_take isl_union_map *umap,
...
static __isl_give isl_union_map *isl_union_map_order_at_multi_union_pw_aff(
  ...
  umap =
      isl_union_map_align_params(umap, isl_multi_union_pw_aff_get_space(mupa));
  mupa =
      isl_multi_union_pw_aff_align_params(mupa, isl_union_map_get_space(umap));
...
__isl_give isl_union_map *isl_union_map_lex_lt_at_multi_union_pw_aff(
    __isl_take isl_union_map *umap, __isl_take isl_multi_union_pw_aff *mupa) {
  return isl_union_map_order_at_multi_union_pw_aff(
      umap, mupa, &isl_multi_pw_aff_lex_lt_map);
}
...
__isl_give isl_union_map *isl_union_map_lex_gt_at_multi_union_pw_aff(
    __isl_take isl_union_map *umap, __isl_take isl_multi_union_pw_aff *mupa) {
  return isl_union_map_order_at_multi_union_pw_aff(
      umap, mupa, &isl_multi_pw_aff_lex_gt_map);
}

/* Return the union of the elements in the list "list".
 */
__isl_give isl_union_set *
isl_union_set_list_union(__isl_take isl_union_set_list *list) {
  int i;
  isl_size n;
  isl_ctx *ctx;
  isl_space *space;
...
isl_union_set_get_basic_set_list(__isl_keep isl_union_set *uset) {
  int n;
  isl_ctx *ctx;
 ...
 */
static __isl_give isl_map *map_id(__isl_take isl_map *map) { return map; }
 ...
 */
__isl_give isl_union_map *
isl_union_map_remove_map_if(__isl_take isl_union_map *umap,
                            isl_bool (*fn)(__isl_keep isl_map *map, void *user),
                            void *user) {
 ...
 */
__isl_give isl_union_set *
isl_union_map_bind_range(__isl_take isl_union_map *umap,
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_domain_space(__isl_take isl_union_map *umap,
                                     __isl_take isl_space *space) {
  struct isl_un_op_control control = {
 ...
 */
__isl_give isl_union_map *
isl_union_map_intersect_range_space(__isl_take isl_union_map *umap,
                                    __isl_take isl_space *space) {
  struct isl_un_op_control control = {
      .filter = &has_range_space_tuples,
      .filter_user = space,
