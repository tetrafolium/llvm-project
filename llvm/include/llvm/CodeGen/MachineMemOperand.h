...
public:
    ...
    const Value *getValue() const {
        return PtrInfo.V.dyn_cast<const Value*>();
    }
    ...
    const void *getOpaqueValue() const {
        return PtrInfo.V.getOpaqueValue();
    }
    ...
    int64_t getOffset() const {
        return PtrInfo.Offset;
    }

    unsigned getAddrSpace() const {
        return PtrInfo.getAddrSpace();
    }
    ...
    bool isVolatile() const {
        return FlagVals & MOVolatile;
    }
    bool isNonTemporal() const {
        return FlagVals & MONonTemporal;
    }
    bool isDereferenceable() const {
        return FlagVals & MODereferenceable;
    }
    bool isInvariant() const {
        return FlagVals & MOInvariant;
    }
