...
CAMLprim LLVMAttributeRef llvm_create_enum_attr_by_kind(LLVMContextRef C,
                                                        value Kind,
                                                        value Value) {
...
CAMLprim LLVMAttributeRef llvm_create_string_attr(LLVMContextRef C, value Kind,
                                                  value Value) {
...
/* llcontext -> llvalue */
CAMLprim LLVMValueRef llvm_mdnull(LLVMContextRef C) { return NULL; }
...
/* bool -> llvalue -> unit */
CAMLprim value llvm_set_unnamed_addr(value UseUnnamedAddr,
                                     LLVMValueRef Global) {
...
/* llvalue -> int -> llvalue -> unit */
CAMLprim value llvm_set_successor(LLVMValueRef U, value I,
                                  LLVMBasicBlockRef B) {
...
CAMLprim LLVMValueRef llvm_build_empty_phi(LLVMTypeRef Type, value Name,
                                           value B) {
...
/* llvalue -> string -> llbuilder -> llvalue */
CAMLprim LLVMValueRef llvm_build_freeze(LLVMValueRef X, value Name, value B) {
