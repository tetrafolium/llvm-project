...
inline void atomic_thread_fence(memory_order) { _mm_mfence(); }
...
inline u32 atomic_fetch_add(volatile atomic_uint32_t *a, u32 v,
                            memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
...
inline u32 atomic_fetch_sub(volatile atomic_uint32_t *a, u32 v,
                            memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
  return (u32)_InterlockedExchangeAdd((volatile long *)&a->val_dont_use,
...
inline uptr atomic_fetch_sub(volatile atomic_uintptr_t *a, uptr v,
                             memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
#ifdef _WIN64
...
inline u8 atomic_exchange(volatile atomic_uint8_t *a, u8 v, memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
  return (u8)_InterlockedExchange8((volatile char *)&a->val_dont_use, v);
}

inline u16 atomic_exchange(volatile atomic_uint16_t *a, u16 v,
                           memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
...
inline u32 atomic_exchange(volatile atomic_uint32_t *a, u32 v,
                           memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
...
inline bool atomic_compare_exchange_strong(volatile atomic_uint8_t *a, u8 *cmp,
                                           u8 xchgv, memory_order mo) {
  (void)mo;
  DCHECK(!((uptr)a % sizeof(*a)));
  u8 cmpv = *cmp;
#ifdef _WIN64
  u8 prev = (u8)_InterlockedCompareExchange8((volatile char *)&a->val_dont_use,
...
inline bool atomic_compare_exchange_strong(volatile atomic_uint32_t *a,
                                           ...
                                           memory_order mo) {
  u32 cmpv = *cmp;
  u32 prev = (u32)_InterlockedCompareExchange((volatile long *)&a->val_dont_use,
                                              (long)xchg, (long)cmpv);
  if (prev == cmpv)
    return true;
  *cmp = prev;
