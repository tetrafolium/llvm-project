...
public:
    ...
    bool hasCalculatedStackSizeSVE() const {
        return HasCalculatedStackSizeSVE;
    }
    ...
    int getMinSVECSFrameIndex() const {
        return MinSVECSFrameIndex;
    }
    int getMaxSVECSFrameIndex() const {
        return MaxSVECSFrameIndex;
    }
    ...
    int getVarArgsStackIndex() const {
        return VarArgsStackIndex;
    }
    void setVarArgsStackIndex(int Index) {
        VarArgsStackIndex = Index;
    }

    int getVarArgsGPRIndex() const {
        return VarArgsGPRIndex;
    }
    void setVarArgsGPRIndex(int Index) {
        VarArgsGPRIndex = Index;
    }

    unsigned getVarArgsGPRSize() const {
        return VarArgsGPRSize;
    }
    ...
    bool branchTargetEnforcement() const {
        return BranchTargetEnforcement;
    }
