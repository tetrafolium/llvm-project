...
public:
    ...
    void set_keyword(parser::CharBlock x) {
        keyword_ = x;
    }
    bool isAlternateReturn() const {
        return isAlternateReturn_;
    }
    void set_isAlternateReturn() {
        isAlternateReturn_ = true;
    }
    bool isPassedObject() const {
        return isPassedObject_;
    }
    void set_isPassedObject(bool yes = true) {
        isPassedObject_ = yes;
    }
