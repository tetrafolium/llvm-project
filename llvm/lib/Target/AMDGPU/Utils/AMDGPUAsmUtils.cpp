...
// This must be in sync with llvm::AMDGPU::SendMsg::Id enum members, see
// SIDefines.h.
const char *const IdSymbolic[] = {nullptr,
                                  "MSG_INTERRUPT",
                                  "MSG_GS",
                                  "MSG_GS_DONE",
                                  nullptr,
...
// These two must be in sync with llvm::AMDGPU::SendMsg::Op enum members, see
// SIDefines.h.
const char *const OpSysSymbolic[] = {
    nullptr, "SYSMSG_OP_ECC_ERR_INTERRUPT", "SYSMSG_OP_REG_RD",
    "SYSMSG_OP_HOST_TRAP_ACK", "SYSMSG_OP_TTRACE_PC"};

const char *const OpGsSymbolic[] = {"GS_OP_NOP", "GS_OP_CUT", "GS_OP_EMIT",
                                    "GS_OP_EMIT_CUT"};
...
// This must be in sync with llvm::AMDGPU::Hwreg::ID_SYMBOLIC_FIRST_/LAST_, see
// SIDefines.h.
const char *const IdSymbolic[] = {nullptr,
                                  "HW_REG_MODE",
                                  "HW_REG_STATUS",
...
StringLiteral const NfmtSymbolicGFX10[] = {"BUF_NUM_FORMAT_UNORM",
...
StringLiteral const UfmtSymbolic[] = {"BUF_FMT_INVALID",
...
// This must be in sync with llvm::AMDGPU::Swizzle::Id enum members, see
// SIDefines.h.
const char *const IdSymbolic[] = {
    "QUAD_PERM", "BITMASK_PERM", "SWAP", "REVERSE", "BROADCAST",
};
...
// This must be in sync with llvm::AMDGPU::VGPRIndexMode::Id enum members, see
// SIDefines.h.
const char *const IdSymbolic[] = {
    "SRC0",
    "SRC1",
