...
constexpr auto label {
    space >> digitString64 / spaceCheck
};
...
constexpr auto stmtErrorRecoveryStart {
    ignoredStatementPrefix
};
constexpr auto skipBadLine {
    SkipPast<'\n'> {} >> construct<ErrorRecovery>()
};
...
constexpr auto missingOptionalName {
    pure<std::optional<Name>>()
};
constexpr auto noNameEnd {
...
constexpr auto bareEnd {
    noNameEnd / recovery(atEndOfStmt, SkipTo<'\n'> {})
};
