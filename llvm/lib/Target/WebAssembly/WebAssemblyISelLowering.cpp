...
WebAssemblyTargetLowering::WebAssemblyTargetLowering(
    ...
    for (auto T : {
                MVT::f32, MVT::f64, MVT::v4f32, MVT::v2f64
            }) {
        // Don't expand the floating-point types to constant pools.
        setOperationAction(ISD::ConstantFP, T, Legal);
        // Expand floating-point comparisons.
        for (auto CC : {
                    ISD::SETO, ISD::SETUO, ISD::SETUEQ, ISD::SETONE,
    ...
    if (Subtarget->hasSIMD128()) {
        ...
        for (auto Op : {
                    ISD::CTLZ, ISD::CTTZ, ISD::CTPOP, ISD::SDIV, ISD::UDIV,
        ...
        for (auto Op : {
                    ISD::FCEIL, ISD::FFLOOR, ISD::FTRUNC, ISD::FNEARBYINT,
    ...
    for (auto T : {
                MVT::i32, MVT::i64, MVT::f32, MVT::f64
            })
        for (auto Op : {
    ...
    if (Subtarget->hasSIMD128()) {
        for (auto T : {
                    MVT::v16i8, MVT::v8i16, MVT::v4i32, MVT::v2i64, MVT::v4f32,
                    MVT::v2f64
                }) {
