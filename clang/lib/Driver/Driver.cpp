...
class OffloadingActionBuilder final {
    ...
    public:
        ...
        virtual Action* appendLinkHostActions(ActionList &AL) {
            return nullptr;
        }
        ...
        virtual bool canUseBundlerUnbundler() const {
            return false;
        }
    ...
    protected:
        ...
        struct TargetID {
            ...
            const char *ID;
            TargetID(CudaArch Arch) {
                ID = CudaArchToString(Arch);
            }
