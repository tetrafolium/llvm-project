...
public:
    ...
    void setParsedNoDeref(bool parsed) {
        parsedNoDeref = parsed;
    }

    bool didParseNoDeref() const {
    ...
    if (Deduced) {
        ...
        case DeclaratorContext::Member: {
            ...
            if (isa<ObjCContainerDecl>(SemaRef.CurContext)) {
                ...
                case TTK_Struct:
                    Error = Cxx ? 1 : 2; /* Struct member */ break;
                case TTK_Union:
                    Error = Cxx ? 3 : 4; /* Union member */ break;
                case TTK_Class:
                    Error = 5; /* Class member */ break;
                case TTK_Interface:
                    Error = 6; /* Interface member */ break;
                }
            }
