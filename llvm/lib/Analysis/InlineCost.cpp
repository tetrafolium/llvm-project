...
protected:
    ...
    /// the reason it can't.
    virtual InlineResult finalizeAnalysis() {
    ...
    /// continue.
    virtual InlineResult onAnalysisStart() {
        return InlineResult::success();
    }
...
class InlineCostCallAnalyzer final : public CallAnalyzer {
    ...
    void onBlockStart(const BasicBlock *BB) override {
        CostAtBBStart = Cost;
    }
