...
public:
    ...
    public:
        ...
        bool isClobber() const {
            return getEntryKind() == Clobber;
        }
        bool isDbgValue() const {
            return getEntryKind() == DbgValue;
        }
        bool isClosed() const {
            return EndIndex != NoEntry;
        }
