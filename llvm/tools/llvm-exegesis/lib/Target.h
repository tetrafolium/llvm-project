...
public:
    ...
    virtual unsigned getScratchMemoryRegister(const Triple &) const {
        return 0;
    }
    ...
    virtual unsigned getLoopCounterRegister(const Triple &) const {
        return 0;
    }
    ...
    // for use in snippets.
    virtual ArrayRef<unsigned> getUnavailableRegisters() const {
        return {};
    }
    ...
    virtual unsigned getMaxMemoryAccessSize() const {
        return 0;
    }
    ...
    // benchmark.
    virtual Error checkFeatureSupport() const {
