...
static const uint64_t NSDictionaryCapacities[] = {
    0,        3,         7,         13,        23,       41,       71,
    127,      191,       251,       383,       631,      1087,     1723,
    2803,     4523,      7351,      11959,     19447,    31231,    50683,
    81919,    132607,    214519,    346607,    561109,   907759,   1468927,
    2376191,  3845119,   6221311,   10066421,  16287743, 26354171, 42641881,
    68996069, 111638519, 180634607, 292272623, 472907251};
...
uint64_t __NSDictionaryMSize_Impl(lldb_private::Process &process,
...
uint64_t __NSDictionaryMSize(lldb_private::Process &process,
                             lldb::addr_t valobj_addr, Status &error) {
...
lldb_private::formatters::GenericNSDictionaryMSyntheticFrontEnd<
    D32, D64>::~GenericNSDictionaryMSyntheticFrontEnd<D32, D64>() {
  delete m_data_32;
  m_data_32 = nullptr;
  delete m_data_64;
  m_data_64 = nullptr;
...
size_t lldb_private::formatters::Foundation1100::
...
bool lldb_private::formatters::Foundation1100::NSDictionaryMSyntheticFrontEnd::
    Update() {
  m_children.clear();
  ValueObjectSP valobj_sp = m_backend.GetSP();
  m_ptr_size = 0;
