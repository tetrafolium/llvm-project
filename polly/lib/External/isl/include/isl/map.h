...
__isl_give isl_basic_map *
isl_basic_map_remove_redundancies(__isl_take isl_basic_map *bmap);
__isl_give isl_map *isl_map_remove_redundancies(__isl_take isl_map *map);
__isl_give isl_basic_map *isl_map_simple_hull(__isl_take isl_map *map);
__isl_export __isl_give isl_basic_map *
isl_map_unshifted_simple_hull(__isl_take isl_map *map);
__isl_give isl_basic_map *
isl_map_plain_unshifted_simple_hull(__isl_take isl_map *map);
__isl_give isl_basic_map *
isl_map_unshifted_simple_hull_from_map_list(__isl_take isl_map *map,
...
__isl_export __isl_give isl_map *
isl_basic_map_union(__isl_take isl_basic_map *bmap1,
                    __isl_take isl_basic_map *bmap2);
__isl_export __isl_give isl_basic_map *
...
isl_basic_map_apply_range(__isl_take isl_basic_map *bmap1,
                          __isl_take isl_basic_map *bmap2);
__isl_export __isl_give isl_basic_map *
isl_basic_map_affine_hull(__isl_take isl_basic_map *bmap);
__isl_give isl_basic_map *
...
__isl_export __isl_give isl_basic_map *
isl_basic_map_sample(__isl_take isl_basic_map *bmap);
__isl_export __isl_give isl_basic_map *
isl_basic_map_detect_equalities(__isl_take isl_basic_map *bmap);
__isl_give isl_basic_map *isl_basic_map_read_from_file(isl_ctx *ctx,
                                                       FILE *input);
__isl_constructor __isl_give isl_basic_map *
isl_basic_map_read_from_str(isl_ctx *ctx, const char *str);
...
isl_printer_print_basic_map(__isl_take isl_printer *printer,
...
isl_basic_map_upper_bound_si(__isl_take isl_basic_map *bmap,
                             enum isl_dim_type type, unsigned pos, int value);
__isl_overload __isl_give isl_map *
...
__isl_give isl_map *isl_map_partial_lexmin(__isl_take isl_map *map,
                                           ...
                                           __isl_give isl_set **empty);
__isl_export __isl_give isl_map *
isl_basic_map_lexmin(__isl_take isl_basic_map *bmap);
__isl_export __isl_give isl_map *
isl_basic_map_lexmax(__isl_take isl_basic_map *bmap);
...
isl_basic_map_partial_lexmin_pw_multi_aff(__isl_take isl_basic_map *bmap,
                                          __isl_take isl_basic_set *dom,
                                          __isl_give isl_set **empty);
__isl_give isl_pw_multi_aff *
isl_basic_map_partial_lexmax_pw_multi_aff(__isl_take isl_basic_map *bmap,
                                          __isl_take isl_basic_set *dom,
                                          __isl_give isl_set **empty);
__isl_give isl_pw_multi_aff *
isl_basic_map_lexmin_pw_multi_aff(__isl_take isl_basic_map *bmap);
__isl_export __isl_give isl_pw_multi_aff *
isl_map_lexmin_pw_multi_aff(__isl_take isl_map *map);
__isl_export __isl_give isl_pw_multi_aff *
isl_map_lexmax_pw_multi_aff(__isl_take isl_map *map);
__isl_export __isl_give isl_multi_pw_aff *
isl_map_min_multi_pw_aff(__isl_take isl_map *map);
__isl_export __isl_give isl_multi_pw_aff *
isl_map_max_multi_pw_aff(__isl_take isl_map *map);
...
__isl_give isl_map *isl_map_union_disjoint(__isl_take isl_map *map1,
                                           __isl_take isl_map *map2);
__isl_export __isl_give isl_map *
isl_map_intersect_domain(__isl_take isl_map *map, __isl_take isl_set *set);
__isl_export __isl_give isl_map *
isl_map_intersect_range(__isl_take isl_map *map, __isl_take isl_set *set);
__isl_give isl_map *
...
isl_basic_map_range_product(__isl_take isl_basic_map *bmap1,
                            __isl_take isl_basic_map *bmap2);
__isl_export __isl_give isl_map *
isl_map_domain_product(__isl_take isl_map *map1, __isl_take isl_map *map2);
__isl_export __isl_give isl_map *
isl_map_range_product(__isl_take isl_map *map1, __isl_take isl_map *map2);
__isl_give isl_basic_map *
...
__isl_export __isl_give isl_map *
isl_map_domain_factor_domain(__isl_take isl_map *map);
__isl_export __isl_give isl_map *
isl_map_domain_factor_range(__isl_take isl_map *map);
__isl_export __isl_give isl_map *
isl_map_range_factor_domain(__isl_take isl_map *map);
__isl_export __isl_give isl_map *
isl_map_range_factor_range(__isl_take isl_map *map);
__isl_export __isl_give isl_map *isl_map_intersect(__isl_take isl_map *map1,
                                                   __isl_take isl_map *map2);
__isl_export __isl_give isl_map *
isl_map_intersect_params(__isl_take isl_map *map, __isl_take isl_set *params);
...
isl_basic_map_deltas(__isl_take isl_basic_map *bmap);
...
__isl_export __isl_give isl_map *
isl_map_detect_equalities(__isl_take isl_map *map);
__isl_export __isl_give isl_basic_map *
isl_map_affine_hull(__isl_take isl_map *map);
__isl_give isl_basic_map *isl_map_convex_hull(__isl_take isl_map *map);
__isl_export __isl_give isl_basic_map *
isl_map_polyhedral_hull(__isl_take isl_map *map);
...
__isl_give isl_basic_map *isl_basic_map_move_dims(
    __isl_take isl_basic_map *bmap, enum isl_dim_type dst_type,
...
__isl_give isl_map *isl_map_project_out(__isl_take isl_map *map,
                                        ...
                                        unsigned n);
__isl_export __isl_give isl_map *
isl_map_project_out_all_params(__isl_take isl_map *map);
__isl_give isl_basic_map *
...
__isl_export __isl_give isl_map *
isl_map_flatten_domain(__isl_take isl_map *map);
...
__isl_export __isl_give isl_map *
isl_set_insert_domain(__isl_take isl_set *set, __isl_take isl_space *domain);
__isl_give isl_map *isl_map_domain_map(__isl_take isl_map *map);
__isl_give isl_map *isl_map_range_map(__isl_take isl_map *map);
__isl_give isl_map *isl_set_wrapped_domain_map(__isl_take isl_set *set);
__isl_constructor __isl_give isl_map *
isl_map_from_basic_map(__isl_take isl_basic_map *bmap);
...
isl_map_bind_domain(__isl_take isl_map *map, __isl_take isl_multi_id *tuple);
__isl_export __isl_give isl_set *
isl_map_bind_range(__isl_take isl_map *map, __isl_take isl_multi_id *tuple);
...
__isl_export __isl_give isl_map *
isl_map_gist_domain(__isl_take isl_map *map, __isl_take isl_set *context);
...
isl_map_get_range_stride_info(__isl_keep isl_map *map, int pos);
__isl_export __isl_give isl_fixed_box *
isl_map_get_range_simple_fixed_box_hull(__isl_keep isl_map *map);
...
__isl_export isl_stat isl_map_foreach_basic_map(
    __isl_keep isl_map *map,
...
isl_map_eq_at_multi_pw_aff(__isl_take isl_map *map,
                           __isl_take isl_multi_pw_aff *mpa);
__isl_overload __isl_give isl_map *
isl_map_lex_lt_at_multi_pw_aff(__isl_take isl_map *map,
                               __isl_take isl_multi_pw_aff *mpa);
__isl_overload __isl_give isl_map *
isl_map_lex_le_at_multi_pw_aff(__isl_take isl_map *map,
                               __isl_take isl_multi_pw_aff *mpa);
__isl_overload __isl_give isl_map *
isl_map_lex_gt_at_multi_pw_aff(__isl_take isl_map *map,
                               __isl_take isl_multi_pw_aff *mpa);
__isl_overload __isl_give isl_map *
isl_map_lex_ge_at_multi_pw_aff(__isl_take isl_map *map,
                               __isl_take isl_multi_pw_aff *mpa);
...
__isl_give isl_basic_map *
isl_basic_map_from_multi_aff(__isl_take isl_multi_aff *maff);
__isl_give isl_basic_map *
isl_basic_map_from_aff_list(__isl_take isl_space *domain_space,
