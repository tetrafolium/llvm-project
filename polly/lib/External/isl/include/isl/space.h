...
isl_space_map_from_set(__isl_take isl_space *space);
__isl_give isl_space *
...
__isl_export __isl_give isl_space *
isl_space_domain(__isl_take isl_space *space);
...
__isl_export __isl_give isl_space *
isl_space_params(__isl_take isl_space *space);
__isl_overload __isl_give isl_space *
...
__isl_export __isl_give isl_space *
isl_space_unwrap(__isl_take isl_space *space);
...
isl_bool isl_space_is_range(__isl_keep isl_space *space1,
                            __isl_keep isl_space *space2);
__isl_export isl_bool isl_space_is_equal(__isl_keep isl_space *space1,
                                         __isl_keep isl_space *space2);
...
__isl_export __isl_give isl_space *
isl_space_flatten_domain(__isl_take isl_space *space);
__isl_export __isl_give isl_space *
isl_space_flatten_range(__isl_take isl_space *space);
