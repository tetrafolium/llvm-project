...
gpu_array_info_print_size(__isl_take isl_printer *prn,
...
print_non_linearized_declaration_argument(__isl_take isl_printer *p,
                                          struct gpu_array_info *array) {
 ...
 */
__isl_give isl_printer *
gpu_array_info_print_declaration_argument(__isl_take isl_printer *p,
                                          struct gpu_array_info *array,
 ...
 */
__isl_give isl_printer *
gpu_array_info_print_call_argument(__isl_take isl_printer *p,
                                   struct gpu_array_info *array) {
  if (gpu_array_is_read_only_scalar(array))
 ...
 */
static __isl_give isl_printer *
stmt_print_local_index(__isl_take isl_printer *p,
 ...
 */
static __isl_give isl_printer *
stmt_print_global_index(__isl_take isl_printer *p,
                        struct ppcg_kernel_stmt *stmt) {
...
__isl_give isl_printer *
ppcg_kernel_print_domain(__isl_take isl_printer *p,
                         struct ppcg_kernel_stmt *stmt) {
 ...
 */
static int already_printed(struct gpu_types *types, struct pet_type *type) {
  int i;
