 ...
 */
static int size_val(isl::size s) { return s.is_error() ? -1 : unsigned(s); }
...
void test_foreach(isl::ctx ctx) {
  ...
  auto fail = [&](isl::basic_set bs) { return isl::stat::error(); };
...
static void test_every(isl::ctx ctx) {
  ...
  auto fail = [](isl::set s) { return isl::boolean::error(); };
...
static void test_schedule_tree(isl::ctx ctx) {
  ...
  auto fail_map = [](isl::schedule_node node) { return isl::schedule_node(); };
  ...
  auto fail = [](isl::schedule_node node) { return isl::boolean(); };
...
static void test_ast_build(isl::ctx ctx) {
  ...
  auto fail_inc_count_ast = [&count_ast_fail, &do_fail](isl::ast_node node,
                                                        isl::ast_build build) {
    count_ast_fail++;
