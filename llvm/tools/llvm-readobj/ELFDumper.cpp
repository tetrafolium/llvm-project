...
public:
    ...
    const object::ELFObjectFile<ELFT> &getElfObject() const {
        return ObjF;
    };
...
public:
    ...
    Optional<DynRegionInfo> getDynSymRegion() const {
        return DynSymRegion;
    }
    ...
    const Elf_Shdr *getDotCGProfileSec() const {
        return DotCGProfileSec;
    }
    const Elf_Shdr *getDotAddrsigSec() const {
        return DotAddrsigSec;
    }
    ArrayRef<Elf_Word> getShndxTable() const {
        return ShndxTable;
    }
    StringRef getDynamicStringTable() const {
        return DynamicStringTable;
    }
    const DynRegionInfo &getDynRelRegion() const {
        return DynRelRegion;
    }
    const DynRegionInfo &getDynRelaRegion() const {
        return DynRelaRegion;
    }
    const DynRegionInfo &getDynRelrRegion() const {
        return DynRelrRegion;
    }
    const DynRegionInfo &getDynPLTRelRegion() const {
        return DynPLTRelRegion;
    }
    const DynRegionInfo &getDynamicTableRegion() const {
        return DynamicTable;
    }
    const Elf_Hash *getHashTable() const {
        return HashTable;
    }
    const Elf_GnuHash *getGnuHashTable() const {
        return GnuHashTable;
    }
...
public:
    ...
    const ELFDumper<ELFT> &dumper() const {
        return Dumper;
    }
...
const typename ELFT::GnuHash *GnuHashTable) {
    ...
    if (!llvm::all_of(Buckets, [](typename ELFT::Word V) {
    return V == 0;
}))
    return createError(
...
public:
    ...
    bool isGotEmpty() const {
        return GotEntries.empty();
    }
    bool isPltEmpty() const {
        return PltEntries.empty();
    }
    ...
    StringRef getPltStrTable() const {
        return PltStrTable;
    }
    const Elf_Shdr *getPltSymTable() const {
        return PltSymTable;
    }
