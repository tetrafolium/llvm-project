...
private:
    ...
    std::intmax_t Convert(std::int64_t x) {
        return x;
    }
    std::uintmax_t Convert(std::uint64_t x) {
        return x;
    }
...
public:
    ...
    bool attachmentIsContext() const {
        return attachmentIsContext_;
    }
