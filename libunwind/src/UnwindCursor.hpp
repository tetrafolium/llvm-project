...
public:
    ...
    virtual bool validReg(int) {
        _LIBUNWIND_ABORT("validReg not implemented");
    }
    ...
    virtual int step() {
        _LIBUNWIND_ABORT("step not implemented");
    }
...
public:
    ...
    DISPATCHER_CONTEXT *getDispatcherContext() {
        return &_dispContext;
    }
    ...
    static void *operator new(size_t, UnwindCursor<A, R> *p) {
        return p;
    }

private:

    pint_t getLastPC() const {
        return _dispContext.ControlPc;
    }
    void setLastPC(pint_t pc) {
        _dispContext.ControlPc = pc;
    }
...
private:
    ...
    int stepWithCompactEncoding(Registers_sparc &) {
        return UNW_EINVAL;
    }
#endif
...
struct EHABISectionIterator {
    ...
    size_t operator-(const _Self& other) const {
        return _i - other._i;
    }
    ...
    typename A::pint_t operator*() const {
