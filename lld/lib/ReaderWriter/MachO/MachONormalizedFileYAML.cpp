...
template <> struct SequenceTraits<std::vector<Section>> {
  static size_t size(IO &io, std::vector<Section> &seq) { return seq.size(); }
...
template <> struct SequenceTraits<std::vector<Symbol>> {
  static size_t size(IO &io, std::vector<Symbol> &seq) { return seq.size(); }
...
template <> struct SequenceTraits<Relocations> {
  static size_t size(IO &io, Relocations &seq) { return seq.size(); }
...
template <> struct SequenceTraits<ContentBytes> {
  static size_t size(IO &io, ContentBytes &seq) { return seq.size(); }
...
template <> struct SequenceTraits<IndirectSymbols> {
  static size_t size(IO &io, IndirectSymbols &seq) { return seq.size(); }
...
template <> struct ScalarEnumerationTraits<lld::MachOLinkingContext::Arch> {
...
template <> struct ScalarEnumerationTraits<lld::MachOLinkingContext::OS> {
  static void enumeration(IO &io, lld::MachOLinkingContext::OS &value) {
    io.enumCase(value, "unknown", lld::MachOLinkingContext::OS::unknown);
    io.enumCase(value, "Mac OS X", lld::MachOLinkingContext::OS::macOSX);
    io.enumCase(value, "iOS", lld::MachOLinkingContext::OS::iOS);
    io.enumCase(value, "iOS Simulator",
                lld::MachOLinkingContext::OS::iOS_simulator);
  }
};

template <> struct ScalarEnumerationTraits<HeaderFileType> {
...
template <> struct ScalarBitSetTraits<FileFlags> {
  static void bitset(IO &io, FileFlags &value) {
    io.bitSetCase(value, "MH_TWOLEVEL", llvm::MachO::MH_TWOLEVEL);
    io.bitSetCase(value, "MH_SUBSECTIONS_VIA_SYMBOLS",
                  llvm::MachO::MH_SUBSECTIONS_VIA_SYMBOLS);
  }
};

template <> struct ScalarEnumerationTraits<SectionType> {
  static void enumeration(IO &io, SectionType &value) {
    io.enumCase(value, "S_REGULAR", llvm::MachO::S_REGULAR);
    io.enumCase(value, "S_ZEROFILL", llvm::MachO::S_ZEROFILL);
    io.enumCase(value, "S_CSTRING_LITERALS", llvm::MachO::S_CSTRING_LITERALS);
    io.enumCase(value, "S_4BYTE_LITERALS", llvm::MachO::S_4BYTE_LITERALS);
    io.enumCase(value, "S_8BYTE_LITERALS", llvm::MachO::S_8BYTE_LITERALS);
    io.enumCase(value, "S_LITERAL_POINTERS", llvm::MachO::S_LITERAL_POINTERS);
    ...
    io.enumCase(value, "S_SYMBOL_STUBS", llvm::MachO::S_SYMBOL_STUBS);
    ...
    io.enumCase(value, "S_COALESCED", llvm::MachO::S_COALESCED);
    io.enumCase(value, "S_GB_ZEROFILL", llvm::MachO::S_GB_ZEROFILL);
    io.enumCase(value, "S_INTERPOSING", llvm::MachO::S_INTERPOSING);
    io.enumCase(value, "S_16BYTE_LITERALS", llvm::MachO::S_16BYTE_LITERALS);
    io.enumCase(value, "S_DTRACE_DOF", llvm::MachO::S_DTRACE_DOF);
...
template <> struct ScalarBitSetTraits<SectionAttr> {
  static void bitset(IO &io, SectionAttr &value) {
    ...
    io.bitSetCase(value, "S_ATTR_EXT_RELOC", llvm::MachO::S_ATTR_EXT_RELOC);
    io.bitSetCase(value, "S_ATTR_LOC_RELOC", llvm::MachO::S_ATTR_LOC_RELOC);
    io.bitSetCase(value, "S_ATTR_DEBUG", llvm::MachO::S_ATTR_DEBUG);
  }
};
...
template <> struct ScalarEnumerationTraits<NListType> {
...
template <> struct ScalarBitSetTraits<SymbolScope> {
...
template <> struct ScalarBitSetTraits<SymbolDesc> {
...
template <> struct MappingTraits<Section> {
...
template <> struct MappingTraits<Relocation> {
...
template <> struct ScalarEnumerationTraits<RelocationInfoType> {
  static void enumeration(IO &io, RelocationInfoType &value) {
    ...
    case lld::MachOLinkingContext::arch_x86_64:
      ...
      io.enumCase(value, "X86_64_RELOC_GOT", llvm::MachO::X86_64_RELOC_GOT);
      ...
      io.enumCase(value, "X86_64_RELOC_TLV", llvm::MachO::X86_64_RELOC_TLV);
      break;
    case lld::MachOLinkingContext::arch_x86:
      io.enumCase(value, "GENERIC_RELOC_VANILLA",
                  llvm::MachO::GENERIC_RELOC_VANILLA);
      io.enumCase(value, "GENERIC_RELOC_PAIR", llvm::MachO::GENERIC_RELOC_PAIR);
      ...
      io.enumCase(value, "GENERIC_RELOC_TLV", llvm::MachO::GENERIC_RELOC_TLV);
      break;
    case lld::MachOLinkingContext::arch_armv6:
    case lld::MachOLinkingContext::arch_armv7:
    case lld::MachOLinkingContext::arch_armv7s:
      io.enumCase(value, "ARM_RELOC_VANILLA", llvm::MachO::ARM_RELOC_VANILLA);
      io.enumCase(value, "ARM_RELOC_PAIR", llvm::MachO::ARM_RELOC_PAIR);
      io.enumCase(value, "ARM_RELOC_SECTDIFF", llvm::MachO::ARM_RELOC_SECTDIFF);
      io.enumCase(value, "ARM_RELOC_LOCAL_SECTDIFF",
                  llvm::MachO::ARM_RELOC_LOCAL_SECTDIFF);
      io.enumCase(value, "ARM_RELOC_BR24", llvm::MachO::ARM_RELOC_BR24);
      io.enumCase(value, "ARM_THUMB_RELOC_BR22",
                  llvm::MachO::ARM_THUMB_RELOC_BR22);
      io.enumCase(value, "ARM_RELOC_HALF", llvm::MachO::ARM_RELOC_HALF);
    ...
    case lld::MachOLinkingContext::arch_arm64:
      ...
      io.enumCase(value, "ARM64_RELOC_PAGE21", llvm::MachO::ARM64_RELOC_PAGE21);
      ...
      io.enumCase(value, "ARM64_RELOC_ADDEND", llvm::MachO::ARM64_RELOC_ADDEND);
      break;
    default:
...
template <> struct ScalarTraits<VMProtect> {
...
template <> struct MappingTraits<Segment> {
...
template <> struct ScalarEnumerationTraits<LoadCommandType> {
  static void enumeration(IO &io, LoadCommandType &value) {
    io.enumCase(value, "LC_LOAD_DYLIB", llvm::MachO::LC_LOAD_DYLIB);
    io.enumCase(value, "LC_LOAD_WEAK_DYLIB", llvm::MachO::LC_LOAD_WEAK_DYLIB);
    io.enumCase(value, "LC_REEXPORT_DYLIB", llvm::MachO::LC_REEXPORT_DYLIB);
    io.enumCase(value, "LC_LOAD_UPWARD_DYLIB",
                llvm::MachO::LC_LOAD_UPWARD_DYLIB);
    io.enumCase(value, "LC_LAZY_LOAD_DYLIB", llvm::MachO::LC_LAZY_LOAD_DYLIB);
    ...
    io.enumCase(value, "LC_VERSION_MIN_TVOS", llvm::MachO::LC_VERSION_MIN_TVOS);
    io.enumCase(value, "LC_VERSION_MIN_WATCHOS",
                llvm::MachO::LC_VERSION_MIN_WATCHOS);
  }
};

template <> struct MappingTraits<DependentDylib> {
...
template <> struct ScalarEnumerationTraits<RebaseType> {
  static void enumeration(IO &io, RebaseType &value) {
    io.enumCase(value, "REBASE_TYPE_POINTER", llvm::MachO::REBASE_TYPE_POINTER);
...
template <> struct MappingTraits<RebaseLocation> {
  static void mapping(IO &io, RebaseLocation &rebase) {
    ...
    io.mapOptional("kind", rebase.kind, llvm::MachO::REBASE_TYPE_POINTER);
  }
};

template <> struct ScalarEnumerationTraits<BindType> {
  static void enumeration(IO &io, BindType &value) {
    io.enumCase(value, "BIND_TYPE_POINTER", llvm::MachO::BIND_TYPE_POINTER);
...
template <> struct MappingTraits<BindLocation> {
  static void mapping(IO &io, BindLocation &bind) {
    ...
    io.mapOptional("kind", bind.kind, llvm::MachO::BIND_TYPE_POINTER);
...
template <> struct ScalarEnumerationTraits<ExportSymbolKind> {
...
template <> struct MappingTraits<Export> {
...
template <> struct ScalarEnumerationTraits<DataRegionType> {
  static void enumeration(IO &io, DataRegionType &value) {
    io.enumCase(value, "DICE_KIND_DATA", llvm::MachO::DICE_KIND_DATA);
...
template <> struct MappingTraits<DataInCode> {
...
template <> struct MappingTraits<NormalizedFile> {
  static void mapping(IO &io, NormalizedFile &file) {
    ...
    io.mapOptional("compat-version", file.compatVersion,
                   PackedVersion(0x10000));
    io.mapOptional("current-version", file.currentVersion,
                   PackedVersion(0x10000));
    ...
    io.mapOptional("min-os-version-kind", file.minOSVersionKind,
                   (LoadCommandType)0);
...
bool MachOYamlIOTaggedDocumentHandler::handledDocTag(
    llvm::yaml::IO &io, const lld::File *&file) const {
  if (!io.mapTag("!mach-o"))
    return false;
  ...
  if (nf.arch != _arch) {
    io.setError(Twine("file is wrong architecture. Expected (" +
                      MachOLinkingContext::nameFromArch(_arch) + ") found (" +
