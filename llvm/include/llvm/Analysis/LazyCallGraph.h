...
public:
    ...
    public:
        ...
        iterator begin() {
            return iterator(Edges.begin(), Edges.end());
        }
        iterator end() {
            return iterator(Edges.end(), Edges.end());
        }
        ...
        call_iterator call_end() {
            return call_iterator(Edges.end(), Edges.end());
        }
    ...
    EdgeSequence::iterator begin() {
        return EntryEdges.begin();
    }
    EdgeSequence::iterator end() {
        return EntryEdges.end();
    }
