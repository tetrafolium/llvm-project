...
public:
    ...
    DNBBreakpointList &Breakpoints() {
        return m_breakpoints;
    }
    const DNBBreakpointList &Breakpoints() const {
        return m_breakpoints;
    }
    ...
    DNBBreakpointList &Watchpoints() {
        return m_watchpoints;
    }
    const DNBBreakpointList &Watchpoints() const {
        return m_watchpoints;
    }
    ...
    useconds_t ProfileInterval() {
        return m_profile_interval_usec;
    }
    ...
    int GetStdinFileDescriptor() const {
        return m_child_stdin;
    }
    int GetStdoutFileDescriptor() const {
        return m_child_stdout;
    }
    int GetStderrFileDescriptor() const {
    ...
    DNBProfileDataScanType GetProfileScanType() {
        return m_profile_scan_type;
    }
