...
struct isl_arg_choice cat_format[] = {{"isl", ISL_FORMAT_ISL},
...
struct isl_arg_choice cat_yaml_style[] = {
    {"block", ISL_YAML_STYLE_BLOCK}, {"flow", ISL_YAML_STYLE_FLOW}, {0}};
...
ISL_ARG_CHOICE(struct cat_options, format, 0, "format", cat_format,
               ISL_FORMAT_ISL, "output format")
ISL_ARG_CHOICE(struct cat_options, yaml_style, 0, "yaml-style", cat_yaml_style,
               ISL_YAML_STYLE_BLOCK, "output YAML style")
ISL_ARGS_END
