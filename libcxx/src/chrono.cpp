...
static system_clock::time_point __libcpp_system_clock_now() {
  ...
  using filetime_duration = _VSTD::chrono::duration<
      __int64,
      _VSTD::ratio_multiply<_VSTD::ratio<100, 1>, nanoseconds::period> >;
  ...
  return system_clock::time_point(
      duration_cast<system_clock::duration>(d - nt_to_unix_epoch));
}
...
static system_clock::time_point __libcpp_system_clock_now() {
  ...
  return system_clock::time_point(seconds(tp.tv_sec) +
...
static steady_clock::time_point __libcpp_steady_clock_now() {
  ...
  return steady_clock::time_point(
      steady_clock::duration(counter.QuadPart * nano::den / freq.QuadPart));
}
