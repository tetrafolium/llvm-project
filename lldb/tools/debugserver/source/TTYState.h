...
public:
    ...
    bool FileDescriptorValid() const {
        return m_fd >= 0;
    }
    bool TFlagsValid() const {
        return m_tflags != -1;
    }
    bool TTYStateValid() const {
        return m_ttystateErr == 0;
    }
    bool ProcessGroupValid() const {
        return m_processGroup != -1;
    }
...
public:
    ...
    bool ValidStateIndex(uint32_t idx) const {
