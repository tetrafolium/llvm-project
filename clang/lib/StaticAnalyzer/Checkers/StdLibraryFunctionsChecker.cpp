...
class StdLibraryFunctionsChecker
    ...
    bool static isIrrelevant(QualType T) {
        return T.isNull();
    }
    ...
    public:
        ...
        InvalidationKind getInvalidationKd() const {
            return InvalidationKd;
        }
        const Cases &getCaseConstraints() const {
            return CaseConstraints;
        }
        const ConstraintSet &getArgConstraints() const {
