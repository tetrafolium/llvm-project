...
static __inline __m128d __DEFAULT_FN_ATTRS128 _mm_permutevar_pd(__m128d __a,
                                                                __m128i __c) {
...
static __inline __m128 __DEFAULT_FN_ATTRS128 _mm_permutevar_ps(__m128 __a,
                                                               __m128i __c) {
...
#define _mm256_dp_ps(V1, V2, M)                                                \
  (__m256)                                                                     \
      __builtin_ia32_dpps256((__v8sf)(__m256)(V1), (__v8sf)(__m256)(V2), (M))
...
#define _mm256_shuffle_ps(a, b, mask)                                          \
  (__m256) __builtin_ia32_shufps256((__v8sf)(__m256)(a), (__v8sf)(__m256)(b),  \
                                    (int)(mask))
...
#define _mm_cmp_pd(a, b, c)                                                    \
  (__m128d)                                                                    \
      __builtin_ia32_cmppd((__v2df)(__m128d)(a), (__v2df)(__m128d)(b), (c))
...
#define _mm256_cmp_pd(a, b, c)                                                 \
  (__m256d)                                                                    \
      __builtin_ia32_cmppd256((__v4df)(__m256d)(a), (__v4df)(__m256d)(b), (c))
...
#define _mm256_cmp_ps(a, b, c)                                                 \
  (__m256)                                                                     \
      __builtin_ia32_cmpps256((__v8sf)(__m256)(a), (__v8sf)(__m256)(b), (c))
...
#define _mm_cmp_sd(a, b, c)                                                    \
  (__m128d)                                                                    \
      __builtin_ia32_cmpsd((__v2df)(__m128d)(a), (__v2df)(__m128d)(b), (c))
...
#define _mm256_extract_epi16(X, N)                                             \
  (int)(unsigned short)                                                        \
      __builtin_ia32_vec_ext_v16hi((__v16hi)(__m256i)(X), (int)(N))
...
#define _mm256_extract_epi8(X, N)                                              \
  (int)(unsigned char)                                                         \
      __builtin_ia32_vec_ext_v32qi((__v32qi)(__m256i)(X), (int)(N))
...
#define _mm256_insert_epi32(X, I, N)                                           \
  (__m256i)                                                                    \
      __builtin_ia32_vec_set_v8si((__v8si)(__m256i)(X), (int)(I), (int)(N))
...
#define _mm256_insert_epi16(X, I, N)                                           \
  (__m256i)                                                                    \
      __builtin_ia32_vec_set_v16hi((__v16hi)(__m256i)(X), (int)(I), (int)(N))
...
#define _mm256_insert_epi8(X, I, N)                                            \
  (__m256i)                                                                    \
      __builtin_ia32_vec_set_v32qi((__v32qi)(__m256i)(X), (int)(I), (int)(N))
...
#define _mm256_insert_epi64(X, I, N)                                           \
  (__m256i) __builtin_ia32_vec_set_v4di((__v4di)(__m256i)(X), (long long)(I),  \
                                        (int)(N))
#endif
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_movehdup_ps(__m256 __a) {
  return __builtin_shufflevector((__v8sf)__a, (__v8sf)__a, 1, 1, 3, 3, 5, 5, 7,
                                 7);
}
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_moveldup_ps(__m256 __a) {
  return __builtin_shufflevector((__v8sf)__a, (__v8sf)__a, 0, 0, 2, 2, 4, 4, 6,
                                 6);
}
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_unpackhi_ps(__m256 __a,
                                                             __m256 __b) {
  return __builtin_shufflevector((__v8sf)__a, (__v8sf)__b, 2, 10, 2 + 1, 10 + 1,
                                 6, 14, 6 + 1, 14 + 1);
}
...
static __inline int __DEFAULT_FN_ATTRS128 _mm_testz_pd(__m128d __a,
                                                       __m128d __b) {
...
static __inline int __DEFAULT_FN_ATTRS128 _mm_testc_pd(__m128d __a,
                                                       __m128d __b) {
...
static __inline int __DEFAULT_FN_ATTRS128 _mm_testnzc_pd(__m128d __a,
                                                         __m128d __b) {
...
///    A 128-bit vector of [4 x float].
/// \returns 1 if both the ZF and CF flags are set to 0, otherwise returns 0.
static __inline int __DEFAULT_FN_ATTRS128 _mm_testnzc_ps(__m128 __a,
                                                         __m128 __b) {
...
_mm256_broadcast_ps(__m128 const *__a) {
  ...
  return (__m256)__builtin_shufflevector((__v4sf)__b, (__v4sf)__b, 0, 1, 2, 3,
                                         0, 1, 2, 3);
}
...
static __inline __m128d __DEFAULT_FN_ATTRS128 _mm_maskload_pd(double const *__p,
                                                              __m128i __m) {
...
static __inline __m128 __DEFAULT_FN_ATTRS128 _mm_maskload_ps(float const *__p,
                                                             __m128i __m) {
...
static __inline void __DEFAULT_FN_ATTRS128 _mm_maskstore_pd(double *__p,
                                                            __m128i __m,
                                                            __m128d __a) {
...
static __inline void __DEFAULT_FN_ATTRS128 _mm_maskstore_ps(float *__p,
                                                            __m128i __m,
                                                            __m128 __a) {
...
static __inline __m256d __DEFAULT_FN_ATTRS _mm256_set_pd(double __a, double __b,
                                                         double __c,
                                                         double __d) {
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_set_ps(float __a, float __b,
                                                        float __c, float __d,
                                                        float __e, float __f,
                                                        float __g, float __h) {
...
///    of the result.
/// \returns An initialized 256-bit floating-point vector of [8 x float].
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_setr_ps(float __a, float __b,
                                                         float __c, float __d,
                                                         float __e, float __f,
                                                         float __g, float __h) {
...
///    A 32-bit integral value used to initialize bits [255:224] of the result.
/// \returns An initialized 256-bit integer vector.
static __inline __m256i __DEFAULT_FN_ATTRS _mm256_setr_epi32(int __i0, int __i1,
                                                             int __i2, int __i3,
                                                             int __i4, int __i5,
                                                             int __i6,
                                                             int __i7) {
...
_mm256_setr_epi16(short __w15, short __w14, short __w13, short __w12,
                  ...
                  short __w07, short __w06, short __w05, short __w04,
                  short __w03, short __w02, short __w01, short __w00) {
  return _mm256_set_epi16(__w00, __w01, __w02, __w03, __w04, __w05, __w06,
                          __w07, __w08, __w09, __w10, __w11, __w12, __w13,
                          __w14, __w15);
}
...
///    An 8-bit integral value used to initialize bits [255:248] of the result.
/// \returns An initialized 256-bit integer vector.
static __inline __m256i __DEFAULT_FN_ATTRS _mm256_setr_epi8(
    char __b31, char __b30, char __b29, char __b28, char __b27, char __b26,
    char __b25, char __b24, char __b23, char __b22, char __b21, char __b20,
    char __b19, char __b18, char __b17, char __b16, char __b15, char __b14,
    char __b13, char __b12, char __b11, char __b10, char __b09, char __b08,
...
static __inline __m256i __DEFAULT_FN_ATTRS _mm256_set1_epi16(short __w) {
  return _mm256_set_epi16(__w, __w, __w, __w, __w, __w, __w, __w, __w, __w, __w,
                          __w, __w, __w, __w, __w);
}
...
static __inline __m256i __DEFAULT_FN_ATTRS _mm256_set1_epi8(char __b) {
  return _mm256_set_epi8(__b, __b, __b, __b, __b, __b, __b, __b, __b, __b, __b,
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_castps128_ps256(__m128 __a) {
  return __builtin_shufflevector((__v4sf)__a, (__v4sf)__a, 0, 1, 2, 3, -1, -1,
                                 -1, -1);
}
...
static __inline __m256 __DEFAULT_FN_ATTRS _mm256_set_m128(__m128 __hi,
                                                          __m128 __lo) {
  return (__m256)__builtin_shufflevector((__v4sf)__lo, (__v4sf)__hi, 0, 1, 2, 3,
                                         4, 5, 6, 7);
}
...
static __inline __m256d __DEFAULT_FN_ATTRS _mm256_set_m128d(__m128d __hi,
                                                            __m128d __lo) {
  return (__m256d)__builtin_shufflevector((__v2df)__lo, (__v2df)__hi, 0, 1, 2,
                                          3);
}
...
static __inline __m256i __DEFAULT_FN_ATTRS _mm256_set_m128i(__m128i __hi,
                                                            __m128i __lo) {
  return (__m256i)__builtin_shufflevector((__v2di)__lo, (__v2di)__hi, 0, 1, 2,
                                          3);
}
