...
public:
    ...
    explicit operator MDTuple *() const {
        return get();
    }

    MDTuple *get() const {
        return const_cast<MDTuple *>(N);
    }
    ...
    iterator begin() const {
        return N ? iterator(N->op_begin()) : iterator();
    }
    iterator end() const {
        return N ? iterator(N->op_end()) : iterator();
    }
};
...
public:
    ...
    Metadata *getRawLowerBound() const {
        return getOperand(1).get();
    }

    Metadata *getRawUpperBound() const {
        return getOperand(2).get();
    }

    Metadata *getRawStride() const {
        return getOperand(3).get();
    }
...
public:
    ...
    TempDIGenericSubrange clone() const {
        return cloneImpl();
    }
...
public:
    ...
    struct ChecksumInfo {
        ...
        StringRef getKindAsString() const {
            return getChecksumKindAsString(Kind);
        }
    };
...
public:
    ...
    Optional<ChecksumInfo<MDString *>> getRawChecksum() const {
        return Checksum;
    }
    Optional<MDString *> getRawSource() const {
        return Source;
    }
...
public:
    ...
    uint32_t getAlignInBytes() const {
        return getAlignInBits() / CHAR_BIT;
    }
    ...
    bool isForwardDecl() const {
        return getFlags() & FlagFwdDecl;
    }
    bool isAppleBlockExtension() const {
        return getFlags() & FlagAppleBlock;
    }
    ...
    bool isObjectPointer() const {
        return getFlags() & FlagObjectPointer;
    }
    ...
    bool isStaticMember() const {
        return getFlags() & FlagStaticMember;
    }
    ...
    bool isTypePassByValue() const {
        return getFlags() & FlagTypePassByValue;
    }
    bool isTypePassByReference() const {
        return getFlags() & FlagTypePassByReference;
    }
    bool isBigEndian() const {
        return getFlags() & FlagBigEndian;
    }
    bool isLittleEndian() const {
        return getFlags() & FlagLittleEndian;
    }
    bool getExportSymbols() const {
        return getFlags() & FlagExportSymbols;
    }
...
public:
    ...
    TempDIDerivedType clone() const {
        return cloneImpl();
    }

    /// Get the base type this is derived from.
    DIType *getBaseType() const {
        return cast_or_null<DIType>(getRawBaseType());
    }
    ...
    Optional<unsigned> getDWARFAddressSpace() const {
...
public:
    ...
    TempDICompositeType clone() const {
        return cloneImpl();
    }
    ...
    MDString *getRawIdentifier() const {
        return getOperandAs<MDString>(7);
    }
...
public:
    ...
    MDString *getRawSysRoot() const {
        return getOperandAs<MDString>(9);
    }
    MDString *getRawSDK() const {
        return getOperandAs<MDString>(10);
    }
...
public:
    ...
    void setImplicitCode(bool ImplicitCode) {
        this->ImplicitCode = ImplicitCode;
    }
...
public:
    ...
    Metadata *getRawUnit() const {
        return getOperand(5);
    }
    Metadata *getRawDeclaration() const {
        return getOperand(6);
    }
    Metadata *getRawRetainedNodes() const {
        return getOperand(7);
    }
...
public:
    ...
    TempDILexicalBlock clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDILexicalBlockFile clone() const {
        return cloneImpl();
    }
...
public:
    ...
    StringRef getAPINotesFile() const {
    ...
    MDString *getRawAPINotesFile() const {
...
public:
    ...
    DIType *getType() const {
        return cast_or_null<DIType>(getRawType());
    }
...
public:
    ...
    TempDITemplateTypeParameter clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDITemplateValueParameter clone() const {
        return cloneImpl();
    }
...
public:
    ...
    private:
        void increment() {
            Op = ExprOperand(getBase() + Op.getSize());
        }
    };
    ...
    bool isFragment() const {
        return getFragmentInfo().hasValue();
    }
...
template <> struct DenseMapInfo<DIExpression::FragmentInfo> {
    ...
    static inline FragInfo getEmptyKey() {
        return {MaxVal, MaxVal};
    }

    static inline FragInfo getTombstoneKey() {
...
public:
    ...
    TempDIGlobalVariable clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDILocalVariable clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDIObjCProperty clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDIImportedEntity clone() const {
        return cloneImpl();
    }
...
public:
    ...
    TempDIGlobalVariableExpression clone() const {
        return cloneImpl();
    }
...
public:
    ...
    const Optional<FragmentInfo> getFragment() const {
        return Fragment;
    }
