...
public:
    ...
    unsigned getWriteResourceID() const {
        return WD->SClassOrWriteResourceID;
    }
...
public:
    ...
    bool isImplicitRead() const {
        return RD->isImplicitRead();
    }

    bool isIndependentFromDef() const {
        return IndependentFromDef;
    }
    void setIndependentFromDef() {
        IndependentFromDef = true;
    }
...
struct InstrDesc {
    ...
    bool isZeroLatency() const {
        return !MaxLatency && Resources.empty();
    }
...
public:
    ...
    bool isDispatched() const {
        return Stage == IS_DISPATCHED;
    }
    bool isPending() const {
        return Stage == IS_PENDING;
    }
    bool isReady() const {
        return Stage == IS_READY;
    }
    bool isExecuting() const {
        return Stage == IS_EXECUTING;
    }
    bool isExecuted() const {
        return Stage == IS_EXECUTED;
    }
    bool isRetired() const {
        return Stage == IS_RETIRED;
    }
    bool isEliminated() const {
        return IsEliminated;
    }
...
public:
    ...
    bool isValid() const {
        return Data.second && Data.first != INVALID_IID;
    }
