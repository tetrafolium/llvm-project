...
public:
    ...
    const std::string &variety() const {
        return V;
    }
...
public:
    ...
    StringRef getLowerName() const {
        return lowerName;
    }
    StringRef getUpperName() const {
        return upperName;
    }
    ...
    virtual std::string getIsOmitted() const {
        return "false";
    }
    virtual void writeValue(raw_ostream &OS) const = 0;
    virtual void writeDump(raw_ostream &OS) const = 0;
    virtual void writeDumpChildren(raw_ostream &OS) const {}
    virtual void writeHasChildren(raw_ostream &OS) const {
        OS << "false";
    }

    virtual bool isEnumArg() const {
        return false;
    }
    virtual bool isVariadicEnumArg() const {
        return false;
    }
...
public:
    ...
    const std::string &getArgSizeName() const {
        return ArgSizeName;
    }
...
public:
    ...
    bool isVariadicEnumArg() const override {
        return true;
    }
