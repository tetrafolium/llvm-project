...
static isl_bool FN(MULTI(BASE),
                   compatible_domain)(__isl_keep MULTI(BASE) * multi,
                                      __isl_keep DOM *domain) {
  isl_bool ok;
...
static isl_stat FN(MULTI(BASE),
                   check_compatible_domain)(__isl_keep MULTI(BASE) * multi,
                                            __isl_keep DOM *domain) {
  isl_bool ok;
  ...
  if (!ok)
    isl_die(FN(DOM, get_ctx)(domain), isl_error_invalid, "incompatible spaces",
            return isl_stat_error);
...
static __isl_give MULTI(BASE) *
    FN(MULTI(BASE), domain_intersect_aligned)(__isl_take MULTI(BASE) * multi,
                                              __isl_take DOM *domain) {
  isl_bool is_params;
  DOM *multi_dom;
 ...
 */
static __isl_give MULTI(BASE) *
    FN(MULTI(BASE), domain_intersect)(__isl_take MULTI(BASE) * multi,
                                      __isl_take DOM *domain) {
  return FN(FN(MULTI(BASE), align_params),
            DOMBASE)(multi, domain, FN(MULTI(BASE), domain_intersect_aligned));
}
...
__isl_give MULTI(BASE) *
    FN(MULTI(BASE), intersect_domain)(__isl_take MULTI(BASE) * multi,
                                      __isl_take DOM *domain) {
...
static __isl_give MULTI(BASE) *
    FN(MULTI(BASE),
       domain_intersect_params_aligned)(__isl_take MULTI(BASE) * multi,
 ...
 */
static __isl_give MULTI(BASE) *
    FN(MULTI(BASE), domain_intersect_params)(__isl_take MULTI(BASE) * multi,
                                             __isl_take isl_set *domain) {
  return FN(FN(MULTI(BASE), align_params), set)(
      multi, domain, FN(MULTI(BASE), domain_intersect_params_aligned));
}
 ...
 */
__isl_give MULTI(BASE) *
    FN(MULTI(BASE), intersect_params)(__isl_take MULTI(BASE) * multi,
                                      __isl_take isl_set *domain) {
  if (FN(MULTI(BASE), has_explicit_domain)(multi))
    return FN(MULTI(BASE), domain_intersect_params)(multi, domain);
  return FN(MULTI(BASE), apply_set)(multi, domain, &FN(EL, intersect_params));
}
