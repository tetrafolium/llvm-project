...
class GCNSubtarget : public AMDGPUGenSubtargetInfo, public AMDGPUSubtarget {
...
public:
  ...
  bool isXNACKEnabled() const { return EnableXNACK; }
  ...
  bool isSRAMECCEnabled() const { return EnableSRAMECC; }
