...
#define _mm_slli_si128(a, imm)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_pslldqi128_byteshift((__v2di)(__m128i)(a), (int)(imm))
...
#define _mm_srli_si128(a, imm)                                                 \
  (__m128i)                                                                    \
      __builtin_ia32_psrldqi128_byteshift((__v2di)(__m128i)(a), (int)(imm))
...
#define _mm_extract_epi16(a, imm)                                              \
  (int)(unsigned short)                                                        \
      __builtin_ia32_vec_ext_v8hi((__v8hi)(__m128i)(a), (int)(imm))
...
#define _mm_insert_epi16(a, b, imm)                                            \
  (__m128i)                                                                    \
      __builtin_ia32_vec_set_v8hi((__v8hi)(__m128i)(a), (int)(b), (int)(imm))
