...
public:
    ...
    ctor_range ctors() const {
        return ctor_range(ctor_begin(), ctor_end());
    }
    ...
    unsigned capture_size() const {
        return getLambdaData().NumCaptures;
    }
    ...
    bool isCXX11StandardLayout() const {
        return data().IsCXX11StandardLayout;
    }
...
public:
    ...
    ExplicitSpecKind getKind() const {
        return ExplicitSpec.getInt();
    }
    const Expr *getExpr() const {
        return ExplicitSpec.getPointer();
    }
    Expr *getExpr() {
        return ExplicitSpec.getPointer();
    }
    ...
    void setKind(ExplicitSpecKind Kind) {
        ExplicitSpec.setInt(Kind);
    }
    void setExpr(Expr *E) {
        ExplicitSpec.setPointer(E);
    }
...
public:
    ...
    bool isExplicit() const {
        return ExplicitSpec.isExplicit();
    }
...
public:
    ...
    bool isConst() const {
        return getType()->castAs<FunctionType>()->isConst();
    }
...
public:
    ...
    bool isMemberInitializer() const {
        return Initializee.is<FieldDecl*>();
    }
...
public:
    ...
    void setLanguage(LanguageIDs L) {
        LinkageSpecDeclBits.Language = L;
    }
...
public:
    ...
    Expr *getTemporaryExpr() {
        return cast<Expr>(ExprWithTemporary);
    }
...
public:
    ...
    static bool classofKind(Kind K) {
        return K == ConstructorUsingShadow;
    }
};
...
public:
    ...
    static bool classofKind(Kind K) {
        return K == UnresolvedUsingTypename;
    }
};
...
public:
    ...
    bool hasGetter() const {
        return GetterId != nullptr;
    }
    IdentifierInfo* getGetterId() const {
        return GetterId;
    }
    bool hasSetter() const {
        return SetterId != nullptr;
    }
