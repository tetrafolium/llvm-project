...
std::string Message::ToString() const {
    ...
    common::visitors{
        ...
        [](const MessageFormattedText &t) {
            return t.string();
        },
        [](const MessageExpectedText &e) {
            return e.ToString();
        },
    },
    text_);
...
std::optional<ProvenanceRange> Message::GetProvenanceRange(
    ...
    common::visitors{
        [&](CharBlock cb) {
            return allCooked.GetProvenanceRange(cb);
        },
