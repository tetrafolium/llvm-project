...
struct AAReachabilityFunction final : public AAReachabilityImpl {
    ...
    /// See AbstractAttribute::trackStatistics()
    void trackStatistics() const override {
        STATS_DECLTRACK_FN_ATTR(reachable);
    }
};
...
struct AAIsDeadReturned : public AAIsDeadValueImpl {
    ...
    ChangeStatus updateImpl(Attributor &A) override {
        ...
        A.checkForAllInstructions([](Instruction &) {
            return true;
        }, *this,
        {Instruction::Ret});
...
struct AANoReturnImpl : public AANoReturn {
    ...
    /// See AbstractAttribute::updateImpl(Attributor &A).
    virtual ChangeStatus updateImpl(Attributor &A) override {
        auto CheckForNoReturn = [](Instruction &) {
            return false;
        };
...
struct AAPrivatizablePtrArgument final : public AAPrivatizablePtrImpl {
    ...
    Optional<Type *> identifyPrivatizableType(Attributor &A) override {
        ...
        A.checkForAllCallSites([](AbstractCallSite ACS) {
        return true;
    }, *this,
    true, AllCallSitesKnown))
