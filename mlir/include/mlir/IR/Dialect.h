...
public:
    ...
    MapTy::const_iterator begin() const {
        return registry.begin();
    }
    MapTy::const_iterator end() const {
        return registry.end();
    }
