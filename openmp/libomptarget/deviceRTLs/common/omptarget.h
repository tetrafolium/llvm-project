...
extern DEVICE SHARED omptarget_nvptx_SharedArgs omptarget_nvptx_globalArgs;
...
extern DEVICE SHARED uint8_t parallelLevel[MAX_THREADS_PER_TEAM / WARPSIZE];
...
extern volatile DEVICE SHARED omptarget_nvptx_WorkFn omptarget_nvptx_workFn;
