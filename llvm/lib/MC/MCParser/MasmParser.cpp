...
struct IntFieldInfo {
    ...
    IntFieldInfo(const SmallVector<const MCExpr *, 1> &V) {
        Values = V;
    }
    IntFieldInfo(SmallVector<const MCExpr *, 1> &&V) {
        Values = V;
    }
};
struct RealFieldInfo {
    ...
    RealFieldInfo(const SmallVector<APInt, 1> &V) {
        AsIntValues = V;
    }
    RealFieldInfo(SmallVector<APInt, 1> &&V) {
        AsIntValues = V;
    }
};
...
public:
    ...
    SourceMgr &getSourceManager() override {
        return SrcMgr;
    }
    MCAsmLexer &getLexer() override {
        return Lexer;
    }
    MCContext &getContext() override {
        return Ctx;
    }
    MCStreamer &getStreamer() override {
        return Out;
    }
    ...
    bool isParsingMSInlineAsm() override {
        return ParsingMSInlineAsm;
    }

    bool isParsingMasm() const override {
        return true;
    }
...
private:
    ...
    bool isInsideMacroInstantiation() {
