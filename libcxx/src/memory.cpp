...
const char* bad_weak_ptr::what() const _NOEXCEPT { return "bad_weak_ptr"; }
...
void __shared_count::__add_shared() _NOEXCEPT {
...
void __shared_weak_count::__add_shared() _NOEXCEPT {
  __shared_count::__add_shared();
}

void __shared_weak_count::__add_weak() _NOEXCEPT {
...
__shared_weak_count* __shared_weak_count::lock() _NOEXCEPT {
  ...
  while (object_owners != -1) {
    if (__libcpp_atomic_compare_exchange(&__shared_owners_, &object_owners,
                                         object_owners + 1))
      return this;
  }
  return nullptr;
...
_LIBCPP_CONSTEXPR __sp_mut::__sp_mut(void* p) _NOEXCEPT : __lx(p) {}

void __sp_mut::lock() _NOEXCEPT {
...
void __sp_mut::unlock() _NOEXCEPT {
