...
bool InquireUnitState::Inquire(
  ...
  case HashInquiryKeyword("BLANK"):
    str = unit().isUnformatted
        ? "UNDEFINED"
        : unit().modes.editingFlags & blankZero ? "ZERO" : "NULL";
    break;
  ...
  case HashInquiryKeyword("DECIMAL"):
    str = unit().isUnformatted
        ? "UNDEFINED"
        : unit().modes.editingFlags & decimalComma ? "COMMA" : "POINT";
    break;
  ...
  case HashInquiryKeyword("ENCODING"):
    str =
        unit().isUnformatted ? "UNDEFINED" : unit().isUTF8 ? "UTF-8" : "ASCII";
    break;
  ...
  case HashInquiryKeyword("SIGN"):
    str = unit().isUnformatted
        ? "UNDEFINED"
        : unit().modes.editingFlags & signPlus ? "PLUS" : "SUPPRESS";
    break;
