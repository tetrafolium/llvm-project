...
public:
    ...
    const SymbolizedStack *get() const {
        return Stack;
    }
};
...
public:
    ...
    bool isSourceLocation() const {
        return Kind == LK_Source;
    }
    bool isMemoryLocation() const {
        return Kind == LK_Memory;
    }
    bool isSymbolizedStack() const {
        return Kind == LK_Symbolized;
    }
...
public:
    ...
    Diag &operator<<(const char *Str) {
        return AddArg(Str);
    }
    Diag &operator<<(TypeName TN) {
        return AddArg(TN);
    }
    Diag &operator<<(unsigned long long V) {
        return AddArg(UIntMax(V));
    }
    Diag &operator<<(const void *V) {
        return AddArg(V);
    }
    Diag &operator<<(const TypeDescriptor &V);
    Diag &operator<<(const Value &V);
    Diag &operator<<(const Range &R) {
        return AddRange(R);
    }
};
