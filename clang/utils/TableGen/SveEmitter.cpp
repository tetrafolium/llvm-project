...
public:
    ...
    bool isScalableVector() const {
        return isVector() && IsScalable;
    }
    bool isChar() const {
        return ElementBitwidth == 8;
    }
    bool isVoid() const {
        return Void & !Pointer;
    }
    ...
    bool isInteger() const {
        return !isFloatingPoint() && !Predicate;
    }
    bool isScalarPredicate() const {
        return !isFloatingPoint() && Predicate && NumVectors == 0;
    }
    bool isPredicateVector() const {
        return Predicate;
    }
    bool isPredicatePattern() const {
        return PredicatePattern;
    }
    bool isPrefetchOp() const {
        return PrefetchOp;
    }
...
public:
    ...
    TypeSpec getBaseTypeSpec() const {
        return BaseTypeSpec;
    }
    SVEType getBaseType() const {
        return BaseType;
    }

    StringRef getGuard() const {
        return Guard;
    }
    ...
    SVEType getReturnType() const {
        return Types[0];
    }
    ArrayRef<SVEType> getTypes() const {
        return Types;
    }
    SVEType getParamType(unsigned I) const {
        return Types[I + 1];
    }
    ...
    ArrayRef<ImmCheck> getImmChecks() const {
        return ImmChecks;
    }
