...
_CLC_OVERLOAD _CLC_DEF float expm1(float x) {
  ...
  float z2 =
      mad(r * r, mad(r, mad(r, 0x1.555556p-5f, 0x1.555556p-3f), 0.5f), r);
...
_CLC_OVERLOAD _CLC_DEF double expm1(double x) {
  ...
  const double log_OneMinus_OneByFour =
  ...
  q = fma(
      r,
      fma(r,
          fma(r, fma(r, 1.38889490863777199667e-03, 8.33336798434219616221e-03),
  ...
  double zme1024 =
      as_double(((long)e << EXPSHIFTBITS_DP64) | (uval & MANTBITS_DP64));
