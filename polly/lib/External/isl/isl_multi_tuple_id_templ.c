...
__isl_give MULTI(BASE) *
    FN(MULTI(BASE), set_tuple_name)(__isl_keep MULTI(BASE) * multi,
...
__isl_give MULTI(BASE) *
    FN(MULTI(BASE), set_tuple_id)(__isl_take MULTI(BASE) * multi,
                                  enum isl_dim_type type,
 ...
 */
__isl_give MULTI(BASE) *
    FN(MULTI(BASE), reset_tuple_id)(__isl_take MULTI(BASE) * multi,
                                    enum isl_dim_type type) {
  isl_space *space;
