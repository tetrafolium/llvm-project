...
float atan2f(float __x, float __y) {
    return __ocml_atan2_f32(__x, __y);
}
...
__DEVICE__
float cyl_bessel_i0f(float __x) {
    return __ocml_i0_f32(__x);
}

__DEVICE__
float cyl_bessel_i1f(float __x) {
...
__DEVICE__
float erfcinvf(float __x) {
    return __ocml_erfcinv_f32(__x);
}

__DEVICE__
float erfcxf(float __x) {
...
float fdimf(float __x, float __y) {
    return __ocml_fdim_f32(__x, __y);
}

__DEVICE__
float fdividef(float __x, float __y) {
    return __x / __y;
}
...
float fmaxf(float __x, float __y) {
    return __ocml_fmax_f32(__x, __y);
}

__DEVICE__
float fminf(float __x, float __y) {
    return __ocml_fmin_f32(__x, __y);
}

__DEVICE__
float fmodf(float __x, float __y) {
    return __ocml_fmod_f32(__x, __y);
}
...
float hypotf(float __x, float __y) {
    return __ocml_hypot_f32(__x, __y);
}
...
__DEVICE__
__RETURN_TYPE __finitef(float __x) {
    return __ocml_isfinite_f32(__x);
}

__DEVICE__
__RETURN_TYPE __isinff(float __x) {
    return __ocml_isinf_f32(__x);
}

__DEVICE__
__RETURN_TYPE __isnanf(float __x) {
...
__DEVICE__
float ldexpf(float __x, int __e) {
    return __ocml_ldexp_f32(__x, __e);
}
...
__DEVICE__
float normcdff(float __x) {
    return __ocml_ncdf_f32(__x);
}

__DEVICE__
float normcdfinvf(float __x) {
...
float powf(float __x, float __y) {
    return __ocml_pow_f32(__x, __y);
}

__DEVICE__
float powif(float __x, int __y) {
    return __ocml_pown_f32(__x, __y);
}

__DEVICE__
float rcbrtf(float __x) {
...
__DEVICE__
float rhypotf(float __x, float __y) {
...
float scalbnf(float __x, int __n) {
    return __ocml_scalbn_f32(__x, __n);
}

__DEVICE__
__RETURN_TYPE __signbitf(float __x) {
...
__DEVICE__
float __fadd_rn(float __x, float __y) {
    return __ocml_add_rte_f32(__x, __y);
}
__DEVICE__
float __fadd_ru(float __x, float __y) {
    return __ocml_add_rtp_f32(__x, __y);
}
__DEVICE__
float __fadd_rz(float __x, float __y) {
...
__DEVICE__
float __fdiv_rn(float __x, float __y) {
    return __ocml_div_rte_f32(__x, __y);
}
__DEVICE__
float __fdiv_ru(float __x, float __y) {
    return __ocml_div_rtp_f32(__x, __y);
}
__DEVICE__
float __fdiv_rz(float __x, float __y) {
...
__DEVICE__
float __fdividef(float __x, float __y) {
    return __x / __y;
}
...
__DEVICE__
float __fmul_rn(float __x, float __y) {
    return __ocml_mul_rte_f32(__x, __y);
}
__DEVICE__
float __fmul_ru(float __x, float __y) {
    return __ocml_mul_rtp_f32(__x, __y);
}
__DEVICE__
float __fmul_rz(float __x, float __y) {
...
__DEVICE__
float __fsqrt_rn(float __x) {
    return __ocml_sqrt_rte_f32(__x);
}
__DEVICE__
float __fsqrt_ru(float __x) {
    return __ocml_sqrt_rtp_f32(__x);
}
__DEVICE__
float __fsqrt_rz(float __x) {
...
__DEVICE__
float __fsub_rn(float __x, float __y) {
    return __ocml_sub_rte_f32(__x, __y);
}
__DEVICE__
float __fsub_ru(float __x, float __y) {
    return __ocml_sub_rtp_f32(__x, __y);
}
__DEVICE__
float __fsub_rz(float __x, float __y) {
...
__DEVICE__
double cyl_bessel_i0(double __x) {
    return __ocml_i0_f64(__x);
}

__DEVICE__
double cyl_bessel_i1(double __x) {
...
__DEVICE__
double erfcinv(double __x) {
    return __ocml_erfcinv_f64(__x);
}

__DEVICE__
double erfcx(double __x) {
    return __ocml_erfcx_f64(__x);
}

__DEVICE__
double erfinv(double __x) {
...
__DEVICE__
__RETURN_TYPE __finite(double __x) {
    return __ocml_isfinite_f64(__x);
}

__DEVICE__
__RETURN_TYPE __isinf(double __x) {
    return __ocml_isinf_f64(__x);
}

__DEVICE__
__RETURN_TYPE __isnan(double __x) {
...
__DEVICE__
double ldexp(double __x, int __e) {
...
__DEVICE__
double normcdf(double __x) {
    return __ocml_ncdf_f64(__x);
}

__DEVICE__
double normcdfinv(double __x) {
...
double powi(double __x, int __y) {
    return __ocml_pown_f64(__x, __y);
}

__DEVICE__
double rcbrt(double __x) {
...
__DEVICE__
double rhypot(double __x, double __y) {
...
__DEVICE__
__RETURN_TYPE __signbit(double __x) {
...
#if defined OCML_BASIC_ROUNDED_OPERATIONS
__DEVICE__
double __drcp_rd(double __x) {
    return __ocml_div_rtn_f64(1.0, __x);
}
__DEVICE__
double __drcp_rn(double __x) {
    return __ocml_div_rte_f64(1.0, __x);
}
__DEVICE__
double __drcp_ru(double __x) {
    return __ocml_div_rtp_f64(1.0, __x);
}
__DEVICE__
double __drcp_rz(double __x) {
