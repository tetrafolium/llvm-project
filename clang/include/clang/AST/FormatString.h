...
public:
    ...
    bool isIntArg() const {
        return (kind >= IntArgBeg && kind <= IntArgEnd) ||
               kind == FreeBSDrArg || kind == FreeBSDyArg;
    }
    bool isUIntArg() const {
        return kind >= UIntArgBeg && kind <= UIntArgEnd;
    }
    bool isAnyIntArg() const {
        return kind >= IntArgBeg && kind <= UIntArgEnd;
    }
...
public:
    ...
    bool isObjCArg() const {
        return kind >= ObjCBeg && kind <= ObjCEnd;
    }
    bool isDoubleArg() const {
