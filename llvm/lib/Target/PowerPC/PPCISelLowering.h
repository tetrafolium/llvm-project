...
public:
  ...
  bool isEqualityCmpFoldedWithSignedCmp() const override { return false; }

  bool hasAndNotCompare(SDValue) const override { return true; }
  ...
  MachineBasicBlock *EmitAtomicBinary(MachineInstr &MI, MachineBasicBlock *MBB,
                                      unsigned AtomicSize, unsigned BinOpcode,
  ...
  struct CallFlags {
    ...
    CallFlags(CallingConv::ID CC, bool IsTailCall, bool IsVarArg,
        ...
        : CallConv(CC), IsTailCall(IsTailCall), IsVarArg(IsVarArg),
          IsPatchPoint(IsPatchPoint), IsIndirect(IsIndirect), HasNest(HasNest),
          NoMerge(NoMerge) {}
  };
...
private:
  ...
  void LowerFP_TO_INTForReuse(SDValue Op, ReuseLoadInfo &RLI, SelectionDAG &DAG,
  ...
  SDValue LowerFP_TO_INT(SDValue Op, SelectionDAG &DAG, const SDLoc &dl) const;
  ...
  SDValue LowerFormalArguments_AIX(SDValue Chain, CallingConv::ID CallConv,
                                   bool isVarArg,
                                   const SmallVectorImpl<ISD::InputArg> &Ins,
                                   const SDLoc &dl, SelectionDAG &DAG,
                                   SmallVectorImpl<SDValue> &InVals) const;
  SDValue LowerFormalArguments_Darwin(SDValue Chain, CallingConv::ID CallConv,
                                      bool isVarArg,
                                      const SmallVectorImpl<ISD::InputArg> &Ins,
                                      const SDLoc &dl, SelectionDAG &DAG,
                                      SmallVectorImpl<SDValue> &InVals) const;
  SDValue LowerFormalArguments_64SVR4(SDValue Chain, CallingConv::ID CallConv,
                                      bool isVarArg,
                                      const SmallVectorImpl<ISD::InputArg> &Ins,
                                      const SDLoc &dl, SelectionDAG &DAG,
                                      SmallVectorImpl<SDValue> &InVals) const;
  SDValue LowerFormalArguments_32SVR4(SDValue Chain, CallingConv::ID CallConv,
                                      bool isVarArg,
                                      const SmallVectorImpl<ISD::InputArg> &Ins,
                                      const SDLoc &dl, SelectionDAG &DAG,
                                      SmallVectorImpl<SDValue> &InVals) const;
