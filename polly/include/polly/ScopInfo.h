...
public:
    ...
    /// nullptr otherwise.
    Value *getFortranArrayDescriptor() const {
        return this->FAD;
    }
...
public:
    ...
    bool isReductionLike() const {
        return RedType != RT_NONE;
    }

    /// Is this a read memory access?
    bool isRead() const {
        return AccType == MemoryAccess::READ;
    }

    /// Is this a must-write memory access?
    bool isMustWrite() const {
        return AccType == MemoryAccess::MUST_WRITE;
    }

    /// Is this a may-write memory access?
    bool isMayWrite() const {
        return AccType == MemoryAccess::MAY_WRITE;
    }

    /// Is this a write memory access?
    bool isWrite() const {
        return isMustWrite() || isMayWrite();
    }
    ...
    bool hasNewAccessRelation() const {
        return !NewAccessRelation.is_null();
    }
    ...
    isl::set getInvalidContext() const {
        return getInvalidDomain().params();
    }
    ...
    bool isLatestPHIKind() const {
        return getLatestKind() == MemoryKind::PHI;
    }
...
public:
    ...
    bool hasInvariantAccesses() {
        return !InvariantEquivClasses.empty();
    }
    ...
    bool hasTrivialInvalidContext() const {
        return InvalidContext.is_empty();
    }
    ...
    bool hasNSWAddRecForLoop(Loop *L) {
        return Affinator.hasNSWAddRecForLoop(L);
    }
...
public:
    ...
    iterator begin() {
        return RegionToScopMap.begin();
    }
    iterator end() {
        return RegionToScopMap.end();
    }
    const_iterator begin() const {
        return RegionToScopMap.begin();
    }
    ...
    reverse_iterator rbegin() {
        return RegionToScopMap.rbegin();
    }
    reverse_iterator rend() {
        return RegionToScopMap.rend();
    }
    const_reverse_iterator rbegin() const {
        return RegionToScopMap.rbegin();
    }
