...
static const std::map<unsigned, std::vector<unsigned>> ExtFixups = {
    ...
    {MCSymbolRefExpr::VK_Hexagon_GD_PLT,
     {_,
      ...
      _,
      _}},
    {MCSymbolRefExpr::VK_Hexagon_IE, {_,           _,           _,
                                      _,           _,           _,
                                      P(_IE_16_X), _,           _,
                                      P(_9_X),     _,           _,
                                      P(_IE_16_X), _,           _,
...
static const std::map<unsigned, std::vector<unsigned>> StdFixups = {
    ...
    {MCSymbolRefExpr::VK_GOT,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,         _,
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_GOT_32)}},
    {MCSymbolRefExpr::VK_GOTREL,
     {_, _, _, _, _, _,           _, _, _, _, _,
      _, _, _, _, _, _ /* [2] */, _, _, _, _, _,
      _, _, _, _, _, _,           _, _, _, _, P(_GOTREL_32)}},
    ...
    {MCSymbolRefExpr::VK_Hexagon_GPREL,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_GPREL16_0),
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _}},
    {MCSymbolRefExpr::VK_Hexagon_HI16,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_HI16),
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _}},
    {MCSymbolRefExpr::VK_Hexagon_IE,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,        _,
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_IE_32)}},
    {MCSymbolRefExpr::VK_Hexagon_IE_GOT,
     {_,
      _,
      _,
    ...
    {MCSymbolRefExpr::VK_Hexagon_LO16,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_LO16),
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _}},
    {MCSymbolRefExpr::VK_PCREL,
     {_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,           _,
      _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, P(_32_PCREL)}},
    {MCSymbolRefExpr::VK_None,
     {_,
      _,
      _,
