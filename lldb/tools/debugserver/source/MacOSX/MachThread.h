...
public:
    ...
    const MachProcess *Process() const {
        return m_process;
    }
    ...
    thread_t MachPortNumber() const {
        return m_mach_port_number;
    }
    ...
    const MachException::Data &GetStopException() {
    ...
    DNBArchProtocol *GetArchProtocol() {
        return m_arch_up.get();
    }
