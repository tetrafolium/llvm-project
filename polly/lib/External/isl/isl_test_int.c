...
struct {
  ...
  char *val;
    ...
    {&int_test_hash, "0"},           {&int_test_hash, "1"},
    {&int_test_hash, "-1"},          {&int_test_hash, "23"},
    {&int_test_hash, "-23"},         {&int_test_hash, "107"},
    {&int_test_hash, "32768"},       {&int_test_hash, "2147483647"},
    {&int_test_hash, "-2147483647"}, {&int_test_hash, "2147483648"},
...
static void
invoke_alternate_representations_3args(char *arg1, char *arg2, char *arg3,
 ...
 */
static void int_test_product(isl_int product, isl_int factor1,
                             isl_int factor2) {
...
struct {
  ...
  char *expected, *lhs, *rhs;
    ...
    {&int_test_product, "4611686014132420609", "2147483647", "2147483647"},
    {&int_test_product, "-4611686014132420609", "-2147483647", "2147483647"},

    {&int_test_product, "4611686016279904256", "2147483647", "2147483648"},
    {&int_test_product, "-4611686016279904256", "-2147483647", "2147483648"},
    {&int_test_product, "-4611686016279904256", "2147483647", "-2147483648"},
    {&int_test_product, "4611686016279904256", "-2147483647", "-2147483648"},
...
int main() {
  ...
  for (i = 0; i < ARRAY_SIZE(int_unary_tests); i += 1) {
    invoke_alternate_representations_2args(int_unary_tests[i].expected,
                                           int_unary_tests[i].arg,
