  ...
  (__extension__(                                                              \
      __builtin_constant_p(src)                                                \
          ? (__string2_1bptr_p(src) && strlen(src) + 1 <= 8                    \
                 ? __stpcpy_small(dest, __stpcpy_args(src), strlen(src) + 1)   \
...
#define __mempcpy_args(src)                                                    \
  ((char *)(src))[0], ((char *)(src))[2], ((char *)(src))[4],                  \
      ((char *)(src))[6], __extension__ __STRING2_SMALL_GET16(src, 0),         \
      __extension__ __STRING2_SMALL_GET16(src, 4),                             \
      __extension__ __STRING2_SMALL_GET32(src, 0),                             \
      __extension__ __STRING2_SMALL_GET32(src, 4)
...
#define __STRING2_SMALL_GET32(src, idx)                                        \
  (((((__const unsigned char *)(__const char *)(src))[idx + 3] << 8 |          \
     ((__const unsigned char *)(__const char *)(src))[idx + 2])                \
        << 8 |                                                                 \
    ((__const unsigned char *)(__const char *)(src))[idx + 1])                 \
       << 8 |                                                                  \
   ((__const unsigned char *)(__const char *)(src))[idx])

stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d), e) stpcpy(
    ...
    e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
              e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                        e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                                  e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                                            e)
    stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
           e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                     e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                               e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d), e)
        stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d), e) stpcpy(
            stpcpy(stpcpy(stpcpy(a, b), c), d),
            e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                      e) stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                        ...
                        stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d), e) stpcpy(
                            ...
                            stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                                ...
                                stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d), e)
                                    stpcpy(stpcpy(stpcpy(stpcpy(a, b), c), d),
                                           e)
                                        stpcpy(stpcpy(stpcpy(stpcpy(a, b), c),
                                                      d),
                                               e)
