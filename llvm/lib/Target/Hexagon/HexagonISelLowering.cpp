...
public:
    ...
    unsigned getNumNamedVarArgParams() const {
...
HexagonTargetLowering::HexagonTargetLowering(const TargetMachine &TM,
    ...
    for (MVT NativeVT : {
                MVT::v8i1, MVT::v4i1, MVT::v2i1, MVT::v4i8,
    ...
    for (MVT VT : {
                MVT::i16, MVT::i32, MVT::v4i8, MVT::i64, MVT::v8i8,
    ...
    for (MVT VT : {
                MVT::v2i16, MVT::v4i8, MVT::v8i8, MVT::v2i32, MVT::v4i16,
                MVT::v2i32
            }) {
...
const {
    ...
    unsigned F = llvm::find_if(AM, [](int M) {
        return M >= 0;
    }) - AM.data();
    if (F == AM.size())
...
HexagonTargetLowering::buildVector32(ArrayRef<SDValue> Elem, const SDLoc &dl,
    ...
    if (AllConst &&
    llvm::all_of(Consts, [](ConstantInt *CI) {
    return CI->isZero();
    }))
