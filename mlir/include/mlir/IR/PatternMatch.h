...
public:
    ...
    void *getAsOpaquePointer() {
        return impl.getOpaqueValue();
    }
...
public:
    ...
    LogicalResult notifyMatchFailure(Operation *op, const Twine &msg) {
        return notifyMatchFailure(op, [&](Diagnostic &diag) {
            diag << msg;
        });
    }
