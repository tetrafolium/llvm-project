...
struct IntelExpr {
    ...
    bool hasBaseReg() const {
        return !BaseReg.empty();
    }
    bool hasIndexReg() const {
        return !IndexReg.empty();
    }
    bool hasRegs() const {
        return hasBaseReg() || hasIndexReg();
    }
    bool hasOffset() const {
        return !OffsetName.empty();
    }
...
struct DiagnosticPredicate {
    ...
    operator bool() const {
        return Type == DiagnosticPredicateTy::Match;
    }
    bool isMatch() const {
        return Type == DiagnosticPredicateTy::Match;
    }
    bool isNearMatch() const {
        return Type == DiagnosticPredicateTy::NearMatch;
    }
    bool isNoMatch() const {
        return Type == DiagnosticPredicateTy::NoMatch;
    }
};
