...
public:
  ...
  st_cxa_cleanup(void* ptr, size_t& idx, size_t element_size,
...
__cxa_vec_new(size_t element_count, size_t element_size, size_t padding_size,
  ...
  return __cxa_vec_new2(element_count, element_size, padding_size, constructor,
                        destructor, &::operator new[], & ::operator delete[]);
}
...
__cxa_vec_new2(size_t element_count, size_t element_size, size_t padding_size,
  ...
  if (NULL != vec_base) {
    ...
    __cxa_vec_ctor(vec_base, element_count, element_size, constructor,
                   destructor);
...
_LIBCXXABI_FUNC_VIS void __cxa_vec_delete(void* array_address,
                                          ...
                                          size_t padding_size,
                                          void (*destructor)(void*)) {
  __cxa_vec_delete2(array_address, element_size, padding_size, destructor,
                    &::operator delete[]);
}
...
__cxa_vec_delete2(void* array_address, size_t element_size, size_t padding_size,
  ...
  if (NULL != array_address) {
    ...
    if (0 != padding_size && NULL != destructor) // call the destructors
      __cxa_vec_dtor(array_address, __get_element_count(vec_base), element_size,
                     destructor);
  }
}
...
__cxa_vec_delete3(void* array_address, size_t element_size, size_t padding_size,
  ...
  if (NULL != array_address) {
    ...
    const size_t element_count =
        padding_size ? __get_element_count(vec_base) : 0;
