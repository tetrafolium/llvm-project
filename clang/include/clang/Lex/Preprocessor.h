...
public:
  ...
  bool SetCodeCompletionPoint(const FileEntry *File, unsigned Line,
                              unsigned Column);
  ...
  void setMainFileDir(const DirectoryEntry *Dir) { MainFileDir = Dir; }
