...
public:
    ...
    bool isDefault() const {
        return Def->getValueAsBit("isDefault");
    }

    // Returns the record name.
    const StringRef getRecordName() const {
        return Def->getName();
    }
...
public:
    ...
    bool isValueOptional() const {
        return Def->getValueAsBit("isValueOptional");
    }

    bool isValueList() const {
        return Def->getValueAsBit("isValueList");
    }
    ...
    bool isImplicit() const {
        return Def->getValueAsBit("isImplicit");
    }
};
...
public:
    ...
    Clause getClause() const {
        return Clause{Def->getValueAsDef("clause")};
    }

    int64_t getMinVersion() const {
        return Def->getValueAsInt("minVersion");
    }

    int64_t getMaxVersion() const {
        return Def->getValueAsInt("maxVersion");
    }
...
public:
    ...
    bool isUserVisible() const {
        return Def->getValueAsBit("isUserValue");
    }
};
