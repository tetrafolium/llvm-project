...
template <> void RegisterMethods<SBBroadcaster>(Registry &R) {
  ...
  LLDB_REGISTER_METHOD(const lldb::SBBroadcaster &,
                       SBBroadcaster, operator=,(const lldb::SBBroadcaster &));
  ...
  LLDB_REGISTER_METHOD(bool, SBBroadcaster, EventTypeHasListeners, (uint32_t));
